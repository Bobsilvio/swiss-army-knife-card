 ...
 * http://polymer.github.io/PATENTS.txt
 */
const m=new WeakMap,f=t=>(...e)=>{const s=t(...e);return m.set(s,!0),s},v=t=>"function"==typeof t&&m.has(t),y={},_={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const S=t=>null===t||!("object"==typeof t||"function"==typeof t),M=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class A{constructor(t,e,s){this.dirty=!0,this.element=t,this.name=e,this.strings=s,this.parts=[];for(let i=0;i<s.length-1;i++)this.parts[i]=this._createPart()}_createPart(){return new E(this)}_getValue(){const t=this.strings,e=t.length-1,s=this.parts;if(1===e&&""===t[0]&&""===t[1]){const t=s[0].value;if("symbol"==typeof t)return String(t);if("string"==typeof t||!M(t))return t}let i="";for(let a=0;a<e;a++){i+=t[a];const e=s[a];if(void 0!==e){const t=e.value;if(S(t)||!M(t))i+="string"==typeof t?t:String(t);else for(const e of t)i+="string"==typeof e?e:String(e)}}return i+=t[e],i}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class E{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===y||S(t)&&t===this.value||(this.value=t,v(t)||(this.committer.dirty=!0))}commit(){for(;v(this.value);){const t=this.value;this.value=y,t(this)}this.value!==y&&this.committer.commit()}}class C{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(c()),this.endNode=t.appendChild(c())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=c()),t.__insert(this.endNode=c())}insertAfterPart(t){t.__insert(this.startNode=c()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(null===this.startNode.parentNode)return;for(;v(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}const t=this.__pendingValue;t!==y&&(S(t)?t!==this.value&&this.__commitText(t):t instanceof $?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):M(t)?this.__commitIterable(t):t===_?(this.value=_,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling,s="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=s:this.__commitNode(document.createTextNode(s)),this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof b&&this.value.template===e)this.value.update(t.values);else{const s=new b(e,t.processor,this.options),i=s._clone();s.update(t.values),this.__commitNode(i),this.value=s}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let s,i=0;for(const a of t)s=e[i],void 0===s&&(s=new C(this.options),e.push(s),0===i?s.appendIntoPart(this):s.insertAfterPart(e[i-1])),s.setValue(a),s.commit(),i++;i<e.length&&(e.length=i,this.clear(s&&s.endNode))}clear(t=this.startNode){s(this.startNode.parentNode,t.nextSibling,this.endNode)}}class T{constructor(t,e,s){if(this.value=void 0,this.__pendingValue=void 0,2!==s.length||""!==s[0]||""!==s[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=s}setValue(t){this.__pendingValue=t}commit(){for(;v(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}if(this.__pendingValue===y)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=y}}class I extends A{constructor(t,e,s){super(t,e,s),this.single=2===s.length&&""===s[0]&&""===s[1]}_createPart(){return new D(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class D extends E{}let P=!1;(()=>{try{const t={get capture(){return P=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class R{constructor(t,e,s){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=s,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;v(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}if(this.__pendingValue===y)return;const t=this.__pendingValue,e=this.value,s=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),i=null!=t&&(null==e||s);s&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),i&&(this.__options=N(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=y}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const N=t=>t&&(P?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function L(t){let e=V.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},V.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const a=t.strings.join(i);return s=e.keyString.get(a),void 0===s&&(s=new n(t,t.getTemplateElement()),e.keyString.set(a,s)),e.stringsArray.set(t.strings,s),s}const V=new Map,O=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const a=e[0];if("."===a){return new I(t,e.slice(1),s).parts}if("@"===a)return[new R(t,e.slice(1),i.eventContext)];if("?"===a)return[new T(t,e.slice(1),s)];return new A(t,e,s).parts}handleTextExpression(t){return new C(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const U=(t,...e)=>new $(t,e,"html",B),z=(t,...e)=>new k(t,e,"svg",B)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const ot=new WeakMap,nt=f((t=>e=>{if(!(e instanceof E)||e instanceof D||"style"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:s}=e,{style:i}=s.element;let a=ot.get(e);void 0===a&&(i.cssText=s.strings.join(" "),ot.set(e,a=new Set)),a.forEach((e=>{e in t||(a.delete(e),-1===e.indexOf("-")?i[e]=null:i.removeProperty(e))}));for(const r in t)a.add(r),-1===r.indexOf("-")?i[r]=t[r]:i.setProperty(r,t[r])})),ht=new WeakMap,lt=window.navigator.userAgent.indexOf("Trident/")>0,ct=f((t=>s=>{if(!(s instanceof C))throw new Error("unsafeSVG can only be used in text bindings");const i=ht.get(s);if(void 0!==i&&S(t)&&t===i.value&&s.value===i.fragment)return;const a=document.createElement("template"),r=a.content;let o;lt?(a.innerHTML=`<svg>${t}</svg>`,o=r.firstChild):(o=document.createElementNS("http://www.w3.org/2000/svg","svg"),r.appendChild(o),o.innerHTML=t),r.removeChild(o),e(r,o.firstChild);const n=document.importNode(r,!0);s.setValue(n),ht.set(s,{value:t,fragment:n})})),dt=new WeakMap,gt=f((t=>e=>{const s=dt.get(e);if(void 0===t&&e instanceof E){if(void 0!==s||!dt.has(e)){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else t!==s&&e.setValue(t);dt.set(e,t)}));var ut="3.0.1-dev";const pt=400,mt=200,ft=pt,vt=(t,e,s)=>t<0||s<0?e+360:e,yt=(t,e)=>Math.abs(t-e);class _t{static mergeDeep(...t){const e=t=>t&&"object"==typeof t;return t.reduce(((t,s)=>(Object.keys(s).forEach((i=>{const a=t[i],r=s[i];Array.isArray(a)&&Array.isArray(r)?t[i]=a.concat(...r):e(a)&&e(r)?t[i]=this.mergeDeep(a,r):t[i]=r})),t)),{})}}class bt{static{this.metrics={renderTimes:[],memoryUsage:[],interactionTimes:[]}}static startRender(){this.renderStart=performance.now()}static endRender(){const t=performance.now()-this.renderStart;return this.metrics.renderTimes.push(t),this.metrics.renderTimes.length>100&&this.metrics.renderTimes.shift(),t>16&&console.warn(`[SAK] Slow render detected: ${t.toFixed(2)}ms (target: <16ms)`),t}static trackInteraction(){const t=performance.now();return()=>{const e=performance.now()-t;this.metrics.interactionTimes.push(e),this.metrics.interactionTimes.length>100&&this.metrics.interactionTimes.shift(),e>100&&console.warn(`[SAK] Slow interaction: ${e.toFixed(2)}ms (target: <100ms)`)}}static getAverageRenderTime(){if(0===this.metrics.renderTimes.length)return 0;const t=this.metrics.renderTimes.reduce(((t,e)=>t+e),0);return t/this.metrics.renderTimes.length}static getAverageInteractionTime(){if(0===this.metrics.interactionTimes.length)return 0;const t=this.metrics.interactionTimes.reduce(((t,e)=>t+e),0);return t/this.metrics.interactionTimes.length}static logMetrics(){console.log("[SAK Performance Metrics]",{avgRenderTime:`${this.getAverageRenderTime().toFixed(2)}ms`,avgInteractionTime:`${this.getAverageInteractionTime().toFixed(2)}ms`,fps:`${(1e3/this.getAverageRenderTime()).toFixed(1)}`,samples:this.metrics.renderTimes.length})}}class wt{static calculateValueBetween(t,e,s){return isNaN(s)?0:s?(Math.min(Math.max(s,t),e)-t)/(e-t):0}static calculateSvgCoordinate(t,e){return t/100*pt+(e-mt)}static calculateSvgDimension(t){return t/100*pt}static getLovelace(){let t=window.document.querySelector("home-assistant");t=t&&t.shadowRoot,t=t&&t.querySelector("home-assistant-main"),t=t&&t.shadowRoot;let e=t&&t.querySelector("app-drawer-layout partial-panel-resolver, ha-drawer partial-panel-resolver");if(e||(e=t&&t.querySelector("partial-panel-resolver")),t=e,t=t&&t.shadowRoot||t,t=t&&t.querySelector("ha-panel-lovelace"),t=t&&t.shadowRoot,t=t&&t.querySelector("hui-root"),t){const e=t.lovelace;return e&&(e.current_view=t.___curView),e||null}return null}}class xt{static replaceVariables3(t,e){if(!t&&!e.template.defaults)return e[e.template.type];let s=t?.slice(0)??[];e.template.defaults&&(s=s.concat(e.template.defaults));let i=JSON.stringify(e[e.template.type]);return s.forEach((t=>{const e=Object.keys(t)[0],s=Object.values(t)[0];if("number"==typeof s||"boolean"==typeof s){const t=new RegExp(`"\\[\\[${e}\\]\\]"`,"gm");i=i.replace(t,String(s))}else if("object"==typeof s){const t=new RegExp(`"\\[\\[${e}\\]\\]"`,"gm"),a=JSON.stringify(s);i=i.replace(t,a)}else{const t=new RegExp(`\\[\\[${e}\\]\\]`,"gm");i=i.replace(t,s)}})),JSON.parse(i)}static getJsTemplateOrValueConfig(t,e,s){if(!s)return s;if(["number","boolean","bigint","symbol"].includes(typeof s))return s;if("object"==typeof s)return Object.keys(s).forEach((i=>{s[i]=xt.getJsTemplateOrValueConfig(t,e,s[i])})),s;const i=s.trim();return"[[[["===i.substring(0,4)&&"]]]]"===i.slice(-4)?xt.evaluateJsTemplateConfig(t,e,i.slice(4,-4)):s}static evaluateJsTemplateConfig(t,e,s){try{return new Function("tool_config","entities_config",`'use strict'; ${s}`).call(this,t,e)}catch(ti){throw ti.name="Sak-evaluateJsTemplateConfig-Error",ti}}static evaluateJsTemplate(t,e,s){try{return new Function("state","states","entity","user","hass","tool_config","entity_config",`'use strict'; ${s}`).call(this,e,t._card._hass.states,t.config.hasOwnProperty("entity_index")?t._card.entities[t.config.entity_index]:void 0,t._card._hass.user,t._card._hass,t.config,t.config.hasOwnProperty("entity_index")?t._card.config.entities[t.config.entity_index]:void 0)}catch(ti){throw ti.name="Sak-evaluateJsTemplate-Error",ti}}static getJsTemplateOrValue(t,e,s){if(!s)return s;if(["number","boolean","bigint","symbol"].includes(typeof s))return s;if("object"==typeof s)return Object.keys(s).forEach((i=>{s[i]=xt.getJsTemplateOrValue(t,e,s[i])})),s;const i=s.trim();return"[[["===i.substring(0,3)&&"]]]"===i.slice(-3)?xt.evaluateJsTemplate(t,e,i.slice(3,-3)):s}}
/**
 * @license
 * Copyright (c) 2018 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class $t{constructor(t){this.classes=new Set,this.changed=!1,this.element=t;const e=(t.getAttribute("class")||"").split(/\s+/);for(const s of e)this.classes.add(s)}add(t){this.classes.add(t),this.changed=!0}remove(t){this.classes.delete(t),this.changed=!0}commit(){if(this.changed){let t="";this.classes.forEach((e=>t+=e+" ")),this.element.setAttribute("class",t)}}}const kt=new WeakMap,St=f((t=>e=>{if(!(e instanceof E)||e instanceof D||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:s}=e,{element:i}=s;let a=kt.get(e);void 0===a&&(i.setAttribute("class",s.strings.join(" ")),kt.set(e,a=new Set));const r=i.classList||new $t(i);a.forEach((e=>{e in t||(r.remove(e),a.delete(e))}));for(const o in t){const e=t[o];e!=a.has(o)&&(e?(r.add(o),a.add(o)):(r.remove(o),a.delete(o)))}"function"==typeof r.commit&&r.commit()})),Mt=(t,e,s,i)=>{i=i||{},s=null==s?{}:s;const a=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return a.detail=s,t.dispatchEvent(a),a};class At{static{At.colorCache={},At.element=void 0,At._canvas=null,At._ctx=null}static _prefixKeys(t){let e={};return t&&"object"==typeof t?(Object.keys(t).forEach((s=>{const i=`--${s}`,a=String(t[s]);e[i]=`${a}`})),e):e}static processTheme(t){let e={},s={},i={},a={};const{modes:r,...o}=t;return r&&(s={...o,...r.dark},e={...o,...r.light}),i=At._prefixKeys(e),a=At._prefixKeys(s),{themeLight:i,themeDark:a}}static processPalette(t){let e={},s={},i={},a={},r={};return Object.values(t).forEach((t=>{const{modes:a,...r}=t;e={...e,...r},a&&(i={...i,...r,...a.dark},s={...s,...r,...a.light})})),a=At._prefixKeys(s),r=At._prefixKeys(i),{paletteLight:a,paletteDark:r}}static setElement(t){At.element=t}static calculateColor(t,e,s){const i=Object.keys(e).map((t=>Number(t))).sort(((t,e)=>t-e));let a,r,o;const n=i.length;if(t<=i[0])return e[i[0]];if(t>=i[n-1])return e[i[n-1]];for(let h=0;h<n-1;h++){const n=i[h],l=i[h+1];if(t>=n&&t<l){if([a,r]=[e[n],e[l]],!s)return a;o=At.calculateValueBetween(n,l,t);break}}return void 0===a||void 0===r||void 0===o?e[i[n-1]]:At.getGradientValue(a,r,o)}static calculateColor2(t,e,s,i,a){const r=Object.keys(e).map((t=>Number(t))).sort(((t,e)=>t-e));let o,n,h;const l=r.length;if(t<=r[0])return e[r[0]];if(t>=r[l-1])return e[r[l-1]];for(let c=0;c<l-1;c++){const l=r[c],d=r[c+1];if(t>=l&&t<d){if([o,n]=[e[l].styles[s][i],e[d].styles[s][i]],!a)return o;h=At.calculateValueBetween(l,d,t);break}}return void 0===o||void 0===n||void 0===h?e[r[l-1]]:At.getGradientValue(o,n,h)}static calculateValueBetween(t,e,s){return(Math.min(Math.max(s,t),e)-t)/(e-t)}static getColorVariable(t){const e=t.substr(4,t.length-5),s=window.getComputedStyle(At.element).getPropertyValue(e);return s&&s.trim()?s.trim():null}static getGradientValue(t,e,s){const i=At.colorToRGBA(t),a=At.colorToRGBA(e);if(!i||!a)return"#00000000";if(null==s||isNaN(s)){return`#${At.padZero(Math.max(0,Math.min(255,i[0])).toString(16))}${At.padZero(Math.max(0,Math.min(255,i[1])).toString(16))}${At.padZero(Math.max(0,Math.min(255,i[2])).toString(16))}${At.padZero(Math.max(0,Math.min(255,i[3])).toString(16))}`}const r=Math.max(0,Math.min(1,s)),o=1-r,n=Math.max(0,Math.min(255,Math.round(i[0]*o+a[0]*r))),h=Math.max(0,Math.min(255,Math.round(i[1]*o+a[1]*r))),l=Math.max(0,Math.min(255,Math.round(i[2]*o+a[2]*r))),c=Math.max(0,Math.min(255,Math.round(i[3]*o+a[3]*r)));return`#${At.padZero(n.toString(16))}${At.padZero(h.toString(16))}${At.padZero(l.toString(16))}${At.padZero(c.toString(16))}`}static padZero(t){return t.length<2&&(t=`0${t}`),t.substr(0,2)}static colorToRGBA(t){if(null==t||""===t)return[0,0,0,0];const e=At.colorCache[t];if(e)return e;let s=t;if("string"==typeof t&&"var"===t.substr(0,3)&&(s=At.getColorVariable(t),!s))return At.colorCache[t]=[0,0,0,0],[0,0,0,0];At._canvas||(At._canvas=window.document.createElement("canvas"),At._canvas.width=At._canvas.height=1,At._ctx=At._canvas.getContext("2d")),At._ctx.clearRect(0,0,1,1),At._ctx.fillStyle=s,At._ctx.fillRect(0,0,1,1);const i=[...At._ctx.getImageData(0,0,1,1).data];return At.colorCache[t]=i,i}static hslToRgb(t){const e=t.h/360,s=t.s/100,i=t.l/100;let a,r,o;if(0===s)a=r=o=i;else{function n(t,e,s){return s<0&&(s+=1),s>1&&(s-=1),s<1/6?t+6*(e-t)*s:s<.5?e:s<2/3?t+(e-t)*(2/3-s)*6:t}const h=i<.5?i*(1+s):i+s-i*s,l=2*i-h;a=n(l,h,e+1/3),r=n(l,h,e),o=n(l,h,e-1/3)}return a*=255,r*=255,o*=255,{r:a,g:r,b:o}}}class Et{static{this.styleCache=new Map}static{this.pendingRenderUpdates=new Set}static{this.rafId=null}constructor(t,e,s){this.toolId=Math.random().toString(36).substr(2,9),this.toolset=t,this._card=this.toolset._card,this.config=e,this.dev={...this._card.dev},this.toolsetPos=s,this.svg={},this.svg.cx=wt.calculateSvgCoordinate(e.position.cx,0),this.svg.cy=wt.calculateSvgCoordinate(e.position.cy,0),this.svg.height=e.position.height?wt.calculateSvgDimension(e.position.height):0,this.svg.width=e.position.width?wt.calculateSvgDimension(e.position.width):0,this.svg.x=this.svg.cx-this.svg.width/2,this.svg.y=this.svg.cy-this.svg.height/2,this.classes={},this.classes.card={},this.classes.toolset={},this.classes.tool={},this.styles={},this.styles.card={},this.styles.toolset={},this.styles.tool={},this.animationClass={},this.animationClassHasChanged=!0,this.animationStyle={},this.animationStyleHasChanged=!0,this.config?.show?.style||(this.config.show||(this.config.show={}),this.config.show.style="default"),this.colorStops={},this.config.colorstops&&this.config.colorstops.colors&&Object.keys(this.config.colorstops.colors).forEach((t=>{this.colorStops[t]=this.config.colorstops.colors[t]})),"colorstop"===this.config.show.style&&this.config?.colorstops.colors&&(this.sortedColorStops=Object.keys(this.config.colorstops.colors).map((t=>Number(t))).sort(((t,e)=>t-e))),this.csnew={},this.config.csnew&&this.config.csnew.colors&&(this.config.csnew.colors.forEach(((t,e)=>{this.csnew[t.stop]=this.config.csnew.colors[e]})),this.sortedcsnew=Object.keys(this.csnew).map((t=>Number(t))).sort(((t,e)=>t-e)))}textEllipsis(t,e){return e&&e<t.length?t.slice(0,e-1).concat("..."):t}defaultEntityIndex(){return this.default||(this.default={},this.config.hasOwnProperty("entity_indexes")?this.default.entity_index=this.config.entity_indexes[0].entity_index:this.default.entity_index=this.config.entity_index),this.default.entity_index}set value(t){let e=t;this.dev.debug&&console.log("BaseTool set value(state)",e);try{if("undefined"!==e&&void 0!==e&&this._stateValue?.toString().toLowerCase()===e.toString().toLowerCase())return}catch(ti){console.log("catching something",ti,t,this.config)}this.derivedEntity=null,this.config.derived_entity&&(this.derivedEntity=xt.getJsTemplateOrValue(this,t,_t.mergeDeep(this.config.derived_entity)),e=this.derivedEntity.state?.toString()),this._stateValuePrev=this._stateValue||e,this._stateValue=e,this._stateValueIsDirty=!0;let s=!1;this.activeAnimation=null,this.config.animations&&Object.keys(this.config.animations).map((t=>{const e=JSON.parse(JSON.stringify(this.config.animations[t])),i=xt.getJsTemplateOrValue(this,this._stateValue,_t.mergeDeep(e));if(s)return!0;switch(i.operator?i.operator:"=="){case"==":s=void 0===this._stateValue?void 0===i.state||"undefined"===i.state.toLowerCase():this._stateValue.toLowerCase()===i.state.toLowerCase();break;case"!=":s=void 0===this._stateValue?"undefined"!==i.state.toLowerCase():this._stateValue.toLowerCase()!==i.state.toLowerCase();break;case">":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())>Number(i.state.toLowerCase()));break;case"<":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())<Number(i.state.toLowerCase()));break;case">=":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())>=Number(i.state.toLowerCase()));break;case"<=":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())<=Number(i.state.toLowerCase()));break;default:s=!1}return this.dev.debug&&console.log("BaseTool, animation, match, value, config, operator",s,this._stateValue,i.state,i.operator),!s||(this.animationClass&&i.reuse||(this.animationClass={}),i.classes&&(this.animationClass=_t.mergeDeep(this.animationClass,i.classes)),this.animationStyle&&i.reuse||(this.animationStyle={}),i.styles&&(this.animationStyle=_t.mergeDeep(this.animationStyle,i.styles)),this.animationStyleHasChanged=!0,this.item=i,this.activeAnimation=i,s)}))}getEntityIndexFromAnimation(t){return t.hasOwnProperty("entity_index")?t.entity_index:this.config.hasOwnProperty("entity_index")?this.config.entity_index:this.config.entity_indexes?this.config.entity_indexes[0].entity_index:void 0}getIndexInEntityIndexes(t){return this.config.entity_indexes.findIndex((e=>e.entity_index===t))}stateIsMatch(t,e){let s;const i=JSON.parse(JSON.stringify(t)),a=xt.getJsTemplateOrValue(this,e,_t.mergeDeep(i));switch(a.operator?a.operator:"=="){case"==":s=void 0===e?void 0===a.state||"undefined"===a.state?.toLowerCase():e.toLowerCase()===a.state.toLowerCase();break;case"!=":s=void 0===e?void 0!==a.state||"undefined"!==a.state?.toLowerCase():e.toLowerCase()!==a.state.toLowerCase();break;case">":void 0!==e&&(s=Number(e.toLowerCase())>Number(a.state.toLowerCase()));break;case"<":void 0!==e&&(s=Number(e.toLowerCase())<Number(a.state.toLowerCase()));break;case">=":void 0!==e&&(s=Number(e.toLowerCase())>=Number(a.state.toLowerCase()));break;case"<=":void 0!==e&&(s=Number(e.toLowerCase())<=Number(a.state.toLowerCase()));break;default:s=!1}return s}mergeAnimationData(t){this.animationClass&&t.reuse||(this.animationClass={}),t.classes&&(this.animationClass=_t.mergeDeep(this.animationClass,t.classes)),this.animationStyle&&t.reuse||(this.animationStyle={}),t.styles&&(this.animationStyle=_t.mergeDeep(this.animationStyle,t.styles)),this.animationStyleHasChanged=!0,this.item||(this.item={}),this.item=_t.mergeDeep(this.item,t),this.activeAnimation={...t}}set values(t){this._lastStateValues||(this._lastStateValues=[]),this._stateValues||(this._stateValues=[]);const e=[...t];this.dev.debug&&console.log("BaseTool set values(state)",e);for(let s=0;s<t.length;++s){void 0!==e[s]&&(this._stateValues[s]?.toLowerCase()===e[s].toLowerCase()||this.config.derived_entities&&(this.derivedEntities[s]=xt.getJsTemplateOrValue(this,t[s],_t.mergeDeep(this.config.derived_entities[s])),e[s]=this.derivedEntities[s].state?.toString())),this._lastStateValues[s]=this._stateValues[s]||e[s],this._stateValues[s]=e[s],this._stateValueIsDirty=!0;let i=!1;this.activeAnimation=null,this.config.animations&&this.config.animations.forEach(((e,a)=>{if(i)return;const r=this.getIndexInEntityIndexes(this.getEntityIndexFromAnimation(e)),o=JSON.parse(JSON.stringify(e));let n=xt.getJsTemplateOrValue(this,t[s],_t.mergeDeep(o));i=this.stateIsMatch(n,t[r]),e.debug&&console.log("set values, item, aniKey",n,t,i,this.config.animations),i&&this.mergeAnimationData(n)}))}this._stateValue=this._stateValues[this.getIndexInEntityIndexes(this.defaultEntityIndex())],this._stateValuePrev=this._lastStateValues[this.getIndexInEntityIndexes(this.defaultEntityIndex())]}EnableHoverForInteraction(){const t=this.config.hasOwnProperty("entity_index")||this.config?.user_actions?.tap_action;this.classes.tool.hover=!!t}MergeAnimationStyleIfChanged(t){if(this.animationStyleHasChanged){this.animationStyleHasChanged=!1;let e=this.config?.styles||this.config[this.config.type]?.styles;const s=JSON.stringify({config:e,animation:this.animationStyle,default:t});if(Et.styleCache.has(s))this.styles=Et.styleCache.get(s);else{if(this.styles=t?_t.mergeDeep(t,e,this.animationStyle):_t.mergeDeep(e,this.animationStyle),Et.styleCache.size>1e3){const t=Et.styleCache.keys().next().value;Et.styleCache.delete(t)}Et.styleCache.set(s,this.styles)}this.styles.card&&0!==Object.keys(this.styles.card).length&&(this._card.styles.card=_t.mergeDeep(this.styles.card)),Et.scheduleRenderUpdate.call(this)}}static scheduleRenderUpdate(){Et.rafId||(Et.rafId=requestAnimationFrame((()=>{Et.pendingRenderUpdates.forEach((t=>{t._card?.requestUpdate&&t._card.requestUpdate()})),Et.pendingRenderUpdates.clear(),Et.rafId=null}))),Et.pendingRenderUpdates.add(this)}MergeAnimationClassIfChanged(t){if(this.animationClassHasChanged=!0,this.animationClassHasChanged){this.animationClassHasChanged=!1;let e=this.config?.classes||this.config[this.config.type]?.classes;this.classes=t?_t.mergeDeep(t,e,this.animationClass):_t.mergeDeep(e,this.animationClass)}}MergeColorFromState(t){if(this.config.hasOwnProperty("entity_index")){const e=this.getColorFromState(this._stateValue);""!==e&&this.config?.show?.style&&t&&(t.fill=this.config[this.config.show.style].fill?e:"",t.stroke=this.config[this.config.show.style].stroke?e:"")}}MergeColorFromState2(t,e){if(this.config.hasOwnProperty("entity_index")){const s=this.config[this.config.show.style].fill?this.getColorFromState2(this._stateValue,e,"fill"):"",i=this.config[this.config.show.style].stroke?this.getColorFromState2(this._stateValue,e,"stroke"):"";""!==s&&(t.fill=s),""!==i&&(t.stroke=i)}}getColorFromState(t){let e="";switch(this.config.show.style){case"default":break;case"fixedcolor":e=this.config.color;break;case"colorstop":case"colorstops":case"colorstopgradient":e=At.calculateColor(t,this.colorStops,"colorstopgradient"===this.config.show.style);break;case"minmaxgradient":e=At.calculateColor(t,this.colorStopsMinMax,!0)}return e}getColorFromState2(t,e,s){let i="";switch(this.config.show.style){case"colorstop":case"colorstops":case"colorstopgradient":i=At.calculateColor2(t,this.csnew,e,s,"colorstopgradient"===this.config.show.style);break;case"minmaxgradient":i=At.calculateColor2(t,this.colorStopsMinMax,e,s,!0)}return i}_processTapEvent(t,e,s,i,a,r){let o;if(i){Mt(t,"haptic",i.haptic||"medium"),this.dev.debug&&console.log("_processTapEvent",s,i,a,r);for(let s=0;s<i.actions.length;s++)switch(i.actions[s].action){case"more-info":void 0!==a&&(o=new Event("hass-more-info",{composed:!0}),o.detail={entityId:a},t.dispatchEvent(o));break;case"navigate":if(!i.actions[s].navigation_path)return;window.history.pushState(null,"",i.actions[s].navigation_path),o=new Event("location-changed",{composed:!0}),o.detail={replace:!1},window.dispatchEvent(o);break;case"call-service":{if(!i.actions[s].service)return;const[t,o]=i.actions[s].service.split(".",2),n={...i.actions[s].service_data};n.entity_id||(n.entity_id=a),i.actions[s].parameter&&(n[i.actions[s].parameter]=r),e.callService(t,o,n);break}case"fire-dom-event":{const e={...i.actions[s]};o=new Event("ll-custom",{composed:!0,bubbles:!0}),o.detail=e,t.dispatchEvent(o);break}default:console.error("Unknown Event definition",i)}}}handleTapEvent(t,e){let s;t.stopPropagation(),t.preventDefault();let i=this.defaultEntityIndex();s=void 0===i||e.user_actions?e.user_actions?.tap_action:{haptic:"light",actions:[{action:"more-info"}]},s&&this._processTapEvent(this._card,this._card._hass,this.config,s,this._card.config.hasOwnProperty("entities")?this._card.config.entities[i]?.entity:void 0,void 0)}}class Ct extends Et{constructor(t,e,s){super(t,_t.mergeDeep({position:{cx:50,cy:50,width:100,height:25,radius:5,ratio:30,divider:30},classes:{tool:{"sak-badge":!0,hover:!0},left:{"sak-badge__left":!0},right:{"sak-badge__right":!0}},styles:{tool:{},left:{},right:{}}},e),s),this.svg.radius=wt.calculateSvgDimension(e.position.radius),this.svg.leftXpos=this.svg.x,this.svg.leftYpos=this.svg.y,this.svg.leftWidth=this.config.position.ratio/100*this.svg.width,this.svg.arrowSize=this.svg.height*this.config.position.divider/100/2,this.svg.divSize=this.svg.height*(100-this.config.position.divider)/100/2,this.svg.rightXpos=this.svg.x+this.svg.leftWidth,this.svg.rightYpos=this.svg.y,this.svg.rightWidth=(100-this.config.position.ratio)/100*this.svg.width,this.classes.tool={},this.classes.left={},this.classes.right={},this.styles.tool={},this.styles.left={},this.styles.right={},this.dev.debug&&console.log("BadgeTool constructor coords, dimensions",this.svg,this.config)}_renderBadge(){let t=[];return this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),t=z`
    ...
    `}}class It extends Et{constructor(t,e,s){switch(super(t,_t.mergeDeep({position:{cx:50,cy:50,radius:45,start_angle:30,end_angle:230,track:{width:2},active:{width:4},thumb:{height:10,width:10,radius:5},capture:{height:25,width:25,radius:25},label:{placement:"none",cx:10,cy:10}},show:{uom:"end",active:!1},classes:{tool:{"sak-circslider":!0,hover:!0},capture:{"sak-circslider__capture":!0,hover:!0},active:{"sak-circslider__active":!0},track:{"sak-circslider__track":!0},thumb:{"sak-circslider__thumb":!0,hover:!0},label:{"sak-circslider__value":!0},uom:{"sak-circslider__uom":!0}},styles:{tool:{},active:{},capture:{},track:{},thumb:{},label:{},uom:{}},scale:{min:0,max:100,step:1}},e),s),this.svg.radius=wt.calculateSvgDimension(this.config.position.radius),this.arc={},this.arc.startAngle=this.config.position.start_angle,this.arc.endAngle=this.config.position.end_angle,this.arc.size=yt(this.config.position.end_angle,this.config.position.start_angle),this.arc.clockwise=this.config.position.end_angle>this.config.position.start_angle,this.arc.direction=this.arc.clockwise?1:-1,this.arc.pathLength=2*this.arc.size/360*Math.PI*this.svg.radius,this.arc.arcLength=2*Math.PI*this.svg.radius,this.arc.startAngle360=vt(this.arc.startAngle,this.arc.startAngle,this.arc.endAngle),this.arc.endAngle360=vt(this.arc.startAngle,this.arc.endAngle,this.arc.endAngle),this.arc.startAngleSvgPoint=this.polarToCartesian(this.svg.cx,this.svg.cy,this.svg.radius,this.svg.radius,this.arc.startAngle360),this.arc.endAngleSvgPoint=this.polarToCartesian(this.svg.cx,this.svg.cy,this.svg.radius,this.svg.radius,this.arc.endAngle360),this.arc.scaleDasharray=2*this.arc.size/360*Math.PI*this.svg.radius,this.arc.dashOffset=this.arc.clockwise?0:-this.arc.scaleDasharray-this.arc.arcLength,this.arc.currentAngle=this.arc.startAngle,this.svg.startAngle=this.config.position.start_angle,this.svg.endAngle=this.config.position.end_angle,this.svg.diffAngle=this.config.position.end_angle-this.config.position.start_angle,this.svg.pathLength=2*this.arc.size/360*Math.PI*this.svg.radius,this.svg.circleLength=2*Math.PI*this.svg.radius,this.svg.label={},this.config.position.label.placement){case"position":this.svg.label.cx=wt.calculateSvgCoordinate(this.config.position.label.cx,0),this.svg.label.cy=wt.calculateSvgCoordinate(this.config.position.label.cy,0);break;case"thumb":this.svg.label.cx=this.svg.cx,this.svg.label.cy=this.svg.cy;break;case"none":break;default:throw console.error("CircularSliderTool - constructor: invalid label placement [none, position, thumb] = ",this.config.position.label.placement),Error("CircularSliderTool::constructor - invalid label placement [none, position, thumb] = ",this.config.position.label.placement)}this.svg.track={},this.svg.track.width=wt.calculateSvgDimension(this.config.position.track.width),this.svg.active={},this.svg.active.width=wt.calculateSvgDimension(this.config.position.active.width),this.svg.thumb={},this.svg.thumb.width=wt.calculateSvgDimension(this.config.position.thumb.width),this.svg.thumb.height=wt.calculateSvgDimension(this.config.position.thumb.height),this.svg.thumb.radius=wt.calculateSvgDimension(this.config.position.thumb.radius),this.svg.thumb.cx=this.svg.cx,this.svg.thumb.cy=this.svg.cy,this.svg.thumb.x1=this.svg.cx-this.svg.thumb.width/2,this.svg.thumb.y1=this.svg.cy-this.svg.thumb.height/2,this.svg.capture={},this.svg.capture.width=wt.calculateSvgDimension(Math.max(this.config.position.capture.width,1.2*this.config.position.thumb.width)),this.svg.capture.height=wt.calculateSvgDimension(Math.max(this.config.position.capture.height,1.2*this.config.position.thumb.height)),this.svg.capture.radius=wt.calculateSvgDimension(this.config.position.capture.radius),this.svg.capture.x1=this.svg.cx-this.svg.capture.width/2,this.svg.capture.y1=this.svg.cy-this.svg.capture.height/2,this.svg.rotate={},this.svg.rotate.degrees=this.arc.clockwise?-90+this.arc.startAngle:this.arc.endAngle360-90,this.svg.rotate.cx=this.svg.cx,this.svg.rotate.cy=this.svg.cy,this.classes.track={},this.classes.active={},this.classes.thumb={},this.classes.label={},this.classes.uom={},this.styles.track={},this.styles.active={},this.styles.thumb={},this.styles.label={},this.styles.uom={},this.svg.scale={},this.svg.scale.min=this.config.scale.min,this.svg.scale.max=this.config.scale.max,this.svg.scale.center=Math.abs(this.svg.scale.max-this.svg.scale.min)/2+this.svg.scale.min,this.svg.scale.svgPointMin=this.sliderValueToPoint(this.svg.scale.min),this.svg.scale.svgPointMax=this.sliderValueToPoint(this.svg.scale.max),this.svg.scale.svgPointCenter=this.sliderValueToPoint(this.svg.scale.center),this.svg.scale.step=this.config.scale.step,this.rid=null,this.thumbPos=this.sliderValueToPoint(this.config.scale.min),this.svg.thumb.x1=this.thumbPos.x-this.svg.thumb.width/2,this.svg.thumb.y1=this.thumbPos.y-this.svg.thumb.height/2,this.svg.capture.x1=this.thumbPos.x-this.svg.capture.width/2,this.svg.capture.y1=this.thumbPos.y-this.svg.capture.height/2,this.dev.debug&&console.log("CircularSliderTool::constructor",this.config,this.svg)}pointToAngle360(t,e,s){let i=-Math.atan2(t.y-e.y,e.x-t.x)/(Math.PI/180);return i+=-90,i<0&&(i+=360),this.arc.clockwise&&i<this.arc.startAngle360&&(i+=360),this.arc.clockwise||i<this.arc.endAngle360&&(i+=360),i}isAngle360InBetween(t){let e;return e=this.arc.clockwise?t>=this.arc.startAngle360&&t<=this.arc.endAngle360:t<=this.arc.startAngle360&&t>=this.arc.endAngle360,!!e}polarToCartesian(t,e,s,i,a){const r=(a-90)*Math.PI/180;return{x:t+s*Math.cos(r),y:e+i*Math.sin(r)}}pointToSliderValue(t){let e,s;const i={};i.x=this.svg.cx,i.y=this.svg.cy;const a=this.pointToAngle360(t,i,!0);let{myAngle:r}=this;const o=this.isAngle360InBetween(a);var n,h,l;return o&&(this.myAngle=a,r=a,this.arc.currentAngle=r),this.arc.currentAngle=r,this.arc.clockwise&&(s=(r-this.arc.startAngle360)/this.arc.size),this.arc.clockwise||(s=(this.arc.startAngle360-r)/this.arc.size),e=(this.config.scale.max-this.config.scale.min)*s+this.config.scale.min,e=Math.round(e/this.svg.scale.step)*this.svg.scale.step,e=Math.max(Math.min(this.config.scale.max,e),this.config.scale.min),this.arc.currentAngle=r,this.dragging&&!o&&(n=this.svg.scale.min,h=e,l=this.svg.scale.max,e=Math.abs(h-n)>Math.abs(l-h)?l:n,this.m=this.sliderValueToPoint(e)),e}sliderValueToPoint(t){let e,s=wt.calculateValueBetween(this.config.scale.min,this.config.scale.max,t);isNaN(s)&&(s=0),e=this.arc.clockwise?this.arc.size*s+this.arc.startAngle360:this.arc.size*(1-s)+this.arc.endAngle360,e<0&&(e+=360);const i=this.polarToCartesian(this.svg.cx,this.svg.cy,this.svg.radius,this.svg.radius,e);return this.arc.currentAngle=e,i}updateValue(t){this._value=this.pointToSliderValue(t);Math.abs(0)<.01&&this.rid&&(window.cancelAnimationFrame(this.rid),this.rid=null)}updateThumb(t){if(this.dragging){this.thumbPos=this.sliderValueToPoint(this._value),this.svg.thumb.x1=this.thumbPos.x-this.svg.thumb.width/2,this.svg.thumb.y1=this.thumbPos.y-this.svg.thumb.height/2,this.svg.capture.x1=this.thumbPos.x-this.svg.capture.width/2,this.svg.capture.y1=this.thumbPos.y-this.svg.capture.height/2;const t=`rotate(${this.arc.currentAngle} ${this.svg.capture.width/2} ${this.svg.capture.height/2})`;this.elements.thumb.setAttribute("transform",t),this.elements.thumbGroup.setAttribute("x",this.svg.capture.x1),this.elements.thumbGroup.setAttribute("y",this.svg.capture.y1)}this.updateLabel(t)}updateActiveTrack(t){const e=this.config.scale.min||0,s=this.config.scale.max||100;let i=wt.calculateValueBetween(e,s,this.labelValue);isNaN(i)&&(i=0);const a=i*this.svg.pathLength;this.dashArray=`${a} ${this.svg.circleLength}`,this.dragging&&this.elements.activeTrack.setAttribute("stroke-dasharray",this.dashArray)}updateLabel(t){this.dev.debug&&console.log("SLIDER - updateLabel start",t,this.config.position.orientation);const e=this._card.config.entities[this.defaultEntityIndex()].decimals||0,s=10**e;this.labelValue2=(Math.round(this.pointToSliderValue(t)*s)/s).toFixed(e),console.log("updateLabel, labelvalue ",this.labelValue2),"none"!==this.config.position.label.placement&&(this.elements.label.textContent=this.labelValue2)}mouseEventToPoint(t){let e=this.elements.svg.createSVGPoint();e.x=t.touches?t.touches[0].clientX:t.clientX,e.y=t.touches?t.touches[0].clientY:t.clientY;const s=this.elements.svg.getScreenCTM().inverse();return e=e.matrixTransform(s),e}callDragService(){void 0!==this.labelValue2&&(this.labelValuePrev!==this.labelValue2&&(this.labelValuePrev=this.labelValue2,this._processTapEvent(this._card,this._card._hass,this.config,this.config.user_actions.tap_action,this._card.config.entities[this.defaultEntityIndex()]?.entity,this.labelValue2)),this.dragging&&(this.timeOutId=setTimeout((()=>this.callDragService()),this.config.user_actions.drag_action.update_interval)))}callTapService(){void 0!==this.labelValue2&&this._processTapEvent(this._card,this._card._hass,this.config,this.config.user_actions?.tap_action,this._card.config.entities[this.defaultEntityIndex()]?.entity,this.labelValue2)}firstUpdated(t){function e(){this.rid=window.requestAnimationFrame(e),this.updateValue(this.m),this.updateThumb(this.m),this.updateActiveTrack(this.m)}this.labelValue=this._stateValue,this.dev.debug&&console.log("circslider - firstUpdated"),this.elements={},this.elements.svg=this._card.shadowRoot.getElementById("circslider-".concat(this.toolId)),this.elements.track=this.elements.svg.querySelector("#track"),this.elements.activeTrack=this.elements.svg.querySelector("#active-track"),this.elements.capture=this.elements.svg.querySelector("#capture"),this.elements.thumbGroup=this.elements.svg.querySelector("#thumb-group"),this.elements.thumb=this.elements.svg.querySelector("#thumb"),this.elements.label=this.elements.svg.querySelector("#label tspan"),this.dev.debug&&console.log("circslider - firstUpdated svg = ",this.elements.svg,"activeTrack=",this.elements.activeTrack,"thumb=",this.elements.thumb,"label=",this.elements.label,"text=",this.elements.text);const s=()=>{const t=yt(this.svg.scale.max,this.labelValue)<=this.rangeMax,e=yt(this.svg.scale.min,this.labelValue)<=this.rangeMin,s=!(!e||!this.diffMax),i=!(!t||!this.diffMin);s?(this.labelValue=this.svg.scale.max,this.m=this.sliderValueToPoint(this.labelValue),this.rangeMax=this.svg.scale.max/10,this.rangeMin=yt(this.svg.scale.max,this.svg.scale.min+this.svg.scale.max/5)):i?(this.labelValue=this.svg.scale.min,this.m=this.sliderValueToPoint(this.labelValue),this.rangeMax=yt(this.svg.scale.min,this.svg.scale.max-this.svg.scale.max/5),this.rangeMin=this.svg.scale.max/10):(this.diffMax=t,this.diffMin=e,this.rangeMin=this.svg.scale.max/5,this.rangeMax=this.svg.scale.max/5)},i=t=>{t.preventDefault(),this.dragging&&(this.m=this.mouseEventToPoint(t),this.labelValue=this.pointToSliderValue(this.m),s(),e.call(this))},a=t=>{t.preventDefault(),this.dragging=!0,window.addEventListener("pointermove",i,!1),window.addEventListener("pointerup",r,!1),this.config.user_actions?.drag_action&&this.config.user_actions?.drag_action.update_interval&&(this.config.user_actions.drag_action.update_interval>0?this.timeOutId=setTimeout((()=>this.callDragService()),this.config.user_actions.drag_action.update_interval):this.timeOutId=null),this.m=this.mouseEventToPoint(t),this.labelValue=this.pointToSliderValue(this.m),s(),this.dev.debug&&console.log("pointerDOWN",Math.round(100*this.m.x)/100),e.call(this)},r=t=>{t.preventDefault(),this.dev.debug&&console.log("pointerUP"),window.removeEventListener("pointermove",i,!1),window.removeEventListener("pointerup",r,!1),window.removeEventListener("mousemove",i,!1),window.removeEventListener("touchmove",i,!1),window.removeEventListener("mouseup",r,!1),window.removeEventListener("touchend",r,!1),this.labelValuePrev=this.labelValue,this.dragging?(this.dragging=!1,clearTimeout(this.timeOutId),this.timeOutId=null,this.target=0,this.labelValue2=this.labelValue,e.call(this),this.callTapService()):s()};this.elements.thumbGroup.addEventListener("touchstart",a,!1),this.elements.thumbGroup.addEventListener("mousedown",a,!1),this.elements.svg.addEventListener("wheel",(t=>{t.preventDefault(),clearTimeout(this.wheelTimeOutId),this.dragging=!0,this.wheelTimeOutId=setTimeout((()=>{clearTimeout(this.timeOutId),this.timeOutId=null,this.labelValue2=this.labelValue,this.dragging=!1,this.callTapService()}),500),this.config.user_actions?.drag_action&&this.config.user_actions?.drag_action.update_interval&&(this.config.user_actions.drag_action.update_interval>0?this.timeOutId=setTimeout((()=>this.callDragService()),this.config.user_actions.drag_action.update_interval):this.timeOutId=null);const s=+this.labelValue+ +(t.altKey?10*this.svg.scale.step:this.svg.scale.step)*Math.sign(t.deltaY);var i,a,r;this.labelValue=(i=this.svg.scale.min,a=s,r=this.svg.scale.max,Math.min(Math.max(a,i),r)),this.m=this.sliderValueToPoint(this.labelValue),this.pointToSliderValue(this.m),e.call(this),this.labelValue2=this.labelValue}),!1)}set value(t){if(super.value=t,this.dragging||(this.labelValue=this._stateValue),!this.dragging){const t=this.config.scale.min||0,e=this.config.scale.max||100;let s=Math.min(wt.calculateValueBetween(t,e,this._stateValue),1);isNaN(s)&&(s=0);const i=s*this.svg.pathLength;this.dashArray=`${i} ${this.svg.circleLength}`;const a=this.sliderValueToPoint(this._stateValue);this.svg.thumb.x1=a.x-this.svg.thumb.width/2,this.svg.thumb.y1=a.y-this.svg.thumb.height/2,this.svg.capture.x1=a.x-this.svg.capture.width/2,this.svg.capture.y1=a.y-this.svg.capture.height/2}}set values(t){if(super.values=t,this.dragging||(this.labelValue=this._stateValues[this.getIndexInEntityIndexes(this.defaultEntityIndex())]),!this.dragging){const t=this.config.scale.min||0,e=this.config.scale.max||100;let s=Math.min(wt.calculateValueBetween(t,e,this._stateValues[this.getIndexInEntityIndexes(this.defaultEntityIndex())]),1);isNaN(s)&&(s=0);const i=s*this.svg.pathLength;this.dashArray=`${i} ${this.svg.circleLength}`;const a=this.sliderValueToPoint(this._stateValues[this.getIndexInEntityIndexes(this.defaultEntityIndex())]);this.svg.thumb.x1=a.x-this.svg.thumb.width/2,this.svg.thumb.y1=a.y-this.svg.thumb.height/2,this.svg.capture.x1=a.x-this.svg.capture.width/2,this.svg.capture.y1=a.y-this.svg.capture.height/2}}_renderUom(){if("none"===this.config.show.uom)return z``;{this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.uom);let t=this.styles.label["font-size"],e=.5,s="em";const i=t.match(/\D+|\d*\.?\d+/g);2===i.length?(e=.6*Number(i[0]),s=i[1]):console.error("Cannot determine font-size for state/unit",t),t={"font-size":e+s},this.styles.uom=_t.mergeDeep(this.config.styles.uom,t);const a=this._card._buildUom(this.derivedEntity,this._card.entities[this.defaultEntityIndex()],this._card.config.entities[this.defaultEntityIndex()]);return"end"===this.config.show.uom?z`
        ...
        `:z`
          <tspan class="${St(this.classes.uom)}"  dx="-0.1em" dy="-0.35em"
            style="${nt(this.styles.uom)}">
            ERR</tspan>
        `}}_renderCircSlider(){return this.MergeAnimationClassIfChanged(),this.MergeColorFromState(),this.MergeAnimationStyleIfChanged(),this.renderValue=this._stateValue,this.dragging?this.renderValue=this.labelValue2:this.elements?.label&&(this.elements.label.textContent="undefined"===this.renderValue?"":this.renderValue),z`
      ...
      `}.call(this)}
        ${function(t){return"thumb"===this.config.position.label.placement&&t?z`
      <text id="label">
        ...
        `:"position"!==this.config.position.label.placement||t?void 0:z`
    ...
    `}}class Dt extends Et{constructor(t,e,s){super(t,_t.mergeDeep({position:{cx:50,cy:50,radiusx:50,radiusy:25},classes:{tool:{"sak-ellipse":!0,hover:!0},ellipse:{"sak-ellipse__ellipse":!0}},styles:{tool:{},ellipse:{}}},e),s),this.svg.radiusx=wt.calculateSvgDimension(e.position.radiusx),this.svg.radiusy=wt.calculateSvgDimension(e.position.radiusy),this.classes.tool={},this.classes.ellipse={},this.styles.tool={},this.styles.ellipse={},this.dev.debug&&console.log("EllipseTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}_renderEllipse(){return this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.ellipse),this.dev.debug&&console.log("EllipseTool - renderEllipse",this.svg.cx,this.svg.cy,this.svg.radiusx,this.svg.radiusy),z`
    ...
    `}}class Pt extends Et{constructor(t,e,s){super(t,_t.mergeDeep({classes:{tool:{},area:{"sak-area__area":!0,hover:!0}},styles:{tool:{},area:{}}},e),s),this.classes.tool={},this.classes.area={},this.styles.tool={},this.styles.area={},this.dev.debug&&console.log("EntityAreaTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}_buildArea(t,e){return e.area||"?"}_renderEntityArea(){this.MergeAnimationClassIfChanged(),this.MergeColorFromState(this.styles.area),this.MergeAnimationStyleIfChanged();const t=this.textEllipsis(this._buildArea(this._card.entities[this.defaultEntityIndex()],this._card.config.entities[this.defaultEntityIndex()]),this.config?.show?.ellipsis);return z`
        <text>
    ...
    `}}var qt=function(){return qt=Object.assign||function(t){for(var e,s=1,i=arguments.length;s<i;s++)for(var a in e=arguments[s])Object.prototype.hasOwnProperty.call(e,a)&&(t[a]=e[a]);return t},qt.apply(this,arguments)};function Wt(t,e,s){void 0===e&&(e=Date.now()),void 0===s&&(s={});var i=qt(qt({},Xt),s||{}),a=(+t-+e)/1e3;if(Math.abs(a)<i.second)return{value:Math.round(a),unit:"second"};var r=a/60;if(Math.abs(r)<i.minute)return{value:Math.round(r),unit:"minute"};var o=a/3600;if(Math.abs(o)<i.hour)return{value:Math.round(o),unit:"hour"};var n=a/86400;if(Math.abs(n)<i.day)return{value:Math.round(n),unit:"day"};var h=new Date(t),l=new Date(e),c=h.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var d=12*c+h.getMonth()-l.getMonth();if(Math.round(Math.abs(d))>0)return{value:Math.round(d),unit:"month"};var g=a/604800;return{value:Math.round(g),unit:"week"}}var Yt,Xt={second:45,minute:45,hour:22,day:5};!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(Yt=Yt||(Yt={}));const Jt=(t,e,s)=>{const i=e?(t=>{switch(t.number_format){case Yt.comma_decimal:return["en-US","en"];case Yt.decimal_comma:return["de","es","it"];case Yt.space_comma:return["fr","sv","cs"];case Yt.system:return;default:return t.language}})(e):void 0;if(Number.isNaN=Number.isNaN||function t(e){return"number"==typeof e&&t(e)},e?.number_format!==Yt.none&&!Number.isNaN(Number(t))&&Intl)try{return new Intl.NumberFormat(i,Zt(t,s)).format(Number(t))}catch(a){return console.error(a),new Intl.NumberFormat(void 0,Zt(t,s)).format(Number(t))}return!Number.isNaN(Number(t))&&""!==t&&e?.number_format===Yt.none&&Intl?new Intl.NumberFormat("en-US",Zt(t,{...s,useGrouping:!1})).format(Number(t)):"string"==typeof t?t:`${((t,e=2)=>Math.round(t*10**e)/10**e)(t,s?.maximumFractionDigits).toString()}${"currency"===s?.style?` ${s.currency}`:""}`},Zt=(t,e)=>{const s={maximumFractionDigits:2,...e};if("string"!=typeof t)return s;if(!e||void 0===e.minimumFractionDigits&&void 0===e.maximumFractionDigits){const e=t.indexOf(".")>-1?t.split(".")[1].length:0;s.minimumFractionDigits=e,s.maximumFractionDigits=e}return s};var Kt=Number.isNaN||function(t){return"number"==typeof t&&t!=t};function Qt(t,e){if(t.length!==e.length)return!1;for(var s=0;s<t.length;s++)if(i=t[s],a=e[s],!(i===a||Kt(i)&&Kt(a)))return!1;var i,a;return!0}function te(t,e){void 0===e&&(e=Qt);var s=null;function i(){for(var i=[],a=0;a<arguments.length;a++)i[a]=arguments[a];if(s&&s.lastThis===this&&e(i,s.lastArgs))return s.lastResult;var r=t.apply(this,i);return s={lastResult:r,lastArgs:i,lastThis:this},r}return i.clear=function(){s=null},i}const ee=te((t=>new Intl.DateTimeFormat(t.language,{weekday:"long",month:"long",day:"numeric"}))),se=te((t=>new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}))),ie=te((t=>new Intl.DateTimeFormat(t.language,{year:"numeric",month:"numeric",day:"numeric"}))),ae=(t,e)=>re(e).format(t),re=te((t=>new Intl.DateTimeFormat(t.language,{day:"numeric",month:"short"}))),oe=te((t=>new Intl.DateTimeFormat(t.language,{month:"long",year:"numeric"}))),ne=te((t=>new Intl.DateTimeFormat(t.language,{month:"long"})));te((t=>new Intl.DateTimeFormat(t.language,{year:"numeric"})));const he=te((t=>new Intl.DateTimeFormat(t.language,{weekday:"long"}))),le=te((t=>new Intl.DateTimeFormat(t.language,{weekday:"short"})));var ce;!function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ce=ce||(ce={}));const de=te((t=>{if(t.time_format===ce.language||t.time_format===ce.system){const e=t.time_format===ce.language?t.language:void 0,s=(new Date).toLocaleString(e);return s.includes("AM")||s.includes("PM")}return t.time_format===ce.am_pm})),ge=te((t=>new Intl.DateTimeFormat("en"!==t.language||de(t)?t.language:"en-u-hc-h23",{hour:"numeric",minute:"2-digit",hour12:de(t)}))),ue=te((t=>new Intl.DateTimeFormat("en"!==t.language||de(t)?t.language:"en-u-hc-h23",{hour:de(t)?"numeric":"2-digit",minute:"2-digit",second:"2-digit",hour12:de(t)}))),pe=te((t=>new Intl.DateTimeFormat("en"!==t.language||de(t)?t.language:"en-u-hc-h23",{weekday:"long",hour:de(t)?"numeric":"2-digit",minute:"2-digit",hour12:de(t)}))),me=t=>fe().format(t),fe=te((()=>new Intl.DateTimeFormat("en-GB",{hour:"numeric",minute:"2-digit",hour12:!1}))),ve=te((t=>new Intl.DateTimeFormat("en"!==t.language||de(t)?t.language:"en-u-hc-h23",{year:"numeric",month:"long",day:"numeric",hour:de(t)?"numeric":"2-digit",minute:"2-digit",hour12:de(t)}))),ye=te((t=>new Intl.DateTimeFormat("en"!==t.language||de(t)?t.language:"en-u-hc-h23",{year:"numeric",month:"short",day:"numeric",hour:de(t)?"numeric":"2-digit",minute:"2-digit",hour12:de(t)}))),_e=te((t=>new Intl.DateTimeFormat("en"!==t.language||de(t)?t.language:"en-u-hc-h23",{month:"short",day:"numeric",hour:de(t)?"numeric":"2-digit",minute:"2-digit",hour12:de(t)}))),be=te((t=>new Intl.DateTimeFormat("en"!==t.language||de(t)?t.language:"en-u-hc-h23",{year:"numeric",month:"long",day:"numeric",hour:de(t)?"numeric":"2-digit",minute:"2-digit",second:"2-digit",hour12:de(t)}))),we=te((t=>new Intl.DateTimeFormat("en"!==t.language||de(t)?t.language:"en-u-hc-h23",{year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"2-digit",hour12:de(t)}))),xe=(t,e=2)=>{let s=`${t}`;for(let i=1;i<e;i++)s=parseInt(s)<10**i?`0${s}`:s;return s};const $e={ms:1,s:1e3,min:6e4,h:36e5,d:864e5},ke=(t,e)=>function(t){const e=Math.floor(t/1e3/3600),s=Math.floor(t/1e3%3600/60),i=Math.floor(t/1e3%3600%60),a=Math.floor(t%1e3);return e>0?`${e}:${xe(s)}:${xe(i)}`:s>0?`${s}:${xe(i)}`:i>0||a>0?`${i}${a>0?`.${xe(a,3)}`:""}`:null}(parseFloat(t)*$e[e])||"0";class Se extends Et{constructor(t,e,s){super(t,_t.mergeDeep({show:{uom:"end"},classes:{tool:{"sak-state":!0,hover:!0},state:{"sak-state__value":!0},uom:{"sak-state__uom":!0}},styles:{tool:{},state:{},uom:{}}},e),s),this.classes.tool={},this.classes.state={},this.classes.uom={},this.styles.tool={},this.styles.state={},this.styles.uom={},this.dev.debug&&console.log("EntityStateTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}static{this.testTimeDate=!1}set value(t){super.value=t}formatStateString(t,e){const s=this._card._hass.selectedLanguage||this._card._hass.language;let i={};if(i.language=s,["relative","total","datetime","datetime-short","datetime-short_with-year","datetime_seconds","datetime-numeric","date","date_month","date_month_year","date-short","date-numeric","date_weekday","date_weekday_day","date_weekday-short","time","time-24h","time-24h_date-short","time_weekday","time_seconds"].includes(e.format)){const a=new Date(t);if(!(a instanceof Date)||isNaN(a.getTime()))return t;let r;switch(e.format){case"relative":const t=Wt(a,new Date);r=new Intl.RelativeTimeFormat(s,{numeric:"auto"}).format(t.value,t.unit);break;case"total":case"precision":r="Not Yet Supported";break;case"datetime":r=((t,e)=>ve(e).format(t))(a,i);break;case"datetime-short":r=((t,e)=>_e(e).format(t))(a,i);break;case"datetime-short_with-year":r=((t,e)=>ye(e).format(t))(a,i);break;case"datetime_seconds":r=((t,e)=>be(e).format(t))(a,i);break;case"datetime-numeric":r=((t,e)=>we(e).format(t))(a,i);break;case"date":r=((t,e)=>se(e).format(t))(a,i);break;case"date_month":r=((t,e)=>ne(e).format(t))(a,i);break;case"date_month_year":r=((t,e)=>oe(e).format(t))(a,i);break;case"date-short":r=ae(a,i);break;case"date-numeric":r=((t,e)=>ie(e).format(t))(a,i);break;case"date_weekday":r=((t,e)=>he(e).format(t))(a,i);break;case"date_weekday-short":r=((t,e)=>le(e).format(t))(a,i);break;case"date_weekday_day":r=((t,e)=>ee(e).format(t))(a,i);break;case"time":r=((t,e)=>ge(e).format(t))(a,i);break;case"time-24h":r=me(a);break;case"time-24h_date-short":const e=Wt(a,new Date);r=["second","minute","hour"].includes(e.unit)?me(a):ae(a,i);break;case"time_weekday":r=((t,e)=>pe(e).format(t))(a,i);break;case"time_seconds":r=((t,e)=>ue(e).format(t))(a,i)}return r}return isNaN(parseFloat(t))||!isFinite(t)?t:"brightness"===e.format||"brightness_pct"===e.format?`${Math.round(t/255*100)} %`:"duration"===e.format?ke(t,"s"):void 0}_renderState(){this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.state);let t=this._stateValue;const e=this._card.entities[this.defaultEntityIndex()];if(void 0===e)return z``;if([void 0,"undefined"].includes(t))return z``;if(void 0===t)return z``;const s=this._card._hass.entities[e.entity_id],i=this._card._hass.states[e.entity_id],a=this._card.config.entities[this.defaultEntityIndex()],r=Vt(this._card.entities[this.defaultEntityIndex()].entity_id),o=this.config.locale_tag?this.config.locale_tag+t.toLowerCase():void 0;if(void 0!==a.format&&void 0!==t&&(t=this.formatStateString(t,a)),(t&&isNaN(t)&&!a.secondary_info||a.attribute)&&(t=o&&this._card._hass.localize(o)||s?.translation_key&&this._card._hass.localize(`component.${s.platform}.entity.${r}.${s.translation_key}.state.${t}`)||i?.attributes?.device_class&&this._card._hass.localize(`component.${r}.entity_component.${i.attributes.device_class}.state.${t}`)||this._card._hass.localize(`component.${r}.entity_component._.state.${t}`)||t,t=this.textEllipsis(t,this.config?.show?.ellipsis)),["undefined","unknown","unavailable","-ua-"].includes(t)&&(t=this._card._hass.localize(`state.default.${t}`)),!isNaN(t)){let e={};e=Zt(t,e),void 0!==this._card.config.entities[this.defaultEntityIndex()].decimals&&(e.maximumFractionDigits=this._card.config.entities[this.defaultEntityIndex()].decimals,e.minimumFractionDigits=e.maximumFractionDigits),t=Jt(t,this._card._hass.locale,e)}return z`
    ...
    `}_renderUom(){if("none"===this.config.show.uom||void 0===this._stateValue)return z``;{this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.uom);let t=this.styles.state["font-size"],e=.5,s="em";const i=t.match(/\D+|\d*\.?\d+/g);2===i.length?(e=.6*Number(i[0]),s=i[1]):console.error("Cannot determine font-size for state/unit",t),t={"font-size":e+s},this.styles.uom=_t.mergeDeep(this.config.styles.uom,this.styles.uom,t);const a=this._card._buildUom(this.derivedEntity,this._card.entities[this.defaultEntityIndex()],this._card.config.entities[this.defaultEntityIndex()]);return"end"===this.config.show.uom?z`
          <tspan class="${St(this.classes.uom)}" dx="-0.1em" dy="-0.35em"
            style="${nt(this.styles.uom)}">
            ${a}</tspan>
        `:"bottom"===this.config.show.uom?z`
        ...
        `:"top"===this.config.show.uom?z`
          <tspan class="${St(this.classes.uom)}" x="${this.svg.x}" dy="-1.5em"
            style="${nt(this.styles.uom)}">
            ${a}</tspan>
        `:z``}}firstUpdated(t){}updated(t){}render(){return z`
    ...
    <mask id=${`fill-${this.id}-${e}`}>
      <path class='fill'
        ...
        d=${this.area[e]}
      />
      ${this.Graph[e]._min<0?z`<path class='fill'
            type=${this.config.sparkline.show.fill}
            .id=${e} anim=${this.config.sparkline.animate} ?init=${i}
            style="animation-delay: ${this.config.sparkline.animate?.5*e+"s":"0s"}"
            fill='white'
    ...
    <mask id=${`fillMinMax-${this.id}-${e}`}>
      ...
      ${this.Graph[e]._min<0?z`<path class='fill'
            ...
            d=${this.areaMinMax[e]}
          />`:""}
    </mask>`}renderSvgLineMask(t,e){if(!t)return;const s=z`
    <path
      class='line'
      .id=${e}
  ...
  `}renderSvgLineMinMaxMask(t,e){if("line"!==this.config.sparkline.show.chart_type)return;if(!t)return;const s=z`
    <path
      class='lineMinMax'
      .id=${e}
      anim=${this.config.sparkline.animate} ?init=${this.length[e]}
  ...
  `}renderSvgPoint(t,e){const s=this.gradient[e]?this.computeColor(t[2],e):"inherit";return z`
    <circle
      class='line--point'
    ...
    />
  `}renderSvgPoints(t,e){if(!t)return;const s=this.computeColor(this._card.entities[e].state,e);return z`
    <g class='line--points'
    ...
    ${i}
    `}renderSvgGraded(t,e){if(!t)return;const s=this.computeColor(this._card.entities[e].state,e),i=this.xLines.lines.map((t=>"below"===t.zpos?[z`
        <line class=${St(this.classes[t.id])}) style="${nt(this.styles[t.id])}"
        ...
        `]:[""])),a=this.xLines.lines.map((t=>"above"===t.zpos?[z`
        <line class="${St(this.classes[t.id])}"
    ...
    <g class='traffic-lights'
      ...
      ${a}
    </g>`}renderSvgGradient(t){if(!t)return;const e=t.map(((t,e)=>{if(t)return z`
      <linearGradient id=${`grad-${this.id}-${e}`} gradientTransform="rotate(90)">
        ${t.map((t=>z`
          <stop stop-color=${t.color} offset=${`${t.offset}%`} />
        `))}
      </linearGradient>`}));return z`${e}`}renderSvgLineBackground(t,e){if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.computeColor(this._card.entities[e].state,e),i=this.xLines.lines.map((t=>"below"===t.zpos?[z`
        <line class=${St(this.classes[t.id])}) style="${nt(this.styles[t.id])}"
        x1="${this.svg.margin.x}" y1="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
        x2="${this.svg.graph.width+this.svg.margin.x}" y2="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
        pathLength="240"
    ...
    />
    ${a}
    `}renderSvgLineMinMaxBackground(t,e){if("line"!==this.config.sparkline.show.chart_type)return;if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.computeColor(this._card.entities[e].state,e);return z`
    <rect class='line--rect'
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      id=${`line-rect-${this.id}-${e}`}
      fill=${s} height="100%" width="100%"
      mask=${`url(#lineMinMax-${this.id}-${e})`}
    />`}renderSvgAreaBackground(t,e){if("area"!==this.config.sparkline.show.chart_type)return;if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e),i=this.xLines.lines.map((t=>"below"===t.zpos?[z`
          <line class=${St(this.classes[t.id])}) style="${nt(this.styles[t.id])}"
          x1="${this.svg.margin.x}" y1="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
          x2="${this.svg.graph.width+this.svg.margin.x}" y2="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
          pathLength="240"
    ...
    />`}renderSvgEqualizerMask(t,e){if("equalizer"!==this.config.sparkline.show.chart_type)return;if(!t)return;const s="fade"===this.config.sparkline.show.fill;this.id;const i=`url(#fill-grad-mask-pos-${this.id}-${e}})`,a=this.config.sparkline.styles.bar_mask_below.fill,r=this.config.sparkline.styles.bar_mask_above.fill;let o;if(!0===this.config.sparkline.equalizer.square&&(o=Math.min(t[0].width,t[0].height),o<t[0].height)){let e=(this.svg.height-this.config.sparkline.equalizer.value_buckets*o)/(this.config.sparkline.equalizer.value_buckets-1),s=t.map(((t,s)=>{let i={...t};for(let a=0;a<t.y.length;a++)i.y[a]=this.svg.height-a*(o+e);return i.width=o,i.height=o,i}));t=[...s]}const n=t.map(((t,i)=>{const n=t.value.map(((i,n)=>{const h=this.config.sparkline.animate?z`
      ...
      <rect class="${St(this.classes.equalizer_part)}"
  ...
  `}renderSvgEqualizerBackground(t,e){if("equalizer"!==this.config.sparkline.show.chart_type)return;if(!t)return;if("fadenever"===this.config.sparkline.show.fill){this.length[e]||this._card.config.entities[e].show_line;const t=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e);return this.gradient[e]?this.id:this.intColor(this._card.entities[e].state,e),z`
      <defs>
      ...
      <g mask = ${`url(#fill-grad-mask-${this.id}-${e})`}>
        ...
        />
      /g>`}{const t=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.computeColor(this._card.entities[e].state,e),s=this.xLines.lines.map((t=>"below"===t.zpos?[z`
            <line class=${St(this.classes[t.id])}) style="${nt(this.styles[t.id])}"
            x1="${this.svg.margin.x}" y1="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
            x2="${this.svg.graph.width+this.svg.margin.x}" y2="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
            pathLength="240"
            ...
            `]:[""])),i=this.xLines.lines.map((t=>"above"===t.zpos?[z`
            <line class="${St(this.classes[t.id])}"
                  style="${nt(this.styles[t.id])}"
            x1="${this.svg.margin.x}" y1="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
            x2="${this.svg.graph.width+this.svg.margin.x}" y2="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
      ...
      <g mask = ${`url(#fill-grad-mask-${this.id}-${e})`}>
        ...
        />
      /g>`}{const t=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.computeColor(this._card.entities[e].state,e);return z`
      <rect class='bars--bg'
        ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
        id=${`bars-bg-${this.id}-${e}`}
        fill=${t} height="100%" width="100%"
        mask=${`url(#bars-bg-${this.id}-${e})`}
      />`}}renderSvgBars(t,e){if(!t)return;const s=t.map(((t,s)=>{const i=this.config.sparkline.animate?z`
        <animate attributeName='y' from=${this.svg.height} to=${t.y} dur='2s' fill='remove'
          calcMode='spline' keyTimes='0; 1' keySplines='0.215 0.61 0.355 1'>
        </animate>`:"",a=this.computeColor(t.value,e);return z` 
      ...
      </rect>`}));return z`<g class='bars' ?anim=${this.config.sparkline.animate}>${s}</g>`}renderSvgRadialBarcodeBin(t,e,s){const i=this.intColor(t.value,0);return z`
  <path class="${St(this.classes.clock_graph)}"
        style="${nt(this.styles.clock_graph)}"
    d=${e}
    fill=${i}
    stroke=${i}
  >
  `}renderSvgRadialBarcodeBackgroundBin(t,e,s){return z`
  <path class="${St(this.classes.radial_barcode_background)}"
        style="${nt(this.styles.radial_barcode_background)}"
    d=${e}
  >
  `}renderSvgRadialBarcodeBackground(t){const{start:e,end:s,start2:i,end2:a,largeArcFlag:r,sweepFlag:o}=this.Graph[0]._calcRadialBarcodeCoords(0,359.9,!0,t,t,this.radialBarcodeChartWidth),n={x:t-this.radialBarcodeChartWidth,y:t-this.radialBarcodeChartWidth},h=["M",e.x,e.y,"A",t,t,0,r,o,s.x,s.y,"L",a.x,a.y,"A",n.x,n.y,0,r,"0"===o?"1":"0",i.x,i.y,"Z"].join(" ");return z`
    <path
      style="fill: lightgray; opacity: 0.4"
      d="${h}"
    />
  `}renderSvgRadialBarcodeFace(t){if(!this.config?.clock?.face)return z``;return z`
    ${(()=>!0===this.config.radial_barcode.face?.show_day_night?z`
          <circle pathLength="1"
          class="${St(this.classes.radial_barcode_face_day_night)}" style="${nt(this.styles.radial_barcode_face_day_night)}"
          r="${this.svg.clockface.dayNightRadius}" cx=${this.svg.width/2} cy="${this.svg.height/2}"
          />
        `:"")()}
    ${(()=>!0===this.config.radial_barcode.face?.show_hour_marks?z`
        <circle pathLength=${this.config.radial_barcode.face.hour_marks_count}
        class="${St(this.classes.radial_barcode_face_hour_marks)}" style="${nt(this.styles.radial_barcode_face_hour_marks)}"
        r="${this.svg.clockface.hourMarksRadius}" cx=${this.svg.width/2} cy="${this.svg.height/2}"
        />
       `:"")()}
    ${(()=>"absolute"===this.config.radial_barcode.face?.show_hour_numbers?z`
        <g>
          <text class="${St(this.classes.radial_barcode_face_hour_numbers)}" style="${nt(this.styles.radial_barcode_face_hour_numbers)}"
    ...
    ${(()=>"relative"===this.config.radial_barcode.face?.show_hour_numbers?z`
        <g>
          <text class="${St(this.classes.radial_barcode_face_hour_numbers)}" style="${nt(this.styles.radial_barcode_face_hour_numbers)}"
            x="${this.svg.width/2}" y="${this.svg.height/2-this.svg.clockface.hourNumbersRadius}"
            >0</text>
  ...
  `}renderSvgRadialBarcode(t,e){if(!t)return;const s=this.Graph[e].getRadialBarcodePaths(),i=this.Graph[e].getRadialBarcodeBackgroundPaths();return z`
    <g class='graph-clock'
      ?tooltip=${this.tooltip.entity===e}
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      ?init=${this.length[e]}
      ...
      </rect>`})),i=this.xLines.lines.map((t=>"below"===t.zpos?[z`
        <!-- Line Below -->
        <line class=${St(this.classes[t.id])} style="${nt(this.styles[t.id])}"
        x1="${this.svg.margin.x}" y1="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
        x2="${this.svg.graph.width+this.svg.margin.x}" y2="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
  ...
  `}renderSvg(){return this.config.sparkline.colorstops.colors.length>0&&!this._card.config.entities[0].color&&(this.gradient[0]=this.Graph[0].computeGradient(this.config.sparkline.colorstops.colors,this.config.sparkline.state_values.logarithmic)),this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),z`
    ...
    >
    ...
    </svg>`}updated(t){this.config.sparkline.animate&&t.has("line")&&(this.length.length<this.entity.length?(this._card.shadowRoot.querySelectorAll("svg path.line").forEach((t=>{this.length[t.id]=t.getTotalLength()})),this.length=[...this.length]):this.length=Array(this.entity.length).fill("none"))}render(){return z`
      ...
      `}}class De extends Et{constructor(t,e,s){super(t,_t.mergeDeep({position:{cx:50,cy:50,radius:45},card_filter:"card--filter-none",horseshoe_scale:{min:0,max:100,width:3,color:"var(--primary-background-color)"},horseshoe_state:{width:6,color:"var(--primary-color)"},show:{horseshoe:!0,scale_tickmarks:!1,horseshoe_style:"fixed"}},e),s),this.HORSESHOE_RADIUS_SIZE=180,this.TICKMARKS_RADIUS_SIZE=172,this.HORSESHOE_PATH_LENGTH=520/360*Math.PI*this.HORSESHOE_RADIUS_SIZE,this.config.entity_index=this.config.entity_index?this.config.entity_index:0,this.svg.radius=wt.calculateSvgDimension(this.config.position.radius),this.svg.radius_ticks=wt.calculateSvgDimension(.95*this.config.position.radius),this.svg.horseshoe_scale={},this.svg.horseshoe_scale.width=wt.calculateSvgDimension(this.config.horseshoe_scale.width),this.svg.horseshoe_state={},this.svg.horseshoe_state.width=wt.calculateSvgDimension(this.config.horseshoe_state.width),this.svg.horseshoe_scale.dasharray=52/36*Math.PI*this.svg.radius,this.svg.rotate={},this.svg.rotate.degrees=-220,this.svg.rotate.cx=this.svg.cx,this.svg.rotate.cy=this.svg.cy,this.colorStops={},this.config.color_stops&&Object.keys(this.config.color_stops).forEach((t=>{this.colorStops[t]=this.config.color_stops[t]})),this.sortedStops=Object.keys(this.colorStops).map((t=>Number(t))).sort(((t,e)=>t-e)),this.colorStopsMinMax={},this.colorStopsMinMax[this.config.horseshoe_scale.min]=this.colorStops[this.sortedStops[0]],this.colorStopsMinMax[this.config.horseshoe_scale.max]=this.colorStops[this.sortedStops[this.sortedStops.length-1]],this.color0=this.colorStops[this.sortedStops[0]],this.color1=this.colorStops[this.sortedStops[this.sortedStops.length-1]],this.angleCoords={x1:"0%",y1:"0%",x2:"100%",y2:"0%"},this.color1_offset="0%",this.dev.debug&&console.log("HorseshoeTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}set value(t){if(this._stateValue===t)return;this._stateValuePrev=this._stateValue||t,this._stateValue=t,this._stateValueIsDirty=!0;const e=this.config.horseshoe_scale.min||0,s=this.config.horseshoe_scale.max||100,i=Math.min(wt.calculateValueBetween(e,s,t),1),a=i*this.HORSESHOE_PATH_LENGTH,r=10*this.HORSESHOE_RADIUS_SIZE;this.dashArray=`${a} ${r}`;const o=this.config.show.horseshoe_style;if("fixed"===o)this.stroke_color=this.config.horseshoe_state.color,this.color0=this.config.horseshoe_state.color,this.color1=this.config.horseshoe_state.color,this.color1_offset="0%";else if("autominmax"===o){const e=At.calculateColor(t,this.colorStopsMinMax,!0);this.color0=e,this.color1=e,this.color1_offset="0%"}else if("colorstop"===o||"colorstopgradient"===o){const e=At.calculateColor(t,this.colorStops,"colorstopgradient"===o);this.color0=e,this.color1=e,this.color1_offset="0%"}else if("lineargradient"===o){const t={x1:"0%",y1:"0%",x2:"100%",y2:"0%"};this.color1_offset=`${Math.round(100*(1-i))}%`,this.angleCoords=t}this.dev.debug&&console.log("HorseshoeTool set value",this.cardId,t)}_renderTickMarks(){const{config:t}=this;if(!t.show.scale_tickmarks)return;const e=t.horseshoe_scale.color?t.horseshoe_scale.color:"var(--primary-background-color)",s=t.horseshoe_scale.ticksize?t.horseshoe_scale.ticksize:(t.horseshoe_scale.max-t.horseshoe_scale.min)/10,i=t.horseshoe_scale.min%s,a=t.horseshoe_scale.min+(0===i?0:s-i),r=(a-t.horseshoe_scale.min)/(t.horseshoe_scale.max-t.horseshoe_scale.min)*260,o=(t.horseshoe_scale.max-a)/s;let n=Math.floor(o);const h=(260-r)/o;Math.floor(n*s+a)<=t.horseshoe_scale.max&&(n+=1);const l=this.svg.horseshoe_scale.width?this.svg.horseshoe_scale.width/2:3;let c;const d=[];let g;for(g=0;g<n;g++)c=r+(360-g*h-230)*Math.PI/180,d[g]=z`
        <circle cx="${this.svg.cx-Math.sin(c)*this.svg.radius_ticks}"
                cy="${this.svg.cy-Math.cos(c)*this.svg.radius_ticks}" r="${l}"
                fill="${e}">
      `;return z`${d}`}_renderHorseShoe(){if(this.config.show.horseshoe)return z`
    ...
    `}}class Re extends Et{constructor(t,e,s){switch(super(t,_t.mergeDeep({descr:"none",position:{cx:50,cy:50,orientation:"horizontal",active:{width:0,height:0,radius:0},track:{width:16,height:7,radius:3.5},thumb:{width:9,height:9,radius:4.5,offset:4.5},label:{placement:"none"}},show:{uom:"end",active:!1},classes:{tool:{"sak-slider":!0,hover:!0},capture:{"sak-slider__capture":!0},active:{"sak-slider__active":!0},track:{"sak-slider__track":!0},thumb:{"sak-slider__thumb":!0},label:{"sak-slider__value":!0},uom:{"sak-slider__uom":!0}},styles:{tool:{},capture:{},active:{},track:{},thumb:{},label:{},uom:{}}},e),s),this.svg.activeTrack={},this.svg.activeTrack.radius=wt.calculateSvgDimension(this.config.position.active.radius),this.svg.activeTrack.height=wt.calculateSvgDimension(this.config.position.active.height),this.svg.activeTrack.width=wt.calculateSvgDimension(this.config.position.active.width),this.svg.track={},this.svg.track.radius=wt.calculateSvgDimension(this.config.position.track.radius),this.svg.thumb={},this.svg.thumb.radius=wt.calculateSvgDimension(this.config.position.thumb.radius),this.svg.thumb.offset=wt.calculateSvgDimension(this.config.position.thumb.offset),this.svg.capture={},this.svg.label={},this.config.position.orientation){case"horizontal":case"vertical":this.svg.capture.width=wt.calculateSvgDimension(this.config.position.capture.width||1.1*this.config.position.track.width),this.svg.capture.height=wt.calculateSvgDimension(this.config.position.capture.height||3*this.config.position.thumb.height),this.svg.track.width=wt.calculateSvgDimension(this.config.position.track.width),this.svg.track.height=wt.calculateSvgDimension(this.config.position.track.height),this.svg.thumb.width=wt.calculateSvgDimension(this.config.position.thumb.width),this.svg.thumb.height=wt.calculateSvgDimension(this.config.position.thumb.height),this.svg.capture.x1=this.svg.cx-this.svg.capture.width/2,this.svg.capture.y1=this.svg.cy-this.svg.capture.height/2,this.svg.track.x1=this.svg.cx-this.svg.track.width/2,this.svg.track.y1=this.svg.cy-this.svg.track.height/2,this.svg.activeTrack.x1="horizontal"===this.config.position.orientation?this.svg.track.x1:this.svg.cx-this.svg.activeTrack.width/2,this.svg.activeTrack.y1=this.svg.cy-this.svg.activeTrack.height/2,this.svg.thumb.x1=this.svg.cx-this.svg.thumb.width/2,this.svg.thumb.y1=this.svg.cy-this.svg.thumb.height/2;break;default:throw console.error("RangeSliderTool - constructor: invalid orientation [vertical, horizontal] = ",this.config.position.orientation),Error("RangeSliderTool::constructor - invalid orientation [vertical, horizontal] = ",this.config.position.orientation)}if("vertical"===this.config.position.orientation)this.svg.track.y2=this.svg.cy+this.svg.track.height/2,this.svg.activeTrack.y2=this.svg.track.y2;switch(this.config.position.label.placement){case"position":this.svg.label.cx=wt.calculateSvgCoordinate(this.config.position.label.cx,0),this.svg.label.cy=wt.calculateSvgCoordinate(this.config.position.label.cy,0);break;case"thumb":this.svg.label.cx=this.svg.cx,this.svg.label.cy=this.svg.cy;break;case"none":break;default:throw console.error("RangeSliderTool - constructor: invalid label placement [none, position, thumb] = ",this.config.position.label.placement),Error("RangeSliderTool::constructor - invalid label placement [none, position, thumb] = ",this.config.position.label.placement)}this.classes.capture={},this.classes.track={},this.classes.thumb={},this.classes.label={},this.classes.uom={},this.styles.capture={},this.styles.track={},this.styles.thumb={},this.styles.label={},this.styles.uom={},this.svg.scale={},this.svg.scale.min=this.valueToSvg(this,this.config.scale.min),this.svg.scale.max=this.valueToSvg(this,this.config.scale.max),this.svg.scale.step=this.config.scale.step,this.dev.debug&&console.log("RangeSliderTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}svgCoordinateToSliderValue(t,e){let s,i,a,r;switch(t.config.position.orientation){case"horizontal":a=e.x-t.svg.track.x1-this.svg.thumb.width/2,i=a/(t.svg.track.width-this.svg.thumb.width);break;case"vertical":r=t.svg.track.y2-this.svg.thumb.height/2-e.y,i=r/(t.svg.track.height-this.svg.thumb.height)}return s=(t.config.scale.max-t.config.scale.min)*i+t.config.scale.min,s=Math.round(s/this.svg.scale.step)*this.svg.scale.step,s=Math.max(Math.min(this.config.scale.max,s),this.config.scale.min),s}valueToSvg(t,e){if("horizontal"===t.config.position.orientation){const s=wt.calculateValueBetween(t.config.scale.min,t.config.scale.max,e)*(t.svg.track.width-this.svg.thumb.width);return t.svg.track.x1+this.svg.thumb.width/2+s}if("vertical"===t.config.position.orientation){const s=wt.calculateValueBetween(t.config.scale.min,t.config.scale.max,e)*(t.svg.track.height-this.svg.thumb.height);return t.svg.track.y2-this.svg.thumb.height/2-s}}updateValue(t,e){this._value=this.svgCoordinateToSliderValue(t,e);Math.abs(0)<.01&&this.rid&&(window.cancelAnimationFrame(this.rid),this.rid=null)}updateThumb(t,e){switch(t.config.position.orientation){default:case"horizontal":if(this.config.position.label.placement,this.dragging){const s="thumb"===this.config.position.label.placement?-50:0,i=`translate(${e.x-this.svg.cx}px , ${s}px)`;t.elements.thumbGroup.style.transform=i}else t.elements.thumbGroup.style.transform=`translate(${e.x-this.svg.cx}px, 0px)`;break;case"vertical":if(this.dragging){const s=`translate(${"thumb"===this.config.position.label.placement?-50:0}px, ${e.y-this.svg.cy}px)`;t.elements.thumbGroup.style.transform=s}else t.elements.thumbGroup.style.transform=`translate(0px, ${e.y-this.svg.cy}px)`}t.updateLabel(t,e)}updateActiveTrack(t,e){if(t.config.show.active)switch(t.config.position.orientation){default:case"horizontal":this.dragging&&t.elements.activeTrack.setAttribute("width",Math.abs(this.svg.activeTrack.x1-e.x+this.svg.cx));break;case"vertical":this.dragging&&(t.elements.activeTrack.setAttribute("y",e.y-this.svg.cy),t.elements.activeTrack.setAttribute("height",Math.abs(t.svg.activeTrack.y2-e.y+this.svg.cx)))}}updateLabel(t,e){this.dev.debug&&console.log("SLIDER - updateLabel start",e,t.config.position.orientation);const s=this._card.config.entities[this.defaultEntityIndex()].decimals||0,i=10**s;t.labelValue2=(Math.round(t.svgCoordinateToSliderValue(t,e)*i)/i).toFixed(s),"none"!==this.config.position.label.placement&&(t.elements.label.textContent=t.labelValue2)}mouseEventToPoint(t){let e=this.elements.svg.createSVGPoint();e.x=t.touches?t.touches[0].clientX:t.clientX,e.y=t.touches?t.touches[0].clientY:t.clientY;const s=this.elements.svg.getScreenCTM().inverse();return e=e.matrixTransform(s),e}callDragService(){void 0!==this.labelValue2&&(this.labelValuePrev!==this.labelValue2&&(this.labelValuePrev=this.labelValue2,this._processTapEvent(this._card,this._card._hass,this.config,this.config.user_actions.tap_action,this._card.config.entities[this.defaultEntityIndex()]?.entity,this.labelValue2)),this.dragging&&(this.timeOutId=setTimeout((()=>this.callDragService()),this.config.user_actions.drag_action.update_interval)))}callTapService(){void 0!==this.labelValue2&&this.labelValuePrev!==this.labelValue2&&(this.labelValuePrev=this.labelValue2,this._processTapEvent(this._card,this._card._hass,this.config,this.config.user_actions?.tap_action,this._card.config.entities[this.defaultEntityIndex()]?.entity,this.labelValue2))}firstUpdated(t){function e(){this.rid=window.requestAnimationFrame(e),this.updateValue(this,this.m),this.updateThumb(this,this.m),this.updateActiveTrack(this,this.m)}function s(t){let s;if(t.preventDefault(),this.dragging){switch(this.m=this.mouseEventToPoint(t),this.config.position.orientation){case"horizontal":s=this.svgCoordinateToSliderValue(this,this.m),this.m.x=this.valueToSvg(this,s),this.m.x=Math.max(this.svg.scale.min,Math.min(this.m.x,this.svg.scale.max)),this.m.x=Math.round(this.m.x/this.svg.scale.step)*this.svg.scale.step;break;case"vertical":s=this.svgCoordinateToSliderValue(this,this.m),this.m.y=this.valueToSvg(this,s),this.m.y=Math.round(this.m.y/this.svg.scale.step)*this.svg.scale.step}e.call(this)}}function i(t){t.preventDefault(),window.addEventListener("pointermove",s.bind(this),!1),window.addEventListener("pointerup",a.bind(this),!1);const i=this.mouseEventToPoint(t),r=this.svg.thumb.x1+this.svg.thumb.cx;i.x>r-10&&i.x<r+this.svg.thumb.width+10?(Mt(window,"haptic","heavy"),this.dragging=!0,this.config.user_actions?.drag_action&&this.config.user_actions?.drag_action.update_interval&&(this.config.user_actions.drag_action.update_interval>0?this.timeOutId=setTimeout((()=>this.callDragService()),this.config.user_actions.drag_action.update_interval):this.timeOutId=null),this.m=this.mouseEventToPoint(t),"horizontal"===this.config.position.orientation?this.m.x=Math.round(this.m.x/this.svg.scale.step)*this.svg.scale.step:this.m.y=Math.round(this.m.y/this.svg.scale.step)*this.svg.scale.step,this.dev.debug&&console.log("pointerDOWN",Math.round(100*this.m.x)/100),e.call(this)):Mt(window,"haptic","error")}function a(t){t.preventDefault(),window.removeEventListener("pointermove",s.bind(this),!1),window.removeEventListener("pointerup",a.bind(this),!1),window.removeEventListener("mousemove",s.bind(this),!1),window.removeEventListener("touchmove",s.bind(this),!1),window.removeEventListener("mouseup",a.bind(this),!1),window.removeEventListener("touchend",a.bind(this),!1),this.dragging&&(this.dragging=!1,clearTimeout(this.timeOutId),this.target=0,this.dev.debug&&console.log("pointerUP"),e.call(this),this.callTapService())}this.labelValue=this._stateValue,this.dev.debug&&console.log("slider - firstUpdated"),this.elements={},this.elements.svg=this._card.shadowRoot.getElementById("rangeslider-".concat(this.toolId)),this.elements.capture=this.elements.svg.querySelector("#capture"),this.elements.track=this.elements.svg.querySelector("#rs-track"),this.elements.activeTrack=this.elements.svg.querySelector("#active-track"),this.elements.thumbGroup=this.elements.svg.querySelector("#rs-thumb-group"),this.elements.thumb=this.elements.svg.querySelector("#rs-thumb"),this.elements.label=this.elements.svg.querySelector("#rs-label tspan"),this.dev.debug&&console.log("slider - firstUpdated svg = ",this.elements.svg,"path=",this.elements.path,"thumb=",this.elements.thumb,"label=",this.elements.label,"text=",this.elements.text),this.elements.svg.addEventListener("touchstart",i.bind(this),!1),this.elements.svg.addEventListener("mousedown",i.bind(this),!1)}set value(t){super.value=t,this.dragging||(this.labelValue=this._stateValue)}_renderUom(){if("none"===this.config.show.uom)return z``;{this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.uom);let t=this.styles.label["font-size"],e=.5,s="em";const i=t.match(/\D+|\d*\.?\d+/g);2===i.length?(e=.6*Number(i[0]),s=i[1]):console.error("Cannot determine font-size for state/unit",t),t={"font-size":e+s},this.styles.uom=_t.mergeDeep(this.config.styles.uom,t);const a=this._card._buildUom(this.derivedEntity,this._card.entities[this.defaultEntityIndex()],this._card.config.entities[this.defaultEntityIndex()]);return"end"===this.config.show.uom?z`
      ...
      <text id="rs-label">
        ...
        `:"position"!==this.config.position.label.placement||t?void 0:z`
          ...
          `}this.svg.thumb.cx=t,this.svg.thumb.cy=e;const i=[];return i.push(z`
      ...
      ${function(){return this.config.show.active?"horizontal"===this.config.position.orientation?z`
    ...
    `}}class Le extends Et{constructor(t,e,s){super(t,_t.mergeDeep({position:{cx:50,cy:50,width:50,height:50,radius:{all:0}},classes:{tool:{"sak-rectex":!0,hover:!0},rectex:{"sak-rectex__rectex":!0}},styles:{tool:{},rectex:{}}},e),s),this.classes.tool={},this.classes.rectex={},this.styles.tool={},this.styles.rectex={};const i=Math.min(this.svg.height,this.svg.width)/2;let a=0;a=wt.calculateSvgDimension(this.config.position.radius.all),this.svg.radiusTopLeft=+Math.min(i,Math.max(0,wt.calculateSvgDimension(this.config.position.radius.top_left||this.config.position.radius.left||this.config.position.radius.top||a)))||0,this.svg.radiusTopRight=+Math.min(i,Math.max(0,wt.calculateSvgDimension(this.config.position.radius.top_right||this.config.position.radius.right||this.config.position.radius.top||a)))||0,this.svg.radiusBottomLeft=+Math.min(i,Math.max(0,wt.calculateSvgDimension(this.config.position.radius.bottom_left||this.config.position.radius.left||this.config.position.radius.bottom||a)))||0,this.svg.radiusBottomRight=+Math.min(i,Math.max(0,wt.calculateSvgDimension(this.config.position.radius.bottom_right||this.config.position.radius.right||this.config.position.radius.bottom||a)))||0,this.dev.debug&&console.log("RectangleToolEx constructor config, svg",this.toolId,this.config,this.svg)}set value(t){super.value=t}_renderRectangleEx(){this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(this.styles),this.MergeAnimationStyleIfChanged(),this.config.hasOwnProperty("csnew")?this.MergeColorFromState2(this.styles.rectex,"rectex"):this.MergeColorFromState(this.styles.rectex),this.counter||(this.counter=0),this.counter+=1;const t=z`
      ...
      `;return z`${t}`}render(){return z`
      <g id="rectex-${this.toolId}"
        class="${St(this.classes.tool)}" style="${nt(this.styles.tool)}"
        @click=${t=>this.handleTapEvent(t,this.config)}>
        ${this._renderRectangleEx()}
      </g>
    `}}class Ve extends Et{constructor(t,e,s){super(t,_t.mergeDeep({position:{cx:50,cy:50,radius:50,side_count:6,side_skip:1,angle_offset:0},classes:{tool:{"sak-polygon":!0,hover:!0},regpoly:{"sak-polygon__regpoly":!0}},styles:{tool:{},regpoly:{}}},e),s),this.svg.radius=wt.calculateSvgDimension(e.position.radius),this.classes.regpoly={},this.styles.regpoly={},this.dev.debug&&console.log("RegPolyTool constructor config, svg",this.toolId,this.config,this.svg)}set value(t){super.value=t}_renderRegPoly(){return this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.regpoly),z`
    ...
    `}}class ze extends Et{constructor(t,e,s){super(t,_t.mergeDeep({classes:{tool:{"sak-text":!0},text:{"sak-text__text":!0,hover:!1}},styles:{tool:{},text:{}}},e),s),this.EnableHoverForInteraction(),this.text=this.config.text,this.classes.tool={},this.classes.text={},this.styles.tool={},this.styles.text={},this.dev.debug&&console.log("TextTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}_renderText(){return this.MergeAnimationClassIfChanged(),this.MergeColorFromState(this.styles.text),this.MergeAnimationStyleIfChanged(),z`
        <text>
 ...
 * MIT Licensed
 */
var Ge=/; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g,He=/\\([\u000b\u0020-\u00ff])/g,je=/^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/,qe=function(t){if(!t)throw new TypeError("argument string is required");var e="object"==typeof t?function(t){var e;"function"==typeof t.getHeader?e=t.getHeader("content-type"):"object"==typeof t.headers&&(e=t.headers&&t.headers["content-type"]);if("string"!=typeof e)throw new TypeError("content-type header is missing from object");return e}(t):t;if("string"!=typeof e)throw new TypeError("argument string is required to be a string");var s=e.indexOf(";"),i=-1!==s?e.slice(0,s).trim():e.trim();if(!je.test(i))throw new TypeError("invalid media type");var a=new We(i.toLowerCase());if(-1!==s){var r,o,n;for(Ge.lastIndex=s;o=Ge.exec(e);){if(o.index!==s)throw new TypeError("invalid parameter format");s+=o[0].length,r=o[1].toLowerCase(),34===(n=o[2]).charCodeAt(0)&&-1!==(n=n.slice(1,-1)).indexOf("\\")&&(n=n.replace(He,"$1")),a.parameters[r]=n}if(s!==e.length)throw new TypeError("invalid parameter format")}return a};function We(t){this.parameters=Object.create(null),this.type=t}var Ye=new Map,Xe=function(t){return t.cloneNode(!0)},Je=function(){return"file:"===window.location.protocol},Ze=function(t,e,s){var i=new XMLHttpRequest;i.onreadystatechange=function(){try{if(!/\.svg/i.test(t)&&2===i.readyState){var e=i.getResponseHeader("Content-Type");if(!e)throw new Error("Content type not found");var a=qe(e).type;if("image/svg+xml"!==a&&"text/plain"!==a)throw new Error("Invalid content type: ".concat(a))}if(4===i.readyState){if(404===i.status||null===i.responseXML)throw new Error(Je()?"Note: SVG injection ajax calls do not work locally without adjusting security settings in your browser. Or consider using a local webserver.":"Unable to load SVG file: "+t);if(!(200===i.status||Je()&&0===i.status))throw new Error("There was a problem injecting the SVG: "+i.status+" "+i.statusText);s(null,i)}}catch(r){if(i.abort(),!(r instanceof Error))throw r;s(r,i)}},i.open("GET",t),i.withCredentials=e,i.overrideMimeType&&i.overrideMimeType("text/xml"),i.send()},Ke={},Qe=function(t,e){Ke[t]=Ke[t]||[],Ke[t].push(e)},ts=function(t,e,s){if(Ye.has(t)){var i=Ye.get(t);if(void 0===i)return void Qe(t,s);if(i instanceof SVGSVGElement)return void s(null,Xe(i))}Ye.set(t,void 0),Qe(t,s),Ze(t,e,(function(e,s){var i;e?Ye.set(t,e):(null===(i=s.responseXML)||void 0===i?void 0:i.documentElement)instanceof SVGSVGElement&&Ye.set(t,s.responseXML.documentElement),function(t){for(var e=function(e,s){setTimeout((function(){if(Array.isArray(Ke[t])){var s=Ye.get(t),i=Ke[t][e];s instanceof SVGSVGElement&&i(null,Xe(s)),s instanceof Error&&i(s),e===Ke[t].length-1&&delete Ke[t]}}),0)},s=0,i=Ke[t].length;s<i;s++)e(s)}(t)}))},es=function(t,e,s){Ze(t,e,(function(t,e){var i;t?s(t):(null===(i=e.responseXML)||void 0===i?void 0:i.documentElement)instanceof SVGSVGElement&&s(null,e.responseXML.documentElement)}))},ss=0,is=[],as={},rs="http://www.w3.org/1999/xlink",os=function(t,e,s,i,a,r,o){var n=t.getAttribute("data-src")||t.getAttribute("src");if(n){if(-1!==is.indexOf(t))return is.splice(is.indexOf(t),1),void(t=null);is.push(t),t.setAttribute("src",""),(i?ts:es)(n,a,(function(i,a){if(!a)return is.splice(is.indexOf(t),1),t=null,void o(i);var h=t.getAttribute("id");h&&a.setAttribute("id",h);var l=t.getAttribute("title");l&&a.setAttribute("title",l);var c=t.getAttribute("width");c&&a.setAttribute("width",c);var d=t.getAttribute("height");d&&a.setAttribute("height",d);var g=Array.from(new Set(Fe(Fe(Fe([],(a.getAttribute("class")||"").split(" "),!0),["injected-svg"],!1),(t.getAttribute("class")||"").split(" "),!0))).join(" ").trim();a.setAttribute("class",g);var u=t.getAttribute("style");u&&a.setAttribute("style",u),a.setAttribute("data-src",n);var p=[].filter.call(t.attributes,(function(t){return/^data-\w[\w-]*$/.test(t.name)}));if(Array.prototype.forEach.call(p,(function(t){t.name&&t.value&&a.setAttribute(t.name,t.value)})),s){var m,f,v,y,_,b={clipPath:["clip-path"],"color-profile":["color-profile"],cursor:["cursor"],filter:["filter"],linearGradient:["fill","stroke"],marker:["marker","marker-start","marker-mid","marker-end"],mask:["mask"],path:[],pattern:["fill","stroke"],radialGradient:["fill","stroke"]};Object.keys(b).forEach((function(t){m=t,v=b[t];for(var e=function(t,e){var s;y=f[t].id,_=y+"-"+ ++ss,Array.prototype.forEach.call(v,(function(t){for(var e=0,i=(s=a.querySelectorAll("["+t+'*="'+y+'"]')).length;e<i;e++){var r=s[e].getAttribute(t);r&&!r.match(new RegExp('url\\("?#'+y+'"?\\)'))||s[e].setAttribute(t,"url(#"+_+")")}}));for(var i=a.querySelectorAll("[*|href]"),r=[],o=0,n=i.length;o<n;o++){var h=i[o].getAttributeNS(rs,"href");h&&h.toString()==="#"+f[t].id&&r.push(i[o])}for(var l=0,c=r.length;l<c;l++)r[l].setAttributeNS(rs,"href","#"+_);f[t].id=_},s=0,i=(f=a.querySelectorAll(m+"[id]")).length;s<i;s++)e(s)}))}a.removeAttribute("xmlns:a");for(var w,x,$=a.querySelectorAll("script"),k=[],S=0,M=$.length;S<M;S++)(x=$[S].getAttribute("type"))&&"application/ecmascript"!==x&&"application/javascript"!==x&&"text/javascript"!==x||((w=$[S].innerText||$[S].textContent)&&k.push(w),a.removeChild($[S]));if(k.length>0&&("always"===e||"once"===e&&!as[n])){for(var A=0,E=k.length;A<E;A++)new Function(k[A])(window);as[n]=!0}var C=a.querySelectorAll("style");if(Array.prototype.forEach.call(C,(function(t){t.textContent+=""})),a.setAttribute("xmlns","http://www.w3.org/2000/svg"),a.setAttribute("xmlns:xlink",rs),r(a),!t.parentNode)return is.splice(is.indexOf(t),1),t=null,void o(new Error("Parent node is null"));t.parentNode.replaceChild(a,t),is.splice(is.indexOf(t),1),t=null,o(null,a)}))}else o(new Error("Invalid data-src or src attribute"))};class ns extends Et{constructor(t,e,s){if(super(t,_t.mergeDeep({position:{cx:50,cy:50,height:50,width:50},options:{svginject:!0},styles:{usersvg:{},mask:{fill:"white"}}},e),s),this.images={},this.images=Object.assign({},...this.config.images),this.item={},this.item.image="default",this.imageCur="none",this.imagePrev="none",this.classes={},this.classes.tool={},this.classes.usersvg={},this.classes.mask={},this.styles={},this.styles.tool={},this.styles.usersvg={},this.styles.mask={},this.injector={},this.injector.svg=null,this.injector.cache=[],this.clipPath={},this.config.clip_path){this.svg.cp_cx=wt.calculateSvgCoordinate(this.config.clip_path.position.cx||this.config.position.cx,0),this.svg.cp_cy=wt.calculateSvgCoordinate(this.config.clip_path.position.cy||this.config.position.cy,0),this.svg.cp_height=wt.calculateSvgDimension(this.config.clip_path.position.height||this.config.position.height),this.svg.cp_width=wt.calculateSvgDimension(this.config.clip_path.position.width||this.config.position.width);const t=Math.min(this.svg.cp_height,this.svg.cp_width)/2;this.svg.radiusTopLeft=+Math.min(t,Math.max(0,wt.calculateSvgDimension(this.config.clip_path.position.radius.top_left||this.config.clip_path.position.radius.left||this.config.clip_path.position.radius.top||this.config.clip_path.position.radius.all)))||0,this.svg.radiusTopRight=+Math.min(t,Math.max(0,wt.calculateSvgDimension(this.config.clip_path.position.radius.top_right||this.config.clip_path.position.radius.right||this.config.clip_path.position.radius.top||this.config.clip_path.position.radius.all)))||0,this.svg.radiusBottomLeft=+Math.min(t,Math.max(0,wt.calculateSvgDimension(this.config.clip_path.position.radius.bottom_left||this.config.clip_path.position.radius.left||this.config.clip_path.position.radius.bottom||this.config.clip_path.position.radius.all)))||0,this.svg.radiusBottomRight=+Math.min(t,Math.max(0,wt.calculateSvgDimension(this.config.clip_path.position.radius.bottom_right||this.config.clip_path.position.radius.right||this.config.clip_path.position.radius.bottom||this.config.clip_path.position.radius.all)))||0}this.dev.debug&&console.log("UserSvgTool constructor config, svg",this.toolId,this.config,this.svg)}set value(t){super.value=t}updated(t){var e=this;if(!this.config.options.svginject||this.injector.cache[this.imageCur])return;const s=this._card?.shadowRoot?.getElementById?.(`usersvg-${this.toolId}`);if(!s)return this._updateRetries||(this._updateRetries=0),this._updateRetries+=1,void(this._updateRetries<10?setTimeout((()=>this.updated?.()),50):(this.dev.debug&&console.warn(`[SAK] UserSvgTool ${this.toolId}: element not found after ${this._updateRetries} retries, giving up.`),this._updateRetries=0));this._updateRetries=0,s.parentNode&&s.isConnected&&(this.injector.elementsToInject=s.querySelectorAll("svg[data-src]:not(.injected-svg)"),0!==this.injector.elementsToInject.length&&function(t,e){var s=void 0===e?{}:e,i=s.afterAll,a=void 0===i?function(){}:i,r=s.afterEach,o=void 0===r?function(){}:r,n=s.beforeEach,h=void 0===n?function(){}:n,l=s.cacheRequests,c=void 0===l||l,d=s.evalScripts,g=void 0===d?"never":d,u=s.httpRequestWithCredentials,p=void 0!==u&&u,m=s.renumerateIRIElements,f=void 0===m||m;if(t&&"length"in t)for(var v=0,y=0,_=t.length;y<_;y++)os(t[y],g,f,c,p,h,(function(e,s){o(e,s),t&&"length"in t&&t.length===++v&&a(v)}));else t?os(t,g,f,c,p,h,(function(e,s){o(e,s),a(1),t=null})):a(0)}(this.injector.elementsToInject,{afterAll(t){e._card?.isConnected&&setTimeout((()=>{e._card.requestUpdate()}),0)},afterEach(t,s){t?(e.injector.error=t,t.message&&t.message.includes("Parent node is null")||(e.config.options.svginject=!1,console.warn(`[SAK] SVGInjector error for tool ${e.toolId}:`,t.message||t))):(e.injector.error="",e.injector.cache[e.imageCur]=s)},beforeEach(t){t.removeAttribute("height"),t.removeAttribute("width")},cacheRequests:!1,evalScripts:"once",httpRequestWithCredentials:!1,renumerateIRIElements:!1}))}_renderUserSvg(){this.MergeAnimationStyleIfChanged(),this._imageMissing=!1;let t=xt.getJsTemplateOrValue(this,this._stateValue,_t.mergeDeep(this.images));if(Array.isArray(t)){const e={};t.forEach((t=>{"object"==typeof t&&Object.assign(e,t)})),t=e}this.imagePrev=this.imageCur;const e=this.item.image?.toLowerCase?.()??"";if(["unknown","unavailable","none"].includes(e)?(console.warn(`[Swiss Army Knife] Stato "${e}" non valido. Uso 'imageoff'.`),this.imageCur=t.imageoff??t.default??"fallback.svg",this._imageMissing=!t.imageoff&&!t.default):t[this.item.image]?this.imageCur=t[this.item.image]:t.default?(console.warn(`[Swiss Army Knife] Immagine "${this.item.image}" non trovata, uso 'default'.`),this.imageCur=t.default):Object.values(t).length>0?(console.warn(`[Swiss Army Knife] Immagine "${this.item.image}" non trovata, uso la prima disponibile.`),this.imageCur=Object.values(t)[0]):(console.warn(`[Swiss Army Knife] Immagine "${this.item.image}" non trovata, uso 'fallback.svg'.`),this.imageCur="fallback.svg",this._imageMissing=!0),"none"===t[this.item.image])return z``;let s=this.injector.cache[this.imageCur],i=z``,a="",r="";this.config.clip_path&&(a=`url(#clip-path-${this.toolId})`,r=`url(#mask-${this.toolId})`,i=z`
        <defs>
        ...
        `);const o=t[this.item.image],n=o?.lastIndexOf?.(".")??-1;return"svg"!==(-1===n?"":o.substring(n+1))?z`
        <svg class="sak-usersvg__image" x="${this.svg.x}" y="${this.svg.y}"
          ...
          />
          ${this._imageMissing?z`
            <text x="${this.svg.x+4}" y="${this.svg.y+20}" fill="red" font-size="12">
              ⚠️ Image not found
            </text>`:z``}
          </svg>
        `:s&&this.config.options.svginject?s&&s.classList?(s.classList.remove("hidden"),z`
        ...
        `):(console.warn("[SAK] cachedSvg nullo o non valido, impossibile renderizzare."),z``):z`
    ...
    `}}const hs=["var(--theme-sys-color-primary)","#3498db","#e74c3c","#9b59b6","#f1c40f","#2ecc71","#1abc9c","#34495e","#e67e22","#7f8c8d","#27ae60","#2980b9","#8e44ad"],ls="cw",cs={CIRCLE:"circle",LINE:"line",RECTANGLE:"rectangle",SPIRAL:"spiral"},ds="colorstops",gs="dashes",us="none",ps="colorstops",ms="dashes",fs={BOTH:"both",INTERIOR:"interior",OUTLINE:"outline"},vs="circumference",ys="center",_s={BUTT:"butt",ROUND:"round",ROUND_START_END:"round_start_end"},bs="smooth",ws={ARCHIMEDEAN_SPIRAL:"arch_spiral",ARCHIMEDEAN_HELIX:"arch_helix",LOGARITHIMIC_SPIRAL:"log_spiral",LOGARITHIMIC_HELIX:"log_helix"},xs=(t,e)=>{for(let s=e,i=t.length;s<i;s+=1)if(null!=t[s].value)return s;throw new Error('Error in threshold interpolation: could not find right-nearest valued stop. Do the first and last thresholds have a set "value"?')},$s=(t,e)=>{const s=(t=>{if(!t||!t.length)return t;if(null==t[0].value||null==t[t.length-1].value)throw new Error('The first and last thresholds must have a set "value".\n See xyz manual');let e=0,s=null;return t.map(((i,a)=>{if(null!=i.value)return e=a,{...i};null==s?s=xs(t,a):a>s&&(e=s,s=xs(t,a));const r=t[e].value,o=(t[s].value-r)/(s-e);return{color:"string"==typeof i?i:i.color,value:o*a+r}}))})(t);try{s.sort(((t,e)=>e.value-t.value))}catch(i){console.log("computeThresholds, error",i,s)}if(e===bs)return s;{const t=[].concat(...s.map(((t,e)=>[t,{value:t.value-1e-4,color:s[e+1]?s[e+1].color:t.color}])));return t}};class ks extends Et{constructor(t,e,s){const i={position:{cx:50,cy:50,width:80,height:80},progpath:{show:{path_type:cs.RECTANGLE,active_track:!0,track:"dashes",marker:"navigation",colorstops:"none",scale:!1,viz:{linecap:_s.BUTT}},background:{width:8},circle:{direction:ls},spiral:{radius_inner:10,radius_outer:40,degrees:720,points:72,width:1,spiral_helix:!1,helix:{adjust_height:!1,offset_x:0,offset_y:0,hw_ratio:0,iso_angle:0}},marker:{size:10,offset:0,color:{animate:!1,smooth:!1},attach_to:vs,flip:!1},scale:{offset:0},track:{width:8},active_track:{width:8,color:{smooth:!1}},line_color:[...hs],colorstops:{colors:[]}},classes:{tool:{"sak-path-progress":!0,hover:!0},background:{},progpath:{"sak-path-progress__progress":!0},dashes_scale:{},active_track:{},marker:{},line:{},circle:{},rectangle:{}},styles:{tool:{},background:{stroke:"var(--theme-sys-elevation-surface-neutral3)",fill:"none"},progpath:{},dashes_scale:{},active_track:{fill:"none",stroke:"var(--primary-color)"},marker:{},line:{},circle:{},rectangle:{}}};super(t,_t.mergeDeep(i,e),s),this._computeRectanglePath=(t,e,s,i,a,r)=>{let o,n,h,l,c;const d=this.config.progpath.rectangle.start.side,g=this.config.progpath.rectangle.stop.side;switch(d){case"top":c=`M${this.svg.width/2+this.rectangle.start.position}, ${this.svg.height/2-e/2}`;break;case"right":c=`M${this.svg.width/2+t/2}, ${this.svg.height/2+this.rectangle.start.position}`;break;case"bottom":c=`M${this.svg.width/2+this.rectangle.start.position}, ${this.svg.height/2+e/2}`;break;case"left":c=`M${this.svg.width/2-t/2}, ${this.svg.height/2-this.rectangle.start.position}`}const u={top:{right:"tr",bottom:"trb",left:"trbl",top:"trblt"},right:{bottom:"rb",left:"rbl",top:"rblt",right:"bltrb"},bottom:{left:"bl",top:"blt",right:"bltr",bottom:"bltrb"},left:{top:"lt",right:"ltr",bottom:"ltrb",left:"ltrbl"}};let p=u[d][g].length;for(let m=0;m<p;m++){switch(u[d][g][m]){case"t":m===p-1?(o=t/2+this.rectangle.stop.position-s,c+=`\n              h${o}\n              `):(o=0===m?t/2-this.rectangle.start.position-i:t-s-i,c+=`\n              h${o}\n              a${i},${i} 0 0 1 ${i},${i}\n            `);break;case"r":m===p-1?(n=e/2-this.rectangle.stop.position-i,c+=`\n              v${n}\n              `):(n=0===m?e/2-this.rectangle.start.position-a:e-i-a,c+=`\n              v${n}\n              a${a},${a} 0 0 1 -${a},${a}\n            `);break;case"b":m===p-1?(h=t/2-this.rectangle.stop.position-a,c+=`\n              h-${h}\n              `):(h=0===m?t/2+this.rectangle.start.position-r:t-r-a,c+=`\n              h-${h}\n              a${r},${r} 0 0 1 -${r},-${r}\n            `);break;case"l":m===p-1?(l=e/2+this.rectangle.stop.position-r,c+=`\n              v-${l}\n              `):(l=0===m?e/2-this.rectangle.start.position-s:e-r-s,c+=`\n              v-${l}\n              a${s},${s} 0 0 1 ${s},-${s}\n            `)}}return c},this.EnableHoverForInteraction(),this.svg.radius=wt.calculateSvgDimension(e.position.radius),this.svg.background={width:wt.calculateSvgDimension(this.config.progpath.background.width)},this.svg.marker={offset:wt.calculateSvgDimension(this.config.progpath.marker.offset)/400*24},this.classes.tool={},this.classes.background={},this.classes.active_track={},this.classes.dashes_scale={},this.classes.marker={},this.styles.tool={},this.styles.background={},this.styles.active_track={},this.styles.dashes_scale={},this.styles.marker={},this.svg.cx=this.svg.width/2,this.svg.cy=this.svg.height/2,this.haveElements=!1,this.elements={},this.elements.path={length:100,svg:""},this.elements.scale={length:100,svg:""},this.configureBackground(),this.configurePathTypeRectangle(),this.configurePathTypeCircle(),this.configurePathTypeLine(),this.configurePathTypeUser(),this.configurePathTypeSpiral(),this.configureMarkerList(),this.configureScale(),this.ticking=!1,this.myValue=50,this.colorstops={},this.colorstops.colors=[],this.colorstops.colors=$s(this.config.progpath.colorstops.colors,bs)}configureScale(){this.scale={},[cs.CIRCLE,cs.LINE].includes(this.config.progpath.show.path_type)&&this.config.progpath.show.scale!==us&&(this.config.progpath.show.scale===ps&&this.config.progpath.colorstops?this.scale.gap=wt.calculateSvgDimension(this.config.progpath.colorstops.gap||0):this.scale.gap=0,this.config.progpath.show.path_type===cs.CIRCLE&&(this.scale={...this.scale,...this.circle},this.scale.radiusX+=wt.calculateSvgDimension(this.config.progpath.scale.offset),this.scale.radiusY+=wt.calculateSvgDimension(this.config.progpath.scale.offset),this.scale.gap*=this.scale.radiusX/this.circle.radiusX,this.elements.scale.svg=this._computeCirclePath(this.scale)),this.config.progpath.show.path_type===cs.LINE&&(this.scale={...this.scale,...this.line},this.scale.cy-=wt.calculateSvgDimension(this.config.progpath.scale.offset),this.elements.scale.svg=this._computeLinePath(this.scale)))}configureBackground(){this.config.styles.background.stroke="var(--theme-sys-elevation-surface-neutral3)",this.config.styles.background.fill="none",this.config.styles.background["stroke-width"]=this.svg.background.width,[_s.ROUND,_s.ROUND_START_END].includes(this.config.progpath.show.viz.linecap)&&(this.config.styles.background["stroke-linecap"]="round")}configurePathTypeRectangle(){this.config.progpath.show.path_type===cs.RECTANGLE&&(this.rectangle={},this.rectangle.start={},this.rectangle.start.position=wt.calculateSvgDimension(this.config.progpath.rectangle.start?.position)/1||0,this.rectangle.stop={},this.rectangle.stop.position=wt.calculateSvgDimension(this.config.progpath.rectangle.stop?.position)/1||0,this.rectangle.radius={},this.rectangle.radius.tl=wt.calculateSvgDimension(this.config.progpath.rectangle.radius?.tl||0)/1,this.rectangle.radius.tr=wt.calculateSvgDimension(this.config.progpath.rectangle.radius?.tr||0)/1,this.rectangle.radius.bl=wt.calculateSvgDimension(this.config.progpath.rectangle.radius?.bl||0)/1,this.rectangle.radius.br=wt.calculateSvgDimension(this.config.progpath.rectangle.radius?.br||0)/1,this.elements.path.svg=this._computeRectanglePath(this.svg.width,this.svg.height,this.rectangle.radius.tl,this.rectangle.radius.tr,this.rectangle.radius.br,this.rectangle.radius.bl),[_s.ROUND].includes(this.config.progpath.show.viz.linecap)&&(this.config.styles.rectangle["stroke-linecap"]="round")),this.track={...this.rectangle}}configurePathTypeCircle(){this.config.progpath.show.path_type===cs.CIRCLE&&(this.circle={},this.svg.cx=this.svg.width/2,this.svg.cy=this.svg.height/2,this.circle.radiusX=this.svg.width/2,this.circle.radiusY=this.svg.height/2,this.circle.isCW=this.config.progpath.circle.direction===ls,this.circle.direction=this.config.progpath.circle.direction,this.circle.startAngle=this.config.progpath.circle.start_angle,this.circle.stopAngle=this.config.progpath.circle.stop_angle,this.direction=this.config.progpath.circle.direction,this.track={...this.circle},this.elements.path.svg=this._computeCirclePath(this.circle),[_s.ROUND].includes(this.config.progpath.show.viz.linecap)&&(this.config.styles.circle["stroke-linecap"]="round"))}configurePathTypeUser(){"user"===this.config.progpath.show.path_type&&(this.user={},this.elements.path.svg=this._computeUserPath())}configurePathTypeLine(){this.config.progpath.show.path_type===cs.LINE&&(this.line={},this.line.cx=this.svg.width/2,this.line.cy=this.svg.height/2,this.line.x=wt.calculateSvgDimension(this.config.progpath.line.margin.left),this.line.width=this.svg.width-wt.calculateSvgDimension(this.config.progpath.line.margin.left+this.config.progpath.line.margin.right),this.track={...this.line},this.elements.path.svg=this._computeLinePath(this.line),[_s.ROUND].includes(this.config.progpath.show.viz.linecap)&&(this.config.styles.line["stroke-linecap"]="round"))}configurePathTypeBar(){"bar"===this.config.progpath.show.path_type&&(this.bar={},this.track={...this.bar},this.elements.path.svg=this._computeBarPath(this.config.progpath.bar))}configurePathTypeSpiral(){if("spiral"!==this.config.progpath.show.path_type)return;let{show:t}=this.config.progpath,{spiral:e}=this.config.progpath;this.spiral={},this.spiral.type=t.variant,this.spiral.radiusInner=Math.max(wt.calculateSvgDimension(e.radius_inner),0),[ws.LOGARITHIMIC_SPIRAL,ws.LOGARITHIMIC_HELIX].includes(this.spiral.type)&&(this.spiral.radiusInner=1),this.spiral.radiusOuter=Math.max(wt.calculateSvgDimension(e.radius_outer),1),0===this.spiral.radiusInner&&0===this.spiral.radiusOuter&&(this.spiral.radiusOuter=1),this.spiral.degrees=Math.max(parseFloat(e.degrees),1),this.spiral.points=Math.max(parseFloat(e.points),2),this.spiral.helix={},this.spiral.helix.adjustHelixHeight=e.helix.adjust_height,this.spiral.helix.offsetX=wt.calculateSvgDimension(e.helix.offset_x),this.spiral.helix.offsetY=wt.calculateSvgDimension(e.helix.offset_y),this.spiral.helix.HWRatio=parseFloat(e.helix.hw_ratio),this.spiral.helix.isoAngle=parseFloat(e.helix.iso_angle),this.spiral.helix.adjustHelixHeight&&(this.spiral.helix.offsetY*=Math.sin(this.spiral.helix.isoAngle*(Math.PI/180))),this.elements.path.svg=this._computeSpiralHelixPath(this.spiral),console.log("configurePathTypeSpiral, path",this.elements.path.svg,this.spiral)}_computeSpiralHelixPath(t){const e=2*t.points,s=t.helix.offsetX/t.points,i=t.helix.offsetY/t.points,a=(t.radiusOuter-t.radiusInner)/e,r=[];if([ws.ARCHIMEDEAN_SPIRAL,ws.ARCHIMEDEAN_HELIX].includes(t.type)){for(let o=0;o<=e;o++){const n=t.radiusInner+o*a,h=90+o*(t.degrees/e);let l=this.svg.cx+n*Math.cos(h*(Math.PI/180)),c=this.svg.cy+n*Math.sin(h*(Math.PI/180));t.type===ws.ARCHIMEDEAN_HELIX&&(c*=t.helix.HWRatio,c+=o*i,l+=o*s),r.push(`${l} ${c}`)}return`M ${r.shift()} Q ${r.join(" ")}`}if([ws.LOGARITHIMIC_SPIRAL,ws.LOGARITHIMIC_HELIX].includes(t.type)){const a=t.radiusInner,n=Math.log(t.radiusOuter/t.radiusInner)/(2*Math.PI*(t.degrees/360)),h=t.degrees/e,l=h*(Math.PI/180);for(var o=0;o<=e;o++){const e=o*h,c=o*l,d=a*Math.E**(n*c);let g=this.svg.cx+d*Math.cos(e*(Math.PI/180)),u=this.svg.cy+d*Math.sin(e*(Math.PI/180));t.type===ws.LOGARITHIMIC_HELIX&&(u*=t.helix.HWRatio,u+=o*i,g+=o*s),r.push(`${g} ${u}`)}return`M ${r.shift()} Q ${r.join(" ")}`}}configureMarkerList(){this.markerConfigurations=new Map,this.markerConfigurations.set("drag-vertical",{viewBox:{x:12,y:12,width:24,height:24},path:"M11 21H9V3H11V21M15 3H13V21H15V3Z"}).set("pan-vertical",{viewBox:{x:12,y:12,width:24,height:24},path:"M12,2.5L8,7H16L12,2.5M12,10A2,2 0 0,0 10,12A2,2 0 0,0 12,14A2,2 0 0,0 14,12A2,2 0 0,0 12,10M8,17L12,21.5L16,17H8Z"}).set("dots-vertical",{viewBox:{x:12,y:12,width:24,height:24},path:"M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z"}).set("circle",{viewBox:{x:12,y:12,width:24,height:24},path:"M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z"}).set("chevron-up",{viewBox:{x:12,y:0,width:24,height:24},path:"M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z"}).set("menu-up",{viewBox:{x:12,y:0,width:24,height:24},path:"M7,15L12,10L17,15H7Z"}).set("arrow-up-bold-outline",{viewBox:{x:12,y:0,width:24,height:24},path:"M16,13V21H8V13H2L12,3L22,13H16M7,11H10V19H14V11H17L12,6L7,11Z"}).set("sak-clock-hand-simple",{viewBox:{x:12,y:19,width:24,height:24},path:"M13.388,15.288c1.498,0.57 2.564,2.02 2.564,3.718c0,2.194 -1.782,3.976 -3.976,3.976c-2.194,-0 -3.976,-1.782 -3.976,-3.976c0,-1.698 1.066,-3.148 2.564,-3.718l-0,-12.901c-0,-0.78 0.633,-1.413 1.412,-1.413c0.78,0 1.412,0.633 1.412,1.413l0,12.901Z"}).set("sak-clock-hand-ring",{viewBox:{x:12,y:20,width:24,height:24},path:"M13.04,16.665c1.412,0.45 2.436,1.774 2.436,3.335c0,1.932 -1.568,3.5 -3.5,3.5c-1.932,-0 -3.5,-1.568 -3.5,-3.5c0,-1.575 1.043,-2.909 2.475,-3.347l0,-14.609c0,-0.576 0.468,-1.044 1.044,-1.044c0.577,0 1.045,0.468 1.045,1.044l-0,14.621Zm-1.064,1.574c-0.972,0 -1.76,0.789 -1.76,1.761c-0,0.972 0.788,1.761 1.76,1.761c0.972,-0 1.761,-0.789 1.761,-1.761c-0,-0.972 -0.789,-1.761 -1.761,-1.761Z"}).set("sak-clock-hand-ring-small",{viewBox:{x:12,y:20,width:24,height:24},path:"M12.495,17.045c1.409,0.246 2.481,1.476 2.481,2.955c0,1.656 -1.344,3 -3,3c-1.656,0 -3,-1.344 -3,-3c0,-1.492 1.092,-2.731 2.519,-2.962l0,-15.538c0,-0.276 0.224,-0.5 0.5,-0.5c0.276,0 0.5,0.224 0.5,0.5l0,15.545Zm-0.519,1.446c-0.833,-0 -1.509,0.676 -1.509,1.509c0,0.833 0.676,1.509 1.509,1.509c0.833,0 1.509,-0.676 1.509,-1.509c0,-0.833 -0.676,-1.509 -1.509,-1.509Z"}).set("navigation",{viewBox:{x:12,y:0,width:24,height:24},path:"M12,2L4.5,20.29L5.21,21L12,18L18.79,21L19.5,20.29L12,2Z"})}set value(t){super.value=t}computeColor(t,e){const{line_color:s}=this.config.progpath,i={...this.colorstops},a=Number(t)||0;if(0===i.colors.length)return s[e]||s[0];const r={color:s[e]||s[0],...i.colors.slice(-1)[0],...i.colors.find((t=>t.value<a))};return this._card.config.entities[e].color||r.color}intColor(t,e){const{line_color:s}=this.config.progpath,i={...this.colorstops},a=Number(t)||0;let r;if(i.colors.length>0)if("bar"===this.config.progpath.show?.chart_type){const{color:t}=i.colors.find((t=>t.value<a))||i.colors.slice(-1)[0];r=t}else{const e=i.colors.findIndex((t=>t.value<a)),s=i.colors[e],o=i.colors[e-1];if(o){const e=(o.value-t)/(o.value-s.value);r=At.getGradientValue(o.color,s.color,e)}else r=e?i.colors[i.colors.length-1].color:i.colors[0].color}return this._card.config.entities[e].color||r||s[e]||s[0]}getPerpendicularAngleAtLength(t,e,s=ls,i=!1){try{const{x:a,y:r}=this.elements.path.id.getPointAtLength(t),{x:o,y:n}=this.elements.path.id.getPointAtLength(e),h=Math.atan2(r-n,a-o);return{x:a,y:r,x2:o,y2:n,angle:(s===ls?0:180)+(i?0:180)+180*h/Math.PI}}catch(a){console.log("getPerp",a,this.elements.path,t,e)}}renderAnimateProgress(t){if(!this.haveElements)return;this.progressPctPrev=this.progressPct||0,this.progressPct=this.myValue/100,this.progressDiff=this.progressPct-this.progressPctPrev;const{show:e}=this.config.progpath;let s,i;const a=t=>{s||(s=t);const r=(t=>--t**5+1)(Math.min(1,(t-s)/5e3)),o=this.myValue-this.myValuePrev;let n=this.myValuePrev+r*o;const h=Number(this._stateValue)-Number(this._stateValuePrev),l=Number(this._stateValuePrev)+r*h,c=this.getPerpendicularAngleAtLength((100-n)/100*this.elements.path.length,(100-n)/100*(this.elements.path.length+1),this.direction,this.flip);if(e?.marker&&"none"!==e.marker&&(this.config.progpath.marker.attach_to===ys?this.elements.marker.setAttribute("transform",`translate(${this.svg.cx} ${this.svg.cy}) rotate(${c.angle})`):this.elements.marker.setAttribute("transform",`translate(${c.x} ${c.y}) rotate(${c.angle})`),"none"!==this.config.progpath.marker.color.animate)){const t=this.config.progpath.marker.color.smooth?this.intColor(l,0):this.computeColor(l,0);t!==i&&(t?([fs.BOTH,fs.INTERIOR].includes(this.config.progpath.marker.color.animate)&&(this.elements.markerPath.style.fill=t,this.styles.marker.fill=t),[fs.BOTH,fs.OUTLINE].includes(this.config.progpath.marker.color.animate)&&(this.elements.markerPath.style.stroke=t,this.styles.marker.stroke=t)):console.log("illegal color",t)),i=t}if(e?.active_track&&!0===e.active_track){this.elements.activeTrack.setAttribute("stroke-dashoffset",n);const t=this.config.progpath.active_track.color.smooth?this.intColor(l,0):this.computeColor(l,0);t!==i?(this.elements.activeTrack.style.stroke=t,this.styles.active_track.stroke=t):t||console.log("illegal color",t),i=t}e?.mask&&!0===e.mask&&this.elements.maskPath.setAttribute("stroke-dasharray",100-n+" 100"),r<1?window.requestAnimationFrame(a):(s=null,i=null)};window.requestAnimationFrame(a)}firstUpdated(t){const e=this._card.shadowRoot;this.elements.path.id=e.getElementById("motion-path-".concat(this.toolId)),null===this.elements.path.id&&console.error("firstUpdated - no path Id",this.elements.path),this.elements.path.length=this.elements.path.id.getTotalLength(),this.elements.scale.id=e.getElementById("scale-path-".concat(this.toolId)),this.elements.scale.length=this.elements.scale.id.getTotalLength(),this.haveElements=!0,[cs.RECTANGLE,cs.LINE,cs.CIRCLE,cs.SPIRAL].includes(this.config.progpath.show.path_type)&&(this.elements.marker=e.getElementById("marker-".concat(this.toolId)),this.elements.markerPath=e.getElementById("markerPath-".concat(this.toolId)),this.elements.activeTrack=e.getElementById("activetrack-path-".concat(this.toolId)),this.elements.activeTrackMask=e.getElementById("activetrack-maskpath-".concat(this.toolId)),this.elements.maskPath=e.getElementById("88maskPath-".concat(this.toolId)),this.elements.pathGroup=e.getElementById("path-group-".concat(this.toolId)),this.renderAnimateProgress(Date.now()),this._card.requestUpdate())}renderMarkerSvg(){const t=this.svg.marker.offset;this.intColor(this._stateValue,0);let e,s=this.markerConfigurations.get(this.config.progpath.show.marker),i="marker-".concat(this.toolId);return s?(e=z`
      ...
      `}renderActiveTrack(){return this.config.progpath.show.active_track?(this.styles.active_track["stroke-dasharray"]="100 100",this.styles.active_track["stroke-width"]=`${this.config.progpath.active_track.width}em`,z`
        <!-- Active TrackPath Render -->
        <path id="activetrack-path-${this.toolId}" d="${this.elements.path.svg}" pathLength="100"
          class="${St(this.classes.active_track)}" style="${nt(this.styles.active_track)}"
          marker-start="url(#myclip2)" marker-end="url(#myclip2)"
        />
      `):z``}getRoundStartOrEndMaskSvg(t,e,s,i,a,r){let o="";return this.config.progpath.show.viz.linecap!==_s.ROUND_START_END||("start"===e&&(o=z`
          <defs>
          ...
          `)),o}renderScaleDashes(){return this.styles.dashes_scale["stroke-width"]=`${this.config.progpath.track.width}em`,z`
      <!-- Track Dashes Render -->
      <path id="dashes-path-${this.toolId}" d="${this.elements.scale.svg}"
      class="${St(this.classes.dashes_scale)}" style="${nt(this.styles.dashes_scale)}"
      />
    `}renderScaleColorstops(){if(this.config.progpath.show.scale===ps&&this.config.progpath.colorstops){const t=this.scale.gap;let e={...this.config.progpath.colorstops.scales.default};e.range=e.max-e.min,e.gap=t;let s=[...this.config.progpath.colorstops.colors],i=s.findIndex((t=>e.min<t.value)),a=s.findIndex((t=>t.value>=e.max));if(-1!==i&&(s.splice(0,i-1),s[0].value=e.min),-1===a)s[s.length]={value:e.max};else{let t=s.splice(a,s.length-a);s[s.length]={value:e.max,color:t[0].color}}s.forEach(((t,e,s)=>t.range=e<s.length-1?s[e+1].value-t.value:0)),0===s[s.length-1].range&&s.splice(s.length-1,1);let r=s[0];const o=this.getRoundStartOrEndMaskSvg("myclip","start",s[0],e,this.elements.scale,this.config.progpath.scale);r=s[0===s[s.length-1].range?s.length-2:s.length-1];const n=this.getRoundStartOrEndMaskSvg("mycliplast","end",r,e,this.elements.scale,this.config.progpath.scale);let h=s.map(((s,i,a)=>{const r=0===i||i===a.length-1||0===a[Math.min(a.length-1,i+1)].range;return 0===s.range?z``:z`
          <!-- Scale Part Render -->
      ...
      <g id="scale-group-${this.toolId}" fill="none">
        ...
        `}}renderScale(){if(this.haveElements)switch(this.config.progpath.show.scale){case ps:return this.renderScaleColorstops();case ms:return this.renderScaleDashes();default:return z``}}renderTrackDashes(){return this.styles.dashes_scale["stroke-width"]=`${this.config.progpath.track.width}em`,z`
      <!-- Track Dashes Render -->
      <path id="dashes-path-${this.toolId}" d="${this.elements.path.svg}"
      class="${St(this.classes.dashes_scale)}" style="${nt(this.styles.dashes_scale)}"
      />
    `}renderTrackColorstops(){if(this.config.progpath.show.track===ds&&this.config.progpath.colorstops){const t=wt.calculateSvgDimension(this.config.progpath.colorstops.gap||0);let e={...this.config.progpath.colorstops.scales.default};e.range=e.max-e.min,e.gap=t;let s=[...this.config.progpath.colorstops.colors],i=s.findIndex((t=>e.min<t.value)),a=s.findIndex((t=>t.value>=e.max));if(-1!==i&&(s.splice(0,i-1),s[0].value=e.min),-1===a)s[s.length]={value:e.max};else{let t=s.splice(a,s.length-a);s[s.length]={value:e.max,color:t[0].color}}s.forEach(((t,e,s)=>t.range=e<s.length-1?s[e+1].value-t.value:0));let r,o=s[0];wt.calculateSvgDimension(this.config.progpath.track.width),r=this.getRoundStartOrEndMaskSvg("myclip2","start",s[0],e,this.elements.path,this.config.progpath.track);let n;o=s[0===s[s.length-1].range?s.length-2:s.length-1],wt.calculateSvgDimension(this.config.progpath.track.width),n=this.getRoundStartOrEndMaskSvg("mycliplast2","end",o,e,this.elements.path,this.config.progpath.track);let h=s.map(((s,i,a)=>{const r=this.config.progpath.show.viz.linecap===_s.ROUND_START_END&&(0===i||i===a.length-1||0===a[Math.min(a.length-1,i+1)].range),o=this.config.progpath.show.viz.linecap===_s.ROUND_START_END&&0===i;return 0===s.range?z``:z`
          <!-- Track Part Render -->
    ...
    `}}renderTrack(){if(this.haveElements)switch(this.config.progpath.show.track){case ds:return this.renderTrackColorstops();case gs:return this.renderTrackDashes();default:return z``}}shouldUpdate(t){return this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.active_track),!0}renderProgressTool(){const t=this.toolId;if([cs.LINE,cs.RECTANGLE,cs.SPIRAL,cs.CIRCLE].includes(this.config.progpath.show.path_type)){let e={};void 0===this.config.progpath?.colorstops?.scales?(e.min=0,e.max=100):e={...this.config.progpath.colorstops.scales.default},e.range=e.max-e.min,e.gap=this.scale.gap;let s=[...this.config.progpath.colorstops.colors];const i=this.getRoundStartOrEndMaskSvg("myprogress","start",s[0],e,this.elements.path,this.config.progpath.scale);return z`
      ...
      `}}render(){if(this._card.dev.real){let t;console.log("rendering with real values...",this._stateValue,this._stateValuePrev),this.config.progpath.colorstops.scales?t=this.config.progpath.colorstops.scales.default.max:(console.log("render, config",this.config),t=100),this.myValuePrev=100-Math.max(Math.min(100,this._stateValuePrev/t*100),0),this.myValue=100-Math.max(Math.min(200,this._stateValue/t*100),0)}else this.myValuePrev=this.myValue,this.myValue=100*Math.random();return z`
      <g "" id="ProgressPath-${this.toolId}"
        class="${St(this.classes.tool)}" style="${nt(this.styles.tool)}"
        @click=${t=>this.handleTapEvent(t,this.config)}>
        ${this.renderProgressTool()}
        </g>
    `}}class Ss{constructor(t,e){if(this.toolsetId=Math.random().toString(36).substr(2,9),this._card=t,this.dev={...this._card.dev},this.dev.performance&&console.time(`--\x3e ${this.toolsetId} PERFORMANCE Toolset::constructor`),this.config=e,this.tools=[],this.palette={},this.palette.light={},this.palette.dark={},this.config.palette){const{paletteLight:t,paletteDark:e}=At.processPalette(this.config.palette);this.palette.light=t,this.palette.dark=e}this.svg={},this.svg.cx=wt.calculateSvgCoordinate(e.position.cx,mt),this.svg.cy=wt.calculateSvgCoordinate(e.position.cy,mt),this.svg.x=this.svg.cx-mt,this.svg.y=this.svg.cy-mt,this.transform={},this.transform.scale={},this.transform.scale.x=this.transform.scale.y=1,this.transform.rotate={},this.transform.rotate.x=this.transform.rotate.y=0,this.transform.skew={},this.transform.skew.x=this.transform.skew.y=0,this.config.position.scale&&(this.transform.scale.x=this.transform.scale.y=this.config.position.scale),this.config.position.rotate&&(this.transform.rotate.x=this.transform.rotate.y=this.config.position.rotate),this.transform.scale.x=this.config.position.scale_x||this.config.position.scale||1,this.transform.scale.y=this.config.position.scale_y||this.config.position.scale||1,this.transform.rotate.x=this.config.position.rotate_x||this.config.position.rotate||0,this.transform.rotate.y=this.config.position.rotate_y||this.config.position.rotate||0,this.dev.debug&&console.log("Toolset::constructor config/svg",this.toolsetId,this.config,this.svg);const s={area:Pt,circslider:It,badge:Ct,bar:Be,circle:Tt,ellipse:Dt,sparkline:Ie,horseshoe:De,icon:Ht,line:Pe,name:jt,rectangle:Ne,rectex:Le,regpoly:Ve,segarc:Oe,state:Se,slider:Re,switch:Ue,text:ze,usersvg:ns,progpath:ks};this.config.tools.map((t=>{const e={...t},i={cx:0,cy:0,scale:this.config.position.scale?this.config.position.scale:1};if(this.dev.debug&&console.log("Toolset::constructor toolConfig",this.toolsetId,e,i),!t.disabled){const a=new s[t.type](this,e,i);this._card.entityHistory.needed|=Number("bar"===t.type),this._card.entityHistory.needed|=Number("sparkline"===t.type),this.tools.push({type:t.type,index:t.id,tool:a})}return!0})),this.dev.performance&&console.timeEnd(`--\x3e ${this.toolsetId} PERFORMANCE Toolset::constructor`)}updateValues(){this.dev.performance&&console.time(`--\x3e ${this.toolsetId} PERFORMANCE Toolset::updateValues`),this.tools&&this.tools.forEach(((t,e)=>{if(t.tool.config.hasOwnProperty("entity_index")&&(this.dev.debug&&console.log("Toolset::updateValues",t,e),t.tool.value=this._card.attributesStr[t.tool.config.entity_index]?this._card.attributesStr[t.tool.config.entity_index]:this._card.secondaryInfoStr[t.tool.config.entity_index]?this._card.secondaryInfoStr[t.tool.config.entity_index]:this._card.entitiesStr[t.tool.config.entity_index]),t.tool.config.hasOwnProperty("entity_indexes")){const e=[];for(let s=0;s<t.tool.config.entity_indexes.length;++s)e[s]=this._card.attributesStr[t.tool.config.entity_indexes[s].entity_index]?this._card.attributesStr[t.tool.config.entity_indexes[s].entity_index]:this._card.secondaryInfoStr[t.tool.config.entity_indexes[s].entity_index]?this._card.secondaryInfoStr[t.tool.config.entity_indexes[s].entity_index]:this._card.entitiesStr[t.tool.config.entity_indexes[s].entity_index];t.tool.values=e}})),this.dev.performance&&console.timeEnd(`--\x3e ${this.toolsetId} PERFORMANCE Toolset::updateValues`)}connectedCallback(){this.dev.performance&&console.time(`--\x3e ${this.toolsetId} PERFORMANCE Toolset::connectedCallback`),this.dev.debug&&console.log("*****Event - connectedCallback",this.toolsetId,(new Date).getTime()),this.dev.performance&&console.timeEnd(`--\x3e ${this.toolsetId} PERFORMANCE Toolset::connectedCallback`)}disconnectedCallback(){this.dev.performance&&console.time(`--\x3e ${this.toolsetId} PERFORMANCE Toolset::disconnectedCallback`),this.dev.debug&&console.log("*****Event - disconnectedCallback",this.toolsetId,(new Date).getTime()),this.dev.performance&&console.timeEnd(`--\x3e ${this.toolsetId} PERFORMANCE Toolset::disconnectedCallback`)}firstUpdated(t){this.dev.debug&&console.log("*****Event - Toolset::firstUpdated",this.toolsetId,(new Date).getTime()),this.tools&&this.tools.map((e=>"function"==typeof e.tool.firstUpdated&&(e.tool.firstUpdated(t),!0)))}updated(t){this.dev.debug&&console.log("*****Event - Updated",this.toolsetId,(new Date).getTime()),this.tools&&this.tools.map((e=>"function"==typeof e.tool.updated&&(e.tool.updated(t),!0)))}willUpdate(t){this.dev.debug&&console.log("*****Event - willUpdate",this.toolsetId,(new Date).getTime()),this.tools&&this.tools.map((e=>"function"==typeof e.tool.willUpdate&&(e.tool.willUpdate(t),!0)))}shouldUpdate(t){this.dev.debug&&console.log("*****Event - shouldUpdate",this.toolsetId,(new Date).getTime()),this.tools&&this.tools.map((e=>"function"==typeof e.tool.shouldUpdate&&(e.tool.shouldUpdate(t),!0)))}renderToolset(){this.dev.debug&&console.log("*****Event - renderToolset",this.toolsetId,(new Date).getTime());const t=this.tools.map((t=>z`
        <!-- Toolset Render Tools -->
        ${t.tool.render()}
      `));return z`${t}`}render(){return!this._card.isSafari&&!this._card.iOS||this._card.isSafariGte16?z`
      ...
      `}}class Ms{constructor(){this.isSafari=this.detectSafari(),this.isiOS=this.detectiOS(),this.isSafari14=this.detectSafari14(),this.isSafari15=this.detectSafari15(),this.isSafari16=this.detectSafari16(),this.isChrome=this.detectChrome(),this.isFirefox=this.detectFirefox(),this.isEdge=this.detectEdge()}detectSafari(){return!!window.navigator.userAgent.match(/Version\/[\d.]+.*Safari/)}detectSafari14(){return this.isSafari&&/Version\/14\.[0-9]/.test(window.navigator.userAgent)}detectSafari15(){return this.isSafari&&/Version\/15\.[0-9]/.test(window.navigator.userAgent)}detectSafari16(){return this.isSafari&&/Version\/16\.[0-9]/.test(window.navigator.userAgent)}detectiOS(){return(/iPad|iPhone|iPod/.test(window.navigator.userAgent)||"MacIntel"===window.navigator.platform&&window.navigator.maxTouchPoints>1)&&!window.MSStream}detectChrome(){return/Chrome/.test(window.navigator.userAgent)&&/Google Inc/.test(window.navigator.vendor)}detectFirefox(){return/Firefox/.test(window.navigator.userAgent)}detectEdge(){return/Edg/.test(window.navigator.userAgent)}detectiOSApp(){const t=window.navigator.userAgent.toLowerCase();return/os 15.*like safari/.test(t)||/os 14.*like safari/.test(t)||/os 16.*like safari/.test(t)}supportsSVG(){return!!document.createElementNS&&!!document.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect}supportsCSSVariables(){return window.CSS&&window.CSS.supports&&window.CSS.supports("color","var(--test)")}supportsWebGL(){try{const t=document.createElement("canvas");return!(!t.getContext("webgl")&&!t.getContext("experimental-webgl"))}catch(ti){return!1}}supportsTouch(){return"ontouchstart"in window||navigator.maxTouchPoints>0}supportsPointerEvents(){return"onpointerdown"in window}isLowEndDevice(){return navigator.hardwareConcurrency<=2||navigator.deviceMemory&&navigator.deviceMemory<=2}getBrowserInfo(){const t=window.navigator.userAgent;let e="Unknown",s="Unknown";if(this.isChrome){e="Chrome";const i=t.match(/Chrome\/(\d+)/);s=i?i[1]:"Unknown"}else if(this.isFirefox){e="Firefox";const i=t.match(/Firefox\/(\d+)/);s=i?i[1]:"Unknown"}else if(this.isEdge){e="Edge";const i=t.match(/Edg\/(\d+)/);s=i?i[1]:"Unknown"}else if(this.isSafari){e="Safari";const i=t.match(/Version\/(\d+)/);s=i?i[1]:"Unknown"}return{name:e,version:s,platform:navigator.platform,userAgent:t}}getCapabilities(){return{svg:this.supportsSVG(),cssVariables:this.supportsCSSVariables(),webgl:this.supportsWebGL(),touch:this.supportsTouch(),pointerEvents:this.supportsPointerEvents(),lowEndDevice:this.isLowEndDevice()}}}const As=new Set(["area","badge","bar","circle","circslider","ellipse","horseshoe","icon","line","name","progpath","rectangle","rectex","regpoly","segarc","slider","sparkline","state","switch","text","usersvg"]);class Es{constructor(){this.errors=[],this.warnings=[]}validate(t){return this.errors=[],this.warnings=[],this.validateTopLevel(t),this.validateEntities(t),this.validateLayout(t),this.validateToolsets(t),{isValid:0===this.errors.length,errors:this.errors,warnings:this.warnings}}validateTopLevel(t){t?(t.type&&"custom:swiss-army-knife-card"===t.type||this.addError("type","Invalid card type","INVALID_TYPE"),t.entities&&Array.isArray(t.entities)||this.addError("entities","Entities array is required","ENTITIES_REQUIRED"),t.layout||this.addError("layout","Layout configuration is required","LAYOUT_REQUIRED")):this.addError("","Configuration is required","CONFIG_REQUIRED")}validateEntities(t){t.entities&&t.entities.forEach(((t,e)=>{const s=`entities[${e}]`;"string"==typeof t?this.isValidEntityId(t)||this.addError(`${s}`,"Invalid entity ID format","INVALID_ENTITY_ID"):"object"==typeof t?t.entity?this.isValidEntityId(t.entity)||this.addError(`${s}.entity`,"Invalid entity ID format","INVALID_ENTITY_ID"):this.addError(`${s}.entity`,"Entity ID is required","ENTITY_ID_REQUIRED"):this.addError(`${s}`,"Entity must be string or object","INVALID_ENTITY_FORMAT")}))}validateLayout(t){if(!t.layout)return;const e=t.layout;e.aspectratio&&!this.isValidAspectRatio(e.aspectratio)&&this.addWarning("layout.aspectratio","Invalid aspect ratio format","INVALID_ASPECT_RATIO")}validateToolsets(t){t.layout?.toolsets&&t.layout.toolsets.forEach(((t,e)=>{const s=`layout.toolsets[${e}]`;this.validateToolset(t,s)}))}validateToolset(t,e){t.position?this.validatePosition(t.position,`${e}.position`):this.addError(`${e}.position`,"Toolset position is required","POSITION_REQUIRED"),t.tools&&Array.isArray(t.tools)?t.tools.forEach(((t,s)=>{const i=`${e}.tools[${s}]`;this.validateTool(t,i)})):this.addError(`${e}.tools`,"Tools array is required","TOOLS_REQUIRED")}validateTool(t,e){t.type?(As.has(t.type)||this.addError(`${e}.type`,`Unsupported tool type: ${t.type}`,"UNSUPPORTED_TOOL_TYPE"),t.position?this.validatePosition(t.position,`${e}.position`):this.addError(`${e}.position`,"Tool position is required","TOOL_POSITION_REQUIRED"),this.validateToolSpecificConfig(t,e)):this.addError(`${e}.type`,"Tool type is required","TOOL_TYPE_REQUIRED")}validatePosition(t,e){"object"==typeof t?(void 0!==t.cx&&"number"!=typeof t.cx&&this.addWarning(`${e}.cx`,"cx should be a number","INVALID_CX"),void 0!==t.cy&&"number"!=typeof t.cy&&this.addWarning(`${e}.cy`,"cy should be a number","INVALID_CY")):this.addError(e,"Position must be an object","INVALID_POSITION_TYPE")}validateToolSpecificConfig(t,e){switch(t.type){case"circle":t.position&&"number"!=typeof t.position.radius&&this.addError(`${e}.position.radius`,"Circle radius is required","CIRCLE_RADIUS_REQUIRED");break;case"rectangle":const s=t.position;s.width&&"number"==typeof s.width||this.addError(`${e}.position.width`,"Rectangle width is required","RECTANGLE_WIDTH_REQUIRED"),s.height&&"number"==typeof s.height||this.addError(`${e}.position.height`,"Rectangle height is required","RECTANGLE_HEIGHT_REQUIRED");break;case"text":t.text||this.addWarning(`${e}.text`,"Text content is recommended","TEXT_CONTENT_RECOMMENDED");break;case"entity_state":void 0===t.entity_index&&this.addError(`${e}.entity_index`,"Entity index is required for entity tools","ENTITY_INDEX_REQUIRED");break;case"switch":case"slider":void 0===t.entity_index&&this.addError(`${e}.entity_index`,"Entity index is required for interactive tools","ENTITY_INDEX_REQUIRED")}}isValidEntityId(t){return/^[a-z_]+\.[a-z0-9_]+$/.test(t)}isValidAspectRatio(t){return/^\d+(\.\d+)?[/:]\d+(\.\d+)?$/.test(t)}addError(t,e,s){this.errors.push({path:t,message:e,code:s,severity:"error"})}addWarning(t,e,s){this.warnings.push({path:t,message:e,code:s,severity:"warning"})}static validateQuick(t){return(new Es).validate(t).isValid}static getValidationSummary(t){const e=(new Es).validate(t);if(e.isValid)return"Configuration is valid ✅";return`Configuration issues: ${[`❌ ${e.errors.length} error(s)`,e.warnings.length>0?`⚠️ ${e.warnings.length} warning(s)`:null].filter(Boolean).join(", ")}`}}const Cs={definitions:{sak_css_definitions:[{content:".sak-state__value {\n  --descr: extra-css;\n  letter-spacing: 0.05em;\n}\n.toolset__group-outer {\n  overflow: visible;\n  /*filter: drop-shadow(0px 1px 1px rgba(0,0,0,0.8));*/\n  /*filter: url(#shadow);*/\n} .toolset__group {\n  overflow: visible;\n  /*filter: drop-shadow(0px 1px 1px rgba(0,0,0,0.8));*/\n  /*filter: url(#shadow);*/\n}\n.sak-circslider__group-inner {\n  pointer-events: none;\n  }\n#as-thumb-group {\n  overflow: visible;\n  pointer-events: all;\n} #as-label {\n  overflow: visible;\n} .sak-circslider {\n  overflow: visible;\n  fill: none;\n  stroke: none;\n  pointer-events: none;\n} .sak-circslider__capture {\n  overflow: visible;\n  pointer-events: all;\n  fill: none;\n  stroke-width: 0;\n  touch-action: manipulation;\n  fill: grey;\n  fill-opacity: 0.1;\n  stroke-width: 0em;\n  stroke: red;\n} .sak-circslider__active {\n  stroke: var(--theme-sys-color-primary);\n  stroke-width: 4em;\n  pointer-events: all;\n} .sak-circslider__track {\n  fill: none;\n  stroke-width: 2em;\n  stroke: var(--theme-sys-elevation-surface-neutral10);\n  overflow: visible;\n  pointer-events: all;\n} .sak-circslider__thumb {\n  overflow: visible;\n  fill: var(--theme-sys-color-primary);\n  fill-opacity: 1;\n  transform-origin: center;\n  transform-box: fill-box;\n} .sak-circslider__value {\n  overflow: visible;\n  fill: var(--primary-text-color);\n  font-size: 8em;\n  font-weight: 400;\n  dominant-baseline: central;\n  pointer-events: none;\n} .sak-circslider__uom {\n  overflow: visible;\n  fill: var(--primary-text-color);\n  text-anchor: middle;\n  dominant-baseline: central;\n  opacity: 0.7;\n  letter-spacing: 0.05em;\n  pointer-events: none;\n}\n.sak-area { }\n.sak-area__area {\n  font-size: 3em;\n  fill: var(--primary-text-color);\n  opacity: 0.8;\n  text-anchor: middle;\n  dominant-baseline: central;\n  letter-spacing: 0.05em;\n}\n.sak-badge { } .sak-badge__left {\n  stroke-width: 0;\n  fill: grey;\n} .sak-badge__right {\n  stroke-width: 0;\n  fill: var(--theme-gradient-color-03, darkgrey);\n}\n.sak-barchart { } .sak-barchart__line {\n  stroke-linecap: round;\n  stroke-linejoin: round;\n}\n.sak-circle { } .sak-circle__circle {\n  fill: var(--primary-background-color);\n}\n.sak-ellipse { } .sak-ellipse__ellipse {\n  fill: var(--primary-background-color);\n}\n.sak-horseshoe { } .sak-horseshoe__todo { }\n.sak-icon { } .sak-icon__icon {\n  --mdc-icon-size: 100%;\n  align-self: center;\n  height: 100%;\n  width: 100%;\n  fill: var(--primary-text-color);\n  color: var(--primary-text-color);\n}\n.sak-line {\n  overflow: visible;\n} .sak-line__line {\n  stroke-linecap: round;\n  stroke: var(--primary-text-color);\n  opacity: 1.0;\n  stroke-width: 2;\n}\n.sak-name {\n  overflow: visible;\n} .sak-name__name {\n  font-size: 3em;\n  fill: var(--primary-text-color);\n  opacity: 1.0;\n  text-anchor: middle;\n  dominant-baseline: central;\n  letter-spacing: 0.05em;\n}\n.sak-polygon {\n  overflow: visible;\n} .sak-polygon__regpoly {\n  stroke: var(--primary-text-color);\n  fill: var(--primary-background-color);\n  fill-rule: nonzero;\n}\n.sak-rectangle {\n  overflow: visible;\n} .sak-rectangle__rectangle {\n  stroke-linecap: round;\n  stroke: var(--primary-text-color);\n  opacity: 1.0;\n  stroke-width: 2em;\n  fill: var(--primary-background-color);\n}\n  \n.sak-rectex { } .sak-rectex__rectex {\n  stroke-linecap: round;\n  stroke: var(--primary-text-color);\n  opacity: 1.0;\n  stroke-width: 0;\n  fill: var(--primary-background-color);\n}\n.sak-segarc { } .sak-segarc__background {\n  stroke-linecap: round;\n  fill: var(--primary-background-color);\n  stroke-width: 0;\n  fill-rule: evenodd;\n  stroke-linejoin: round;\n} .sak-segarc__foreground {\n  stroke-linecap: round;\n  fill: var(--primary-color);\n  stroke: none;\n  stroke-width: 0.5;\n  fill-rule: evenodd;\n  stroke-linejoin: round;\n}\n#rs-thumb-group {\n  overflow: visible;\n} #rs-label {\n  overflow: visible;\n} .sak-slider {\n  pointer-events: none;\n  overflow: visible;\n} .sak-slider__capture {\n  overflow: visible;\n  pointer-events: all;\n  fill: none;\n  stroke-width: 0;\n  touch-action: manipulation;\n} .sak-slider__track {\n  overflow: visible;\n  fill-opacity: 0.38;\n  stroke-width: 0;\n  stroke: var(--primary-text-color);\n  fill: var(--switch-unchecked-track-color);\n  transition: all .5s ease;\n  pointer-events: none;\n} .sak-slider__thumb {\n  overflow: visible;\n  --thumb-stroke: var(--secondary-text-color);\n  stroke: var(--thumb-stroke);\n  fill: var(--primary-background-color);\n  pointer-events: none;\n} .sak-slider__value {\n  overflow: visible;\n  fill: var(--primary-text-color);\n  font-size: 8em;\n  font-weight: 400;\n  transition: all .5s cubic-bezier(0.4, 0, 0.2, 1);\n  pointer-events: none;\n  dominant-baseline: central;\n} .sak-slider__uom {\n  overflow: visible;\n  fill: var(--primary-text-color);\n  text-anchor: middle;\n  dominant-baseline: central;\n  opacity: 0.7;\n  letter-spacing: 0.05em;\n}\n  \n.sak-state { } .sak-state__value {\n  --descr: original;\n  font-size: 3em;\n  fill: var(--primary-text-color);\n  opacity: 1.0;\n  text-anchor: middle;\n  dominant-baseline: central;\n  letter-spacing: 0.05em;\n} .sak-state__uom {\n  fill: var(--primary-text-color);\n  text-anchor: middle;\n  dominant-baseline: central;\n  opacity: 0.7;\n  letter-spacing: 0.05em;\n}\n.sak-switch { } .sak-switch__track {\n  fill-opacity: 0.38;\n  stroke-width: 0;\n  stroke: var(--primary-text-color);\n  fill: var(--primary-background-color);\n  transition: all .5s ease;\n  pointer-events: none;\n} .sak-switch__thumb {\n  --thumb-stroke: var(--secondary-text-color);\n  stroke: var(--thumb-stroke);\n  fill: var(--primary-background-color);\n  transition: all .5s cubic-bezier(0.4, 0, 0.2, 1);\n  pointer-events: none;\n}\n.sak-text { } .sak-text__text {\n  font-size: 3em;\n  fill: var(--primary-text-color);\n  opacity: 1.0;\n  text-anchor: middle;\n  dominant-baseline: central;\n}\n.sak-usersvg__group { } .sak-usersvg__image { }\n@keyframes blinkingText {\n  0%{   opacity: 0%;   }\n  49%{  opacity: 0%;   }\n  60%{  opacity: 100%; }\n  99%{  opacity: 100%; }\n  100%{ opacity: 0%;   }\n}\n@keyframes zoomOut {\n  from {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0;\n    transform: scale3d(0.3, 0.3, 0.3);\n  }\n  to {\n    opacity: 0;\n  }\n}\n@keyframes bounce {\n  from,\n  20%,\n  53%,\n  80%,\n  to {\n  animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n  transform: translate3d(0, 0, 0);\n  }\n  40%,\n  43% {\n  animation-timing-function: cubic-bezier(0.755, 0.05, 0.855, 0.06);\n  transform: translate3d(0, -30px, 0);\n  }\n  70% {\n  animation-timing-function: cubic-bezier(0.755, 0.05, 0.855, 0.06);\n  transform: translate3d(0, -15px, 0);\n  }\n  90% {\n  transform: translate3d(0, -4px, 0);\n  }\n}\n@-webkit-keyframes flash {\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.2;\n  }\n  100% {\n    opacity: 1;\n  }\n} @keyframes flash {\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.2;\n  }\n  100% {\n    opacity: 1;\n  }\n}\n@keyframes flashold {\n  from,\n  50%,\n  to {\n  opacity: 1;\n  }\n  25%,\n  75% {\n  opacity: 0;\n  }\n}\n@keyframes headShake {\n  0% {\n  transform: translateX(0);\n  }\n  6.5% {\n  transform: translateX(-6px) rotateY(-9deg);\n  }\n  18.5% {\n  transform: translateX(5px) rotateY(7deg);\n  }\n  31.5% {\n  transform: translateX(-3px) rotateY(-5deg);\n  }\n  43.5% {\n  transform: translateX(2px) rotateY(3deg);\n  }\n  50% {\n  transform: translateX(0);\n  }\n}\n@keyframes heartBeat {\n  0% {\n  transform: scale(1);\n  }\n  14% {\n  transform: scale(1.3);\n  }\n  28% {\n  transform: scale(1);\n  }\n  42% {\n  transform: scale(1.3);\n  }\n  70% {\n  transform: scale(1);\n  }\n}\n@keyframes jello {\n  from,\n  11.1%,\n  to {\n  transform: translate3d(0, 0, 0);\n  }\n  22.2% {\n  transform: skewX(-12.5deg) skewY(-12.5deg);\n  }\n  33.3% {\n  transform: skewX(6.25deg) skewY(6.25deg);\n  }\n  44.4% {\n  transform: skewX(-3.125deg) skewY(-3.125deg);\n  }\n  55.5% {\n  transform: skewX(1.5625deg) skewY(1.5625deg);\n  }\n  66.6% {\n  transform: skewX(-0.78125deg) skewY(-0.78125deg);\n  }\n  77.7% {\n  transform: skewX(0.390625deg) skewY(0.390625deg);\n  }\n  88.8% {\n  transform: skewX(-0.1953125deg) skewY(-0.1953125deg);\n  }\n}\n@keyframes pulse {\n  from {\n  transform: scale3d(1, 1, 1);\n  }\n  50% {\n  transform: scale3d(1.05, 1.05, 1.05);\n  }\n  to {\n  transform: scale3d(1, 1, 1);\n  }\n}\n@keyframes rubberBand {\n  from {\n  transform: scale3d(1, 1, 1);\n  }\n  30% {\n  transform: scale3d(1.25, 0.75, 1);\n  }\n  40% {\n  transform: scale3d(0.75, 1.25, 1);\n  }\n  50% {\n  transform: scale3d(1.15, 0.85, 1);\n  }\n  65% {\n  transform: scale3d(0.95, 1.05, 1);\n  }\n  75% {\n  transform: scale3d(1.05, 0.95, 1);\n  }\n  to {\n  transform: scale3d(1, 1, 1);\n  }\n}\n@keyframes shake {\n  from,\n  to {\n  transform: translate3d(0, 0, 0);\n  }\n  10%,\n  30%,\n  50%,\n  70%,\n  90% {\n  transform: translate3d(-10px, 0, 0);\n  }\n  20%,\n  40%,\n  60%,\n  80% {\n  transform: translate3d(10px, 0, 0);\n  }\n}\n@keyframes swing {\n  20% {\n  transform: rotate3d(0, 0, 1, 15deg);\n  }\n  40% {\n  transform: rotate3d(0, 0, 1, -10deg);\n  }\n  60% {\n  transform: rotate3d(0, 0, 1, 5deg);\n  }\n  80% {\n  transform: rotate3d(0, 0, 1, -5deg);\n  }\n  to {\n  transform: rotate3d(0, 0, 1, 0deg);\n  }\n}\n@keyframes tada {\n  from {\n  transform: scale3d(1, 1, 1);\n  }\n  10%,\n  20% {\n  transform: scale3d(0.9, 0.9, 0.9) rotate3d(0, 0, 1, -3deg);\n  }\n  30%,\n  50%,\n  70%,\n  90% {\n  transform: scale3d(1.1, 1.1, 1.1) rotate3d(0, 0, 1, 3deg);\n  }\n  40%,\n  60%,\n  80% {\n  transform: scale3d(1.1, 1.1, 1.1) rotate3d(0, 0, 1, -3deg);\n  }\n  to {\n  transform: scale3d(1, 1, 1);\n  }\n}\n@keyframes wobble {\n  from {\n  transform: translate3d(0, 0, 0);\n  }\n  15% {\n  transform: translate3d(-25%, 0, 0) rotate3d(0, 0, 1, -5deg);\n  }\n  30% {\n  transform: translate3d(20%, 0, 0) rotate3d(0, 0, 1, 3deg);\n  }\n  45% {\n  transform: translate3d(-15%, 0, 0) rotate3d(0, 0, 1, -3deg);\n  }\n  60% {\n  transform: translate3d(10%, 0, 0) rotate3d(0, 0, 1, 2deg);\n  }\n  75% {\n  transform: translate3d(-5%, 0, 0) rotate3d(0, 0, 1, -1deg);\n  }\n  to {\n  transform: translate3d(0, 0, 0);\n  }\n}\n@-webkit-keyframes spin {\n  0% {\n    -webkit-transform: rotate(0);\n            transform: rotate(0);\n  }\n  100% {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg);\n  }\n} @keyframes spin {\n  0% {\n    -webkit-transform: rotate(0);\n            transform: rotate(0);\n  }\n  100% {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg);\n  }\n} @keyframes spinold {\n    from {\n        -webkit-transform: -webkit-rotate(0deg);\n        transform:rotate(0deg);\n    }\n    to {\n        -webkit-transform: -webkit-rotate(360deg);\n        transform:rotate(360deg);\n    }\n}\n@keyframes spinn {\n  100% {\n    -webkit-transform: -webkit-rotate(360deg);\n    transform: rotate(360deg);\n  }\n}\n@-webkit-keyframes spinn {\n  100% {\n    -webkit-transform: -webkit-rotate(360deg);\n    transform: rotate(360deg);\n  }\n}\n@keyframes spin-stop {\n  100% {\n    -webkit-transform: -webkit-rotate(0deg);\n    transform: rotate(0deg);\n  }\n}\n"}],sak_svg_definitions:[{content:'<filter id="sak-inset-1" x="-50%" y="-50%" width="400%" height="400%">\n  <feComponentTransfer in=SourceAlpha>\n    <feFuncA type="table" tableValues="1 0" />\n  </feComponentTransfer>\n  <feGaussianBlur stdDeviation="1"/>\n  <feOffset dx="0" dy="1" result="offsetblur"/>\n  <feFlood flood-color="rgba(0, 0, 0, 0.3)" result="color"/>\n  <feComposite in2="offsetblur" operator="in"/>\n  <feComposite in2="SourceAlpha" operator="in" />\n  <feMerge>\n    <feMergeNode in="SourceGraphic" />\n    <feMergeNode />\n  </feMerge>\n</filter>\n<filter id="sak-inset-2">\n  \x3c!-- Shadow Offset --\x3e\n  <feOffset\n    dx=\'1\'\n    dy=\'1\'\n  />\n  \x3c!-- Shadow Blur --\x3e\n  <feGaussianBlur\n    stdDeviation=\'0.5\'\n    result=\'offset-blur\'\n  />\n  \x3c!-- Invert the drop shadow\n       to create an inner shadow --\x3e\n  <feComposite\n    operator=\'out\'\n    in=\'SourceGraphic\'\n    in2=\'offset-blur\'\n    result=\'inverse\'\n  />\n  \x3c!-- Color & Opacity --\x3e\n  <feFlood\n    flood-color=\'black\'\n    flood-opacity=\'0.4\'\n    result=\'color\'\n  />\n  \x3c!-- Clip color inside shadow --\x3e\n  <feComposite\n    operator=\'in\'\n    in=\'color\'\n    in2=\'inverse\'\n    result=\'shadow\'\n  />\n  \x3c!-- Put shadow over original object --\x3e\n  <feComposite\n    operator=\'over\'\n    in=\'shadow\'\n    in2=\'SourceGraphic\'\n  />\n</filter>\n\x3c!-- Neumorphic filter --\x3e\n\x3c!-- --\x3e\n\x3c!-- Light Shadow, #FFFFFF at 50%, x:-6, Y:-6, Blur:16 --\x3e\n\x3c!-- Dark Shadow: #d1cdc7 at 50%, x:6, y:6, Blur:16 --\x3e\n\x3c!-- Main Background: #efeeee --\x3e\n\x3c!-- Shape Background: #efeeee --\x3e\n\x3c!-- Optional Border: #fff at 20% Alpha --\x3e\n\x3c!-- Dark Shadow was: 0d2750 --\x3e\n\n\x3c!-- 2021.11.17 --\x3e\n\x3c!-- Performance with inset shadow and width/height=150% seems to be optimal setting --\x3e\n\x3c!-- Smaller settings give clipping, and larger settings performance hits --\x3e\n\x3c!-- Absolute settings (userSpaceOnUse) seem to be difficult to find right settings --\x3e\n<filter id="is-1" x="-25%" y="-25%" width="150%" height="150%">\n  <feComponentTransfer in=SourceAlpha>\n    <feFuncA type="table" tableValues="1 0" />\n  </feComponentTransfer>\n  <feGaussianBlur stdDeviation="1"/>\n  <feOffset dx="2" dy="2" result="offsetblur"/>\n  <feFlood flood-color="#0d2750" flood-opacity="0.5" result="color"/>\n  <feComposite in2="offsetblur" operator="in"/>\n  <feComposite in2="SourceAlpha" operator="in" />\n  <feMerge>\n    <feMergeNode in="SourceGraphic" />\n    <feMergeNode />\n  </feMerge>\n</filter>\n\n<filter id="is-1b" filterUnits="userSpaceOnUse" x="-200" y="-200" width="1000" height="1000">\n  <feComponentTransfer in=SourceAlpha>\n    <feFuncA type="table" tableValues="1 0" />\n  </feComponentTransfer>\n  <feGaussianBlur stdDeviation="1"/>\n  <feOffset dx="2" dy="2" result="offsetblur"/>\n  <feFlood flood-color="#0d2750" flood-opacity="0.5" result="color"/>\n  <feComposite in2="offsetblur" operator="in"/>\n  <feComposite in2="SourceAlpha" operator="in" />\n  <feMerge>\n    <feMergeNode in="SourceGraphic" />\n    <feMergeNode />\n  </feMerge>\n</filter>\n\n\x3c!-- Using feComposite in="offsetblur" operator="in" instead of in2 gives a --\x3e\n\x3c!-- much larger shadow area, much deeper! WHY?? --\x3e\n\n<filter id="nm-2" x="-50%" y="-50%" width="200%" height="200%">\n  <feComponentTransfer in=SourceAlpha out=transfer>\n    <feFuncA type="table" tableValues="1 0" />\n  </feComponentTransfer>\n  \n  <feGaussianBlur input="transfer" stdDeviation="5" result="blurdark"/>\n  <feOffset input="blurdark" dx="12" dy="12" result="offsetblurdark"/>\n  <feFlood input="offsetblurdark" flood-color="#d1cdc7" flood-opacity="0.4" result="colordark"/>\n  \n  <feGaussianBlur input="transfer" stdDeviation="5" result="blurlight"/>\n  <feOffset input="blurlight" dx="-12" dy="-12" result="offsetblurlight"/>\n  <feFlood input="offsetblurlight" flood-color="white" flood-opacity="0.9" result="colorlight"/>\n  \n  <feComposite in="offsetblurdark" operator="in"/>\n  <feComposite in="SourceAlpha" operator="in" />\n  \n  <feMerge>\n    <feMergeNode in="SourceGraphic" />\n    <feMergeNode />\n  </feMerge>\n</filter>\n\n<filter id="filter-yoksel" x="-20%" y="-20%" width="140%" height="140%" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse" color-interpolation-filters="linearRGB">\n  <feFlood flood-color="#eeebe7" flood-opacity="0.7" x="0%" y="0%" width="100%" height="100%" result="flood2"/>\n  <feComposite in="flood2" in2="SourceAlpha" operator="out" x="0%" y="0%" width="100%" height="100%" result="composite5"/>\n  <feOffset dx="-9" dy="-7" x="0%" y="0%" width="100%" height="100%" in="composite5" result="offset1"/>\n  <feGaussianBlur stdDeviation="3 10" x="0%" y="0%" width="100%" height="100%" in="offset1" edgeMode="none" result="blur2"/>\n  <feComposite in="merge3" in2="SourceAlpha" operator="in" x="0%" y="0%" width="100%" height="100%" result="composite7"/>\n  <feFlood flood-color="#0f0f0f" flood-opacity="1" x="0%" y="0%" width="100%" height="100%" result="flood4"/>\n  <feComposite in="flood4" in2="SourceAlpha" operator="out" x="0%" y="0%" width="100%" height="100%" result="composite8"/>\n  <feOffset dx="6" dy="6" x="0%" y="0%" width="100%" height="100%" in="merge3" result="offset2"/>\n  <feGaussianBlur stdDeviation="3 10" x="0%" y="0%" width="100%" height="100%" in="offset2" edgeMode="none" result="blur3"/>\n  <feComposite in="blur3" in2="SourceAlpha" operator="in" x="0%" y="0%" width="100%" height="100%" result="composite9"/>\n  <feMerge x="0%" y="0%" width="100%" height="100%" result="merge3">\n        <feMergeNode in="SourceGraphic"/>\n    <feMergeNode in="composite7"/>\n    <feMergeNode in="composite9"/>\n    </feMerge>\n</filter>\n\n\x3c!-- 2021.11.15 --\x3e\n\x3c!-- For some reason, changing the filter width/height from 160% to 600% improves performance on iOS 15 --\x3e\n\n\x3c!-- second try... --\x3e\n<filter id="filter" x="-50%" y="-50%" width="300%" height="300%">\n  <feFlood flood-color="var(--cs-theme-shadow-lighter)" flood-opacity="1" result="flood2"/>\n  <feComposite in="flood2" in2="SourceAlpha" operator="out" result="composite5"/>\n  <feOffset dx="-6" dy="-6" in="composite5" result="offset1"/>\n  <feGaussianBlur stdDeviation="5" in="offset1" edgeMode="none" result="blur2"/>\n  <feComposite in="blur2" in2="SourceAlpha" operator="in"  result="composite7"/>\n  \n  \x3c!-- flood-color="#777777" --\x3e\n  <feFlood flood-color="var(--cs-theme-shadow-darker)" flood-opacity="1" result="flood4"/>\n  <feComposite in="flood4" in2="SourceAlpha" operator="out" result="composite8"/>\n  <feOffset dx="6" dy="6" in="composite8" result="offset2"/>\n  <feGaussianBlur stdDeviation="15" in="offset2" edgeMode="none" result="blur3"/>\n  <feComposite in="blur3" in2="SourceAlpha" operator="in" result="composite9"/>\n  \n  <feMerge result="merge3">\n    <feMergeNode in="SourceGraphic"/>\n    <feMergeNode in="composite7"/>\n    <feMergeNode in="composite9"/>\n    </feMerge>\n</filter>\n\n<filter id="filterb" filterUnits="userSpaceOnUse" x="-200" y="-200" width="1000" height="1000">\n  <feFlood flood-color="var(--cs-theme-shadow-lighter)" flood-opacity="1" result="flood2"/>\n  <feComposite in="flood2" in2="SourceAlpha" operator="out" result="composite5"/>\n  <feOffset dx="-6" dy="-6" in="composite5" result="offset1"/>\n  <feGaussianBlur stdDeviation="5" in="offset1" edgeMode="none" result="blur2"/>\n  <feComposite in="blur2" in2="SourceAlpha" operator="in"  result="composite7"/>\n  \n  \x3c!-- flood-color="#777777" --\x3e\n  <feFlood flood-color="var(--cs-theme-shadow-darker)" flood-opacity="1" result="flood4"/>\n  <feComposite in="flood4" in2="SourceAlpha" operator="out" result="composite8"/>\n  <feOffset dx="6" dy="6" in="composite8" result="offset2"/>\n  <feGaussianBlur stdDeviation="15" in="offset2" edgeMode="none" result="blur3"/>\n  <feComposite in="blur3" in2="SourceAlpha" operator="in" result="composite9"/>\n  \n  <feMerge result="merge3">\n    <feMergeNode in="SourceGraphic"/>\n    <feMergeNode in="composite7"/>\n    <feMergeNode in="composite9"/>\n    </feMerge>\n</filter>\n\n<filter id="bold" x="-50%" y="-50%" width="240%" height="240%">\n  <feFlood flood-color="#FFFFFF" flood-opacity="0.8" result="flood2"/>\n  <feComposite in="flood2" in2="SourceAlpha" operator="out" result="composite5"/>\n  <feOffset dx="12" dy="12" in="composite5" result="offset1"/>\n  <feGaussianBlur stdDeviation="5" in="offset1" edgeMode="none" result="blur2"/>\n  <feComposite in="blur2" in2="SourceAlpha" operator="in"  result="composite7"/>\n  \n  <feFlood flood-color="#777777" flood-opacity="0.6" result="flood4"/>\n  <feComposite in="flood4" in2="SourceAlpha" operator="out" result="composite8"/>\n  <feOffset dx="-12" dy="-12" in="composite8" result="offset2"/>\n  <feGaussianBlur stdDeviation="15" in="offset2" edgeMode="none" result="blur3"/>\n  <feComposite in="blur3" in2="SourceAlpha" operator="in" result="composite9"/>\n  \n  <feMerge result="merge3">\n    <feMergeNode in="SourceGraphic"/>\n    <feMergeNode in="composite7"/>\n    <feMergeNode in="composite9"/>\n    </feMerge>\n</filter>\n\n<filter id="filterss" x="-20%" y="-20%" width="140%" height="140%">\n  <feFlood flood-color="#eeebe7" flood-opacity="0.9" result="flood2"/>\n  <feComposite in="flood2" in2="SourceAlpha" operator="out" result="composite5"/>\n  <feOffset dx="-15" dy="-15" in="composite5" result="offset1"/>\n  <feGaussianBlur stdDeviation="5" in="offset1" edgeMode="none" result="blur2"/>\n  <feComposite in="blur2" in2="SourceAlpha" operator="in" result="composite7"/>\n  \n  <feFlood flood-color="#0f0f0f" flood-opacity="1" result="flood4"/>\n  <feComposite in="flood4" in2="SourceAlpha" operator="out" result="composite8"/>\n  <feOffset dx="6" dy="6" in="composite8" result="offset2"/>\n  <feGaussianBlur stdDeviation="5" in="offset2" edgeMode="none" result="blur3"/>\n  <feComposite in="blur3" in2="SourceAlpha" operator="in" result="composite9"/>\n  \n  <feMerge result="merge3">\n    <feMergeNode in="SourceGraphic"/>\n    <feMergeNode in="composite7"/>\n    <feMergeNode in="composite9"/>\n    </feMerge>\n</filter>\n\n\x3c!-- flood-color="#d1cdc7" --\x3e\n\x3c!-- flood-color="#FFFFFF" --\x3e\n<filter id="nm-11" x="-50%" y="-50%" width="300%" height="300%">\n  <feDropShadow stdDeviation="5" in="SourceGraphic"\n    dx="6" dy="6" flood-color="var(--cs-theme-shadow-darker)" flood-opacity="0.5" result="dropShadow"\n  </feDropShadow>\n  <feDropShadow stdDeviation="4.5" in="SourceGraphic"\n    dx="-6" dy="-6" flood-color="var(--cs-theme-shadow-lighter)" flood-opacity="1" result="dropShadow1"/>\n  <feMerge result="merge">\n    <feMergeNode in="dropShadow1"/>\n    <feMergeNode in="dropShadow"/>\n  </feMerge>\n</filter>\n\n\x3c!-- 2021.11.15 --\x3e\n\x3c!-- For some reason, changing the filter width/height from 300% to 600% improves performance on iOS 15 --\x3e\n\x3c!-- Changing this value to 3000% improves performance also, but pixelates some of the views, so unusable! --\x3e\n\x3c!-- A value of 1000% seems to be a good value too! Switching views is now instant again for some reason! --\x3e\n\x3c!-- However, some views (sake5) becomes very, very, very slow. Views sake4 and sake6 are very fast. --\x3e\n\x3c!-- 2021.11.17 --\x3e\n\x3c!-- Let\'s settle for now with x/y=-10% and width/height=120%. This is actually the default for svg filters... --\x3e\n\n<filter id="sak-nm-default" x="-10%" y="-10%" width="120%" height="120%">\n  <feDropShadow stdDeviation="5" in="SourceGraphic" dx="6" dy="6" flood-color="var(--cs-theme-shadow-darker)" flood-opacity="0.5" result="dropShadow"/>\n  <feDropShadow stdDeviation="4.5" in="SourceGraphic" dx="-6" dy="-6" flood-color="var(--cs-theme-shadow-lighter)" flood-opacity="1" result="dropShadow1"/>\n  <feMerge result="merge">\n    <feMergeNode in="dropShadow1"/>\n    <feMergeNode in="dropShadow"/>\n  </feMerge>\n</filter>\n\n<filter id="nm-1" x="-10%" y="-10%" width="120%" height="120%">\n  <feDropShadow stdDeviation="5" in="SourceGraphic" dx="6" dy="6" flood-color="var(--cs-theme-shadow-darker)" flood-opacity="0.5" result="dropShadow"/>\n  <feDropShadow stdDeviation="4.5" in="SourceGraphic" dx="-6" dy="-6" flood-color="var(--cs-theme-shadow-lighter)" flood-opacity="1" result="dropShadow1"/>\n  <feMerge result="merge">\n    <feMergeNode in="dropShadow1"/>\n    <feMergeNode in="dropShadow"/>\n  </feMerge>\n</filter>\n\n<filter id="sak-nm-default-b" filterUnits="userSpaceOnUse" x="-100" y="-100" width="5000" height="800">\n  <feDropShadow stdDeviation="5" in="SourceGraphic" dx="6" dy="6" flood-color="var(--cs-theme-shadow-darker)" flood-opacity="0.5" result="dropShadow"/>\n  <feDropShadow stdDeviation="4.5" in="SourceGraphic" dx="-6" dy="-6" flood-color="var(--cs-theme-shadow-lighter)" flood-opacity="1" result="dropShadow1"/>\n  <feMerge result="merge">\n    <feMergeNode in="dropShadow1"/>\n    <feMergeNode in="dropShadow"/>\n  </feMerge>\n</filter>\n\n<filter id="nm-1b" filterUnits="userSpaceOnUse" x="-200" y="-200" width="2000" height="2000">\n  <feDropShadow stdDeviation="5" in="SourceGraphic" dx="6" dy="6" flood-color="var(--cs-theme-shadow-darker)" flood-opacity="0.5" result="dropShadow"/>\n  <feDropShadow stdDeviation="4.5" in="SourceGraphic" dx="-6" dy="-6" flood-color="var(--cs-theme-shadow-lighter)" flood-opacity="1" result="dropShadow1"/>\n  <feMerge result="merge">\n    <feMergeNode in="dropShadow1"/>\n    <feMergeNode in="dropShadow"/>\n  </feMerge>\n</filter>\n\n<filter id="nm-1-reverse" x="-10%" y="-10%" width="120%" height="120%">\n  <feDropShadow stdDeviation="4.5" in="SourceGraphic" dx="-6" dy="-6" flood-color="var(--cs-theme-shadow-darker)" flood-opacity="0.5" result="dropShadow"/>\n  <feDropShadow stdDeviation="5" in="SourceGraphic" dx="6" dy="6" flood-color="var(--cs-theme-shadow-lighter)" flood-opacity="1" result="dropShadow1"/>\n  <feMerge result="merge">\n    <feMergeNode in="dropShadow1"/>\n    <feMergeNode in="dropShadow"/>\n  </feMerge>\n</filter>\n\n<filter id="nm-1b-reverse" filterUnits="userSpaceOnUse" primitiveUnits="userSpaceOnUse" x="0" y="0" width="1000" height="1000">\n  <feDropShadow stdDeviation="4.5" in="SourceGraphic" dx="-6" dy="-6" flood-color="var(--cs-theme-shadow-darker)" flood-opacity="0.5" result="dropShadow"/>\n  <feDropShadow stdDeviation="5" in="SourceGraphic" dx="6" dy="6" flood-color="var(--cs-theme-shadow-lighter)" flood-opacity="1" result="dropShadow1"/>\n  <feMerge result="merge">\n    <feMergeNode in="dropShadow1"/>\n    <feMergeNode in="dropShadow"/>\n  </feMerge>\n</filter>\n<filter id=\'shadow\' color-interpolation-filters="sRGB">\n  <feDropShadow dx="2" dy="2" stdDeviation="3" flood-color="var(--cs-theme-shadow-darker)" flood-opacity="0.5"/>\n</filter>      \n<filter id="sak-drop-1" y="-50%" x="-50%" width="200%" height="400%">\n  <feDropShadow dx="0" dy="1.5" flood-color="var(--cs-theme-shadow-darker)" stdDeviation=".3"/>\n</filter>\n\n<filter id="sak-drop-1a" y="-50%" x="-50%" width="200%" height="400%">\n  <feDropShadow dx="1" dy="2" flood-color="var(--cs-theme-shadow-darker)" stdDeviation=".5"/>\n</filter>\n\n<filter id="sak-drop-1b" y="-50%" x="-50%" width="200%" height="400%">\n  <feDropShadow dx="2" dy="4" flood-color="var(--cs-theme-shadow-darker)" stdDeviation="6"/>\n</filter>\n\n<filter id="sak-drop-2" width="10" height="10">\n  <feDropShadow dx="2" dy="3" flood-color="var(--cs-theme-shadow-darker)" stdDeviation="0.5"/>\n</filter>\n\n<filter id="sak-drop-3" x="0" y="0" width="200%" height="200%">\n  <feOffset result="offOut" in="SourceAlpha" dx="20" dy="20" />\n  <feGaussianBlur result="blurOut" in="offOut" stdDeviation="10" />\n  <feBlend in="SourceGraphic" in2="blurOut" mode="normal" />\n</filter>\n\n<filter id="sak-drop-4" x="0" y="0" width="200%" height="200%">\n  <feGaussianBlur stdDeviation="1" />\n</filter>\n<marker viewBox="0 0 200 200" id="markerCircle" markerWidth="8" markerHeight="8" refX="5" refY="5">\n    <circle cx="5" cy="5" r="3" style="stroke: none; fill:currentColor;"/>\n</marker>\n\n<marker viewBox="0 0 200 200" id="markerArrow" markerWidth="13" markerHeight="13" refX="2" refY="6"\n       orient="auto">\n    <path d="M2,2 L2,11 L10,6 L2,2" style="fill: currentColor;" />\n</marker>\n<rect id="cliprect" width="100%" height="100%" fill="none" stroke="none" rx="3" />\n<clipPath id="clip">\n  <use xlink:href="#cliprect"/>\n</clipPath>\n<linearGradient id="sak-light-brightness-gradient" x1="1" x2="0">\n  <stop stop-color="#eeeeee"/>\n  <stop offset="1" stop-color="#555555"/>\n</linearGradient>\n\n<linearGradient id="sak-light-brightness-gradient--orange" x1="1" x2="0">\n  <stop stop-color="white"/>\n  <stop offset="1" stop-color="darkorange"/>\n</linearGradient>\n\n<linearGradient id="sak-light-brightness-gradient--reverse" x1="1" x2="0">\n  <stop stop-color="#555555"/>\n  <stop offset="1" stop-color="#eeeeee"/>\n</linearGradient>\n\n<linearGradient id="sak-light-color-temperature-gradient" x1="1" x2="0">\n  <stop stop-color="#ffa000"/>\n  <stop offset=".5" stop-color="#fff"/>\n  <stop offset="1" stop-color="#a6d1ff"/>\n</linearGradient>\n\n<linearGradient id="sak-boiler-setpoint-blue-orange-gradient" x1="1" x2="0">\n  <stop stop-color="#ff8c00"/>\n  <stop offset="1" stop-color="#0094ff"/>\n</linearGradient>\n\n<radialGradient id="sak-mask-radial-gradient">\n  <stop offset="0" stop-color="white" stop-opacity="1"/>\n  <stop offset="0.8" stop-color="white" stop-opacity="0.8"/>\n  <stop offset="1" stop-color="white" stop-opacity="0"/>\n</radialGradient>'}]},templates:{}},Ts=globalThis,Is=Ts.ShadowRoot&&(void 0===Ts.ShadyCSS||Ts.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ds=Symbol(),Ps=new WeakMap;
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Rs=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Ds)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(Is&&void 0===t){const s=void 0!==e&&1===e.length;s&&(t=Ps.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&Ps.set(e,t))}return t}toString(){return this.cssText}};const Ns=(t,...e)=>{const s=1===t.length?t[0]:e.reduce(((e,s,i)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[i+1]),t[0]);return new Rs(s,t,Ds)},Ls=Is?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return(t=>new Rs("string"==typeof t?t:t+"",void 0,Ds))(e)})(t):t
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */,{is:Vs,defineProperty:Os,getOwnPropertyDescriptor:Bs,getOwnPropertyNames:Us,getOwnPropertySymbols:zs,getPrototypeOf:Fs}=Object,Gs=globalThis,Hs=Gs.trustedTypes,js=Hs?Hs.emptyScript:"",qs=Gs.reactiveElementPolyfillSupport,Ws=(t,e)=>t,Ys={toAttribute(t,e){switch(e){case Boolean:t=t?js:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=null!==t;break;case Number:s=null===t?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch(t){s=null}}return s}},Xs=(t,e)=>!Vs(t,e),Js={attribute:!0,type:String,converter:Ys,reflect:!1,useDefault:!1,hasChanged:Xs};Symbol.metadata??=Symbol("metadata"),Gs.litPropertyMetadata??=new WeakMap;let Zs=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Js){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const s=Symbol(),i=this.getPropertyDescriptor(t,s,e);void 0!==i&&Os(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){const{get:i,set:a}=Bs(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get:i,set(e){const r=i?.call(this);a?.call(this,e),this.requestUpdate(t,r,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Js}static _$Ei(){if(this.hasOwnProperty(Ws("elementProperties")))return;const t=Fs(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Ws("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ws("properties"))){const t=this.properties,e=[...Us(t),...zs(t)];for(const s of e)this.createProperty(s,t[s])}const t=this[Symbol.metadata];if(null!==t){const e=litPropertyMetadata.get(t);if(void 0!==e)for(const[t,s]of e)this.elementProperties.set(t,s)}this._$Eh=new Map;for(const[e,s]of this.elementProperties){const t=this._$Eu(e,s);void 0!==t&&this._$Eh.set(t,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const t of s)e.unshift(Ls(t))}else void 0!==t&&e.push(Ls(t));return e}static _$Eu(t,e){const s=e.attribute;return!1===s?void 0:"string"==typeof s?s:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((t=>t(this)))}addController(t){(this._$EO??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((t,e)=>{if(Is)t.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet));else for(const s of e){const e=document.createElement("style"),i=Ts.litNonce;void 0!==i&&e.setAttribute("nonce",i),e.textContent=s.cssText,t.appendChild(e)}})(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((t=>t.hostConnected?.()))}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach((t=>t.hostDisconnected?.()))}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){const s=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,s);if(void 0!==i&&!0===s.reflect){const a=(void 0!==s.converter?.toAttribute?s.converter:Ys).toAttribute(e,s.type);this._$Em=t,null==a?this.removeAttribute(i):this.setAttribute(i,a),this._$Em=null}}_$AK(t,e){const s=this.constructor,i=s._$Eh.get(t);if(void 0!==i&&this._$Em!==i){const t=s.getPropertyOptions(i),a="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:Ys;this._$Em=i;const r=a.fromAttribute(e,t.type);this[i]=r??this._$Ej?.get(i)??r,this._$Em=null}}requestUpdate(t,e,s,i=!1,a){if(void 0!==t){const r=this.constructor;if(!1===i&&(a=this[t]),s??=r.getPropertyOptions(t),!((s.hasChanged??Xs)(a,e)||s.useDefault&&s.reflect&&a===this._$Ej?.get(t)&&!this.hasAttribute(r._$Eu(t,s))))return;this.C(t,e,s)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:i,wrapped:a},r){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,r??e??this[t]),!0!==a||void 0!==r)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),!0===i&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[e,s]of t){const{wrapped:t}=s,i=this[e];!0!==t||this._$AL.has(e)||void 0===i||this.C(e,void 0,s,i)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach((t=>t.hostUpdate?.())),this.update(e)):this._$EM()}catch(e){throw t=!1,this._$EM(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach((t=>t.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach((t=>this._$ET(t,this[t]))),this._$EM()}updated(t){}firstUpdated(t){}};Zs.elementStyles=[],Zs.shadowRootOptions={mode:"open"},Zs[Ws("elementProperties")]=new Map,Zs[Ws("finalized")]=new Map,qs?.({ReactiveElement:Zs}),(Gs.reactiveElementVersions??=[]).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ks=globalThis,Qs=Ks.trustedTypes,ti=Qs?Qs.createPolicy("lit-html",{createHTML:t=>t}):void 0,ei="$lit$",si=`lit$${Math.random().toFixed(9).slice(2)}$`,ii="?"+si,ai=`<${ii}>`,ri=document,oi=()=>ri.createComment(""),ni=t=>null===t||"object"!=typeof t&&"function"!=typeof t,hi=Array.isArray,li="[ \t\n\f\r]",ci=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,di=/-->/g,gi=/>/g,ui=RegExp(`>|${li}(?:([^\\s"'>=/]+)(${li}*=${li}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),pi=/'/g,mi=/"/g,fi=/^(?:script|style|textarea|title)$/i,vi=(t=>(e,...s)=>({_$litType$:t,strings:e,values:s}))(1),yi=Symbol.for("lit-noChange"),_i=Symbol.for("lit-nothing"),bi=new WeakMap,wi=ri.createTreeWalker(ri,129);function xi(t,e){if(!hi(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==ti?ti.createHTML(e):e}const $i=(t,e)=>{const s=t.length-1,i=[];let a,r=2===e?"<svg>":3===e?"<math>":"",o=ci;for(let n=0;n<s;n++){const e=t[n];let s,h,l=-1,c=0;for(;c<e.length&&(o.lastIndex=c,h=o.exec(e),null!==h);)c=o.lastIndex,o===ci?"!--"===h[1]?o=di:void 0!==h[1]?o=gi:void 0!==h[2]?(fi.test(h[2])&&(a=RegExp("</"+h[2],"g")),o=ui):void 0!==h[3]&&(o=ui):o===ui?">"===h[0]?(o=a??ci,l=-1):void 0===h[1]?l=-2:(l=o.lastIndex-h[2].length,s=h[1],o=void 0===h[3]?ui:'"'===h[3]?mi:pi):o===mi||o===pi?o=ui:o===di||o===gi?o=ci:(o=ui,a=void 0);const d=o===ui&&t[n+1].startsWith("/>")?" ":"";r+=o===ci?e+ai:l>=0?(i.push(s),e.slice(0,l)+ei+e.slice(l)+si+d):e+si+(-2===l?n:d)}return[xi(t,r+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class ki{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let a=0,r=0;const o=t.length-1,n=this.parts,[h,l]=$i(t,e);if(this.el=ki.createElement(h,s),wi.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=wi.nextNode())&&n.length<o;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(ei)){const e=l[r++],s=i.getAttribute(t).split(si),o=/([.?@])?(.*)/.exec(e);n.push({type:1,index:a,name:o[2],strings:s,ctor:"."===o[1]?Ci:"?"===o[1]?Ti:"@"===o[1]?Ii:Ei}),i.removeAttribute(t)}else t.startsWith(si)&&(n.push({type:6,index:a}),i.removeAttribute(t));if(fi.test(i.tagName)){const t=i.textContent.split(si),e=t.length-1;if(e>0){i.textContent=Qs?Qs.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],oi()),wi.nextNode(),n.push({type:2,index:++a});i.append(t[e],oi())}}}else if(8===i.nodeType)if(i.data===ii)n.push({type:2,index:a});else{let t=-1;for(;-1!==(t=i.data.indexOf(si,t+1));)n.push({type:7,index:a}),t+=si.length-1}a++}}static createElement(t,e){const s=ri.createElement("template");return s.innerHTML=t,s}}function Si(t,e,s=t,i){if(e===yi)return e;let a=void 0!==i?s._$Co?.[i]:s._$Cl;const r=ni(e)?void 0:e._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),void 0===r?a=void 0:(a=new r(t),a._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=a:s._$Cl=a),void 0!==a&&(e=Si(t,a._$AS(t,e.values),a,i)),e}class Mi{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??ri).importNode(e,!0);wi.currentNode=i;let a=wi.nextNode(),r=0,o=0,n=s[0];for(;void 0!==n;){if(r===n.index){let e;2===n.type?e=new Ai(a,a.nextSibling,this,t):1===n.type?e=new n.ctor(a,n.name,n.strings,this,t):6===n.type&&(e=new Di(a,this,t)),this._$AV.push(e),n=s[++o]}r!==n?.index&&(a=wi.nextNode(),r++)}return wi.currentNode=ri,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class Ai{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=_i,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Si(this,t,e),ni(t)?t===_i||null==t||""===t?(this._$AH!==_i&&this._$AR(),this._$AH=_i):t!==this._$AH&&t!==yi&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>hi(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==_i&&ni(this._$AH)?this._$AA.nextSibling.data=t:this.T(ri.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=ki.createElement(xi(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new Mi(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=bi.get(t.strings);return void 0===e&&bi.set(t.strings,e=new ki(t)),e}k(t){hi(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const a of t)i===e.length?e.push(s=new Ai(this.O(oi()),this.O(oi()),this,this.options)):s=e[i],s._$AI(a),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class Ei{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,a){this.type=1,this._$AH=_i,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=a,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=_i}_$AI(t,e=this,s,i){const a=this.strings;let r=!1;if(void 0===a)t=Si(this,t,e,0),r=!ni(t)||t!==this._$AH&&t!==yi,r&&(this._$AH=t);else{const i=t;let o,n;for(t=a[0],o=0;o<a.length-1;o++)n=Si(this,i[s+o],e,o),n===yi&&(n=this._$AH[o]),r||=!ni(n)||n!==this._$AH[o],n===_i?t=_i:t!==_i&&(t+=(n??"")+a[o+1]),this._$AH[o]=n}r&&!i&&this.j(t)}j(t){t===_i?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Ci extends Ei{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===_i?void 0:t}}class Ti extends Ei{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==_i)}}class Ii extends Ei{constructor(t,e,s,i,a){super(t,e,s,i,a),this.type=5}_$AI(t,e=this){if((t=Si(this,t,e,0)??_i)===yi)return;const s=this._$AH,i=t===_i&&s!==_i||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,a=t!==_i&&(s===_i||i);i&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Di{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Si(this,t)}}const Pi=Ks.litHtmlPolyfillSupport;Pi?.(ki,Ai),(Ks.litHtmlVersions??=[]).push("3.3.2");const Ri=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ni extends Zs{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let a=i._$litPart$;if(void 0===a){const t=s?.renderBefore??null;i._$litPart$=a=new Ai(e.insertBefore(oi(),t),t,void 0,s??{})}return a._$AI(t),a})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return yi}}Ni._$litElement$=!0,Ni.finalized=!0,Ri.litElementHydrateSupport?.({LitElement:Ni});const Li=Ri.litElementPolyfillSupport;Li?.({LitElement:Ni}),(Ri.litElementVersions??=[]).push("4.2.2");const Vi=new Set(["type","cards","title","direction","view_layout","card_mod"]);class Oi extends Ni{constructor(){super(...arguments),this._cards=[]}static{this.properties={hass:{attribute:!1}}}setConfig(t){const e={};for(const[s,i]of Object.entries(t))!Vi.has(s)&&i&&"object"==typeof i&&(e[s]=i);Object.keys(e).length>0&&(window.__sakUserTemplates||(window.__sakUserTemplates={templates:{}}),Object.assign(window.__sakUserTemplates.templates,e)),this._config=t,this._buildCards()}_buildCards(){this._cards=(this._config?.cards??[]).map((t=>{const e=t.type.startsWith("custom:")?t.type.slice(7):`hui-${t.type}-card`,s=document.createElement(e);try{"function"==typeof s.setConfig&&s.setConfig(t)}catch(ti){console.error(`[sak-layout] setConfig failed for "${t.type}":`,ti)}return this.hass&&(s.hass=this.hass),s}))}updated(t){if(super.updated(t),t.has("hass")&&this.hass)for(const e of this._cards)e.hass=this.hass}render(){const t="horizontal"===this._config?.direction?"row":"column";return vi`<div class="sak-layout-stack" style="flex-direction:${t}">${this._cards}</div>`}static{this.styles=Ns`
    .sak-layout-stack {
      display: flex;
      gap: 8px;
    }
  `}getCardSize(){return this._cards.reduce(((t,e)=>t+("function"==typeof e.getCardSize?e.getCardSize():1)),0)||1}}customElements.define("sak-layout",Oi);const Bi=t=>{const e=Math.round(Math.min(Math.max(t,0),255)).toString(16);return 1===e.length?`0${e}`:e},Ui=t=>`#${Bi(t[0])}${Bi(t[1])}${Bi(t[2])}`,zi=t=>{const[e,s,i]=t,a=Math.max(e,s,i),r=a-Math.min(e,s,i),o=r&&(a===e?(s-i)/r:a===s?2+(i-e)/r:4+(e-s)/r);return[60*(o<0?o+6:o),a&&r/a,a]},Fi=t=>{const[e,s,i]=t,a=t=>{const a=(t+e/60)%6;return i-i*s*Math.max(Math.min(a,4-a,1),0)};return[a(5),a(3),a(1)]},Gi=t=>Fi([t[0],t[1],255]),Hi=(t,e,s)=>Math.min(Math.max(t,e),s),ji=t=>{if(t<=66)return 255;return Hi(329.698727446*(t-60)**-.1332047592,0,255)},qi=t=>{let e;return e=t<=66?99.4708025861*Math.log(t)-161.1195681661:288.1221695283*(t-60)**-.0755148492,Hi(e,0,255)},Wi=t=>{if(t>=66)return 255;if(t<=19)return 0;const e=138.5177312231*Math.log(t-10)-305.0447927307;return Hi(e,0,255)},Yi=t=>{const e=t/100;return[ji(e),qi(e),Wi(e)]},Xi=(t,e)=>{const s=Math.max(...t),i=Math.max(...e);let a;return a=0===i?0:s/i,e.map((t=>Math.round(t*a)))},Ji=t=>Math.floor(1e6/t),Zi=(t,e,s)=>{const[i,a,r,o,n]=t,h=Ji(e??2700),l=Ji(s??6500),c=h-l;let d;try{d=n/(o+n)}catch(_){d=.5}const g=l+d*c,u=g?(p=g,Math.floor(1e6/p)):0;var p;const[m,f,v]=Yi(u),y=Math.max(o,n)/255;return Xi([i,a,r,o,n],[i+m*y,a+f*y,r+v*y])};console.info(`%c  SWISS-ARMY-KNIFE-CARD  \n%c      Version ${ut}      `,"color: yellow; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");class Ki extends rt{constructor(){super(),this.connected=!1,At.setElement(this),this.cardId=Math.random().toString(36).substring(2,11),this.entities=[],this.entitiesStr=[],this.attributesStr=[],this.secondaryInfoStr=[],this.iconStr=[],this.viewBoxSize=ft,this.viewBox={width:ft,height:ft},this.toolsets=[],this.tools=[],this.styles={},this.styles.card={},this.styles.card.default={},this.styles.card.light={},this.styles.card.dark={},this.entityHistory={},this.entityHistory.needed=!1,this.stateChanged=!0,this.entityHistory.updating=!1,this.entityHistory.update_interval=300,this.dev={},this.dev.debug=!1,this.dev.performance=!1,this.dev.m3=!1,this.configIsSet=!1,this.theme={},this.theme.checked=!1,this.theme.isLoaded=!1,this.theme.modeChanged=!1,this.theme.darkMode=!1,this.theme.light={},this.theme.dark={},this.isSafari=!!window.navigator.userAgent.match(/Version\/[\d\.]+.*Safari/),this.iOS=(/iPad|iPhone|iPod/.test(window.navigator.userAgent)||"MacIntel"===window.navigator.platform&&window.navigator.maxTouchPoints>1)&&!window.MSStream,this.isSafari14=this.isSafari&&/Version\/14\.\d+/.test(window.navigator.userAgent),this.isSafari15=this.isSafari&&/Version\/15\.\d+/.test(window.navigator.userAgent),this.isSafari16=this.isSafari&&/Version\/16\.\d+/.test(window.navigator.userAgent),this.isSafari17=this.isSafari&&/Version\/17\.\d+/.test(window.navigator.userAgent),this.isSafari18=this.isSafari&&/Version\/18\.\d+/.test(window.navigator.userAgent),this.isSafariGte16=this.isSafari&&/Version\/(?:1[6-9]|[2-9]\d)\.\d+/.test(window.navigator.userAgent),this.browserDetection=new Ms,this.browserCapabilities=this.browserDetection.getCapabilities(),this.isSafari14=this.isSafari14||/os 14.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafari15=this.isSafari15||/os 15.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafari16=this.isSafari16||/os 16.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafari17=this.isSafari17||/os 17.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafari18=this.isSafari18||/os 18.*like safari/.test(window.navigator.userAgent.toLowerCase()),this.isSafariGte16=this.isSafariGte16||/os (?:1[6-9]|[2-9]\d).*like safari/.test(window.navigator.userAgent.toLowerCase()),this.lovelace=Ki.lovelace,this.lovelace||console.warn("card::constructor - Lovelace not available yet, will initialize in setConfig"),Ki.colorCache||(Ki.colorCache=[]),this.palette={},this.palette.light={},this.palette.dark={},this.dev.debug&&console.log("*****Event - card - constructor",this.cardId,(new Date).getTime())}static getSystemStyles(){return it`
      :host {
        cursor: default;
        font-size: ${4}px;
    ...
    `}static getUserStyles(){return this.userContent="",Ki._sakUserTemplates&&Ki._sakUserTemplates.definitions?.user_css_definitions&&(this.userContent=Ki._sakUserTemplates.definitions.user_css_definitions.reduce(((t,e)=>t+e.content),"")),it`${st(this.userContent)}`}static getSakStyles(){return this.sakContent="",Ki._sakSysTemplates&&Ki._sakSysTemplates.definitions?.sak_css_definitions&&(this.sakContent=Ki._sakSysTemplates.definitions.sak_css_definitions.reduce(((t,e)=>t+e.content),"")),it`${st(this.sakContent)}`}static getSakSvgDefinitions(){let t="";Ki._sakSysTemplates&&Ki._sakSysTemplates.definitions?.sak_svg_definitions&&(t=Ki._sakSysTemplates.definitions.sak_svg_definitions.reduce(((t,e)=>t+e.content),"")),Ki.sakSvgContent=ct(t)}static getUserSvgDefinitions(){let t="";Ki._sakUserTemplates&&Ki._sakUserTemplates.definitions?.user_svg_definitions&&(t=Ki._sakUserTemplates.definitions.user_svg_definitions.reduce(((t,e)=>t+e.content),"")),Ki.userSvgContent=ct(t)}static get styles(){return Ki.lovelace||(Ki.lovelace=wt.getLovelace()),Ki.lovelace?(Ki._sakSysTemplates||(Ki._sakSysTemplates=Ki.lovelace.config.sak_sys_templates??Cs),Ki._sakUserTemplates||(Ki._sakUserTemplates=Ki.lovelace.config.sak_user_templates??null),Ki.getSakSvgDefinitions(),Ki.getUserSvgDefinitions(),Ki._sakStylesFromLovelace=!0,it`
      ${Ki.getSystemStyles()}
      ${Ki.getSakStyles()}
      ${Ki.getUserStyles()}
    `):(console.warn("SAK - Can't get reference to Lovelace yet, deferring SAK styles to setConfig"),it`${Ki.getSystemStyles()}`)}set hass(t){if(this.counter||(this.counter=0),this.counter+=1,this.theme.modeChanged=t.themes.darkMode!==this.theme.darkMode,this.theme.modeChanged&&(this.theme.darkMode=t.themes.darkMode,At.colorCache={}),!this.theme.checked){if(this.theme.checked=!0,this.config.theme&&t.themes.themes[this.config.theme]){const{themeLight:e,themeDark:s}=At.processTheme(t.themes.themes[this.config.theme]);this.theme.light=e,this.theme.dark=s,this.theme.isLoaded=!0}this.styles.card.light={...this.styles.card.default,...this.theme.light,...this.palette.light},this.styles.card.dark={...this.styles.card.default,...this.theme.dark,...this.palette.dark}}if(this.dev.debug&&console.log("*****Event - card::set hass",this.cardId,(new Date).getTime()),this._hass=t,this.connected||this.dev.debug&&console.log("set hass but NOT connected",this.cardId),!this.config.entities)return;let e,s,i,a,r,o=!1,n=0,h=!1,l=!1;for(e of this.config.entities){const e=this.config.entities[n].entity,c=t.states[e],d=void 0===c;if(this.entities[n]=c,d&&console.warn(`[SAK] Entità non disponibile: ${e}`),this.config.entities[n].secondary_info&&(h=!0,s=d?"non disponibile":c[this.config.entities[n].secondary_info],i=this._buildStateString(s,this.config.entities[n]),i!==this.secondaryInfoStr[n]&&(this.secondaryInfoStr[n]=i,o=!0)),this.config.entities[n].icon||(a=d?"mdi:alert-circle-outline":c.attributes.icon,a!==this.iconStr[n]&&(this.iconStr[n]=a,o=!0)),this.config.entities[n].attribute){let{attribute:t}=this.config.entities[n],e="",s="";const i=this.config.entities[n].attribute.indexOf("["),a=this.config.entities[n].attribute.indexOf(".");let h=0,c="";if(-1!==i){t=this.config.entities[n].attribute.substring(0,i),e=this.config.entities[n].attribute.substring(i,this.config.entities[n].attribute.length);const a=e.indexOf("]");h=parseInt(e.substring(1,a),10),c=e.substring(a+2,e.length);const r=this.entities[n].attributes?.[t];s=r&&void 0!==r[h]?c?r[h][c]:r[h]:void 0}else if(-1!==a){t=this.config.entities[n].attribute.substring(0,a),e=this.config.entities[n].attribute.substring(a,this.config.entities[n].attribute.length),c=e.substring(1,e.length);const i=this.entities[n].attributes?.[t];s=void 0!==i?i[c]:void 0,console.log("set hass, attributes with map",this.config.entities[n].attribute,t,e)}else s=this.entities[n].attributes?.[t];r=this._buildStateString(s,this.config.entities[n]),r!==this.attributesStr[n]&&(this.attributesStr[n]=r,o=!0),l=!0}l||h||(r=d?void 0:this._buildStateString(this.entities[n].state,this.config.entities[n]),r!==this.entitiesStr[n]&&(this.entitiesStr[n]=r,o=!0),this.dev.debug&&console.log("set hass - attrSet=false",this.cardId,`${(new Date).getSeconds().toString()}.${(new Date).getMilliseconds().toString()}`,r)),n+=1,l=!1,h=!1}(o||this.theme.modeChanged)&&(this.toolsets&&this.toolsets.forEach((t=>{t.updateValues()})),this.requestUpdate(),this.theme.modeChanged=!1,this.counter-=1)}setConfig(t){if(this.dev.performance&&console.time(`--\x3e ${this.cardId} PERFORMANCE card::setConfig`),this.dev.debug&&console.log("*****Event - setConfig",this.cardId,(new Date).getTime()),(t=JSON.parse(JSON.stringify(t))).dev&&(this.dev={...this.dev,...t.dev}),this.dev.debug&&console.log("setConfig",this.cardId),this.lovelace||(Ki.lovelace=wt.getLovelace(),this.lovelace=Ki.lovelace),!this.lovelace)throw Error("card::setConfig - Can't get Lovelace panel");Ki._sakSysTemplates||(this.lovelace.config.sak_sys_templates||console.info(`${ut} - SAK - System Templates not found in Lovelace config. Using built-in templates.`),Ki._sakSysTemplates=this.lovelace.config.sak_sys_templates??Cs);const e=window.__sakUserTemplates,s=this.lovelace.config.sak_user_templates;if(e?.templates&&Object.keys(e.templates).length>0?Ki._sakUserTemplates={...s??{},templates:{...e.templates??{},...s?.templates??{}}}:s&&!Ki._sakUserTemplates&&(Ki._sakUserTemplates=s),!Ki._sakStylesFromLovelace&&(Ki._sakDefsLoaded||(Ki.getSakSvgDefinitions(),Ki.getUserSvgDefinitions(),Ki._sakDefsLoaded=!0),this.shadowRoot)){const l=Ki.getSakStyles().cssText||"",c=Ki.getUserStyles().cssText||"";if(l||c){const d=document.createElement("style");d.textContent=l+c,this.shadowRoot.appendChild(d)}}if(!t.layout)throw Error("card::setConfig - No layout defined");const i=(new Es).validate(t);if(i.isValid||i.errors.forEach((t=>{console.error(`[SAK] Config error at '${t.path}': ${t.message}`)})),i.warnings.length>0&&i.warnings.forEach((t=>{console.warn(`[SAK] Config warning at '${t.path}': ${t.message}`)})),t.entities){if("sensor"!==Vt(t.entities[0].entity)&&t.entities[0].attribute&&!isNaN(t.entities[0].attribute))throw Error("card::setConfig - First entity or attribute must be a numbered sensorvalue, but is NOT")}const a=_t.mergeDeep(t);function r(t,e){if(e?.template){const t=Ki._sakUserTemplates,s=t?.templates?.[e.template.name];s||console.error("Template not found...",e.template,s);const i=xt.replaceVariables3(e.template.variables,s);return _t.mergeDeep(i)}return"template"===t?(console.log("findTemplate return key=template/value",t,void 0),e):e}this.config=a,this.toolset=[];const o=JSON.stringify(this.config,r);if(this.config.palette){this.config.palette=JSON.parse(o).palette;const{paletteLight:g,paletteDark:u}=At.processPalette(this.config.palette);this.palette.light=g,this.palette.dark=u}const n=JSON.parse(o).layout.toolsets;if(this.config.layout.template&&(this.config.layout=JSON.parse(o).layout),this.config.layout.toolsets.map(((t,e)=>{let s=null;this.toolsets||(this.toolsets=[]);{let i=!1,a=[];s=n[e].tools,t.tools&&t.tools.map(((o,h)=>(n[e].tools.map(((a,l)=>(o.id===a.id&&(t.template&&(this.config.layout.toolsets[e].position&&(n[e].position=_t.mergeDeep(this.config.layout.toolsets[e].position)),s[l]=_t.mergeDeep(s[l],o),s[l]=JSON.parse(JSON.stringify(s[l],r)),i=!0),this.dev.debug&&console.log("card::setConfig - got toolsetCfg toolid",o,h,a,l,o)),n[e].tools[l]=xt.getJsTemplateOrValueConfig(n[e].tools[l],this.config.entities,_t.mergeDeep(n[e].tools[l])),i))),i||(a=a.concat(t.tools[h])),i))),s=s.concat(a)}t=n[e];const i=new Ss(this,t);return this.toolsets.push(i),!0})),this.dev.m3&&(console.log("*** M3 - Checking for m3.yaml template to convert..."),Ki._sakUserTemplates?.templates?.m3)){const{m3:p}=Ki._sakUserTemplates.templates;console.log("*** M3 - Found. Material 3 conversion starting...");let m="",f="",v="",y="",_="",b="",w="",x="",$="",k="";const S={},M={},A={};p.entities.map((t=>(["ref.palette","sys.color","sys.color.light","sys.color.dark"].includes(t.category_id)&&(t.tags.includes("alias")||(S[t.id]={value:t.value,tags:t.tags})),"ref.palette"===t.category_id&&(m+=`${t.id}: '${t.value}'\n`,"md.ref.palette.primary40"===t.id&&(b=t.value),"md.ref.palette.primary80"===t.id&&($=t.value),"md.ref.palette.neutral40"===t.id&&(w=t.value),"md.ref.palette.neutral80"===t.id&&(k=t.value)),"sys.color"===t.category_id&&(f+=`${t.id}: '${t.value}'\n`),"sys.color.light"===t.category_id&&(v+=`${t.id}: '${t.value}'\n`,"md.sys.color.surface.light"===t.id&&(_=t.value)),"sys.color.dark"===t.category_id&&(y+=`${t.id}: '${t.value}'\n`,"md.sys.color.surface.dark"===t.id&&(x=t.value)),!0))),["primary","secondary","tertiary","error","neutral","neutral-variant"].forEach((t=>{[5,15,25,35,45,65,75,85].forEach((e=>{S[`md.ref.palette.${t}${e.toString()}`]={value:At.getGradientValue(S[`md.ref.palette.${t}${(e-5).toString()}`].value,S[`md.ref.palette.${t}${(e+5).toString()}`].value,.5),tags:[...S[`md.ref.palette.${t}${(e-5).toString()}`].tags]},S[`md.ref.palette.${t}${e.toString()}`].tags[3]=t+e.toString()})),S[`md.ref.palette.${t}7`]={value:At.getGradientValue(S[`md.ref.palette.${t}5`].value,S[`md.ref.palette.${t}10`].value,.5),tags:[...S[`md.ref.palette.${t}10`].tags]},S[`md.ref.palette.${t}7`].tags[3]=`${t}7`,S[`md.ref.palette.${t}92`]={value:At.getGradientValue(S[`md.ref.palette.${t}90`].value,S[`md.ref.palette.${t}95`].value,.5),tags:[...S[`md.ref.palette.${t}90`].tags]},S[`md.ref.palette.${t}92`].tags[3]=`${t}92`,S[`md.ref.palette.${t}97`]={value:At.getGradientValue(S[`md.ref.palette.${t}95`].value,S[`md.ref.palette.${t}99`].value,.5),tags:[...S[`md.ref.palette.${t}90`].tags]},S[`md.ref.palette.${t}97`].tags[3]=`${t}97`}));for(const[Q,tt]of Object.entries(S))M[Q]=`theme-${tt.tags[1]}-${tt.tags[2]}-${tt.tags[3]}: rgb(${E(tt.value)})`,A[Q]=`theme-${tt.tags[1]}-${tt.tags[2]}-${tt.tags[3]}-rgb: ${E(tt.value)}`;function E(t){const e={};e.r=Math.round(parseInt(t.substring(1,3),16)),e.g=Math.round(parseInt(t.substring(3,5),16)),e.b=Math.round(parseInt(t.substring(5,7),16));return`${e.r},${e.g},${e.b}`}function C(t,e,s,i,a){const r={},o={};r.r=Math.round(parseInt(t.substring(1,3),16)),r.g=Math.round(parseInt(t.substring(3,5),16)),r.b=Math.round(parseInt(t.substring(5,7),16)),o.r=Math.round(parseInt(e.substring(1,3),16)),o.g=Math.round(parseInt(e.substring(3,5),16)),o.b=Math.round(parseInt(e.substring(5,7),16));let n,h,l,c="";return s.forEach(((t,e)=>{n=Math.round(t*o.r+(1-t)*r.r),h=Math.round(t*o.g+(1-t)*r.g),l=Math.round(t*o.b+(1-t)*r.b),c+=`${i+(e+1).toString()}-${a}: rgb(${n},${h},${l})\n`,c+=`${i+(e+1).toString()}-${a}-rgb: ${n},${h},${l}\n`})),c}const T=[.03,.05,.08,.11,.15,.19,.24,.29,.35,.4],I=[.05,.08,.11,.15,.19,.24,.29,.35,.4,.45],D=C(_,w,T,"  theme-ref-elevation-surface-neutral","light"),P=S["md.ref.palette.neutral-variant40"].value,R=C(_,P,T,"  theme-ref-elevation-surface-neutral-variant","light"),N=C(_,b,T,"  theme-ref-elevation-surface-primary","light"),L=S["md.ref.palette.secondary40"].value,V=C(_,L,T,"  theme-ref-elevation-surface-secondary","light"),O=S["md.ref.palette.tertiary40"].value,B=C(_,O,T,"  theme-ref-elevation-surface-tertiary","light"),U=S["md.ref.palette.error40"].value,z=C(_,U,T,"  theme-ref-elevation-surface-error","light"),F=C(x,k,I,"  theme-ref-elevation-surface-neutral","dark"),G=S["md.ref.palette.neutral-variant80"].value,H=C(x,G,I,"  theme-ref-elevation-surface-neutral-variant","dark"),j=C(x,$,I,"  theme-ref-elevation-surface-primary","dark"),q=S["md.ref.palette.secondary80"].value,W=C(x,q,I,"  theme-ref-elevation-surface-secondary","dark"),Y=S["md.ref.palette.tertiary80"].value,X=C(x,Y,I,"  theme-ref-elevation-surface-tertiary","dark"),J=S["md.ref.palette.error80"].value,Z=C(x,J,I,"  theme-ref-elevation-surface-error","dark");let K="";for(const[et,st]of Object.entries(M))"theme-ref"===st.substring(0,9)&&(K+=`  ${st}\n`,K+=`  ${A[et]}\n`);console.log(D+R+N+V+B+z+F+H+j+W+X+Z+K),console.log("*** M3 - Material 3 conversion DONE. You should copy the above output...")}this.aspectratio=(this.config.layout.aspectratio||this.config.aspectratio||"1/1").trim();const h=this.aspectratio.split("/");this.viewBox||(this.viewBox={}),this.viewBox.width=h[0]*pt,this.viewBox.height=h[1]*pt,this.config.layout.styles?.card&&(this.styles.card.default=this.config.layout.styles.card),this.dev.debug&&console.log("Step 5: toolconfig, list of toolsets",this.toolsets),this.dev.debug&&console.log("debug - setConfig",this.cardId,this.config),this.dev.performance&&console.timeEnd(`--\x3e ${this.cardId} PERFORMANCE card::setConfig`),this.configIsSet=!0}connectedCallback(){this.dev.performance&&console.time(`--\x3e ${this.cardId} PERFORMANCE card::connectedCallback`),this.dev.debug&&console.log("*****Event - connectedCallback",this.cardId,(new Date).getTime()),this.connected=!0,super.connectedCallback(),this.entityHistory.update_interval&&(this.updateOnInterval(),clearInterval(this.interval),this.interval=setInterval((()=>this.updateOnInterval()),this._hass?1e3*this.entityHistory.update_interval:100)),this.dev.debug&&console.log("ConnectedCallback",this.cardId),this.requestUpdate(),this.dev.performance&&console.timeEnd(`--\x3e ${this.cardId} PERFORMANCE card::connectedCallback`)}disconnectedCallback(){this.dev.performance&&console.time(`--\x3e ${this.cardId} PERFORMANCE card::disconnectedCallback`),this.dev.debug&&console.log("*****Event - disconnectedCallback",this.cardId,(new Date).getTime()),this.interval&&(clearInterval(this.interval),this.interval=0),super.disconnectedCallback(),this.dev.debug&&console.log("disconnectedCallback",this.cardId),this.connected=!1,this.dev.performance&&console.timeEnd(`--\x3e ${this.cardId} PERFORMANCE card::disconnectedCallback`)}firstUpdated(t){this.dev.debug&&console.log("*****Event - card::firstUpdated",this.cardId,(new Date).getTime()),this.toolsets&&this.toolsets.forEach((e=>{e.firstUpdated(t)}))}updated(t){this.dev.debug&&console.log("*****Event - Updated",this.cardId,(new Date).getTime()),this.toolsets&&this.toolsets.forEach((e=>{e.updated(t)}))}willUpdate(t){this.toolsets&&this.toolsets.forEach((e=>{e.willUpdate(t)}))}shouldUpdate(t){return this.toolsets&&this.toolsets.forEach((e=>{e.shouldUpdate(t)})),!0}render(){if(this.dev.performance&&console.time(`--\x3e ${this.cardId} PERFORMANCE card::render`),this.dev.debug&&console.log("*****Event - render",this.cardId,(new Date).getTime()),!this.connected)return void(this.dev.debug&&console.log("render but NOT connected",this.cardId,(new Date).getTime()));let t;try{t=this.config.disable_card?U`
                  ...
                  `}catch(e){console.error(e)}return this.dev.performance&&console.timeEnd(`--\x3e ${this.cardId} PERFORMANCE card::render`),t}_renderSakSvgDefinitions(){return z`
    ${Ki.sakSvgContent}
    `}_renderUserSvgDefinitions(){return z`
    ${Ki.userSvgContent}
    `}themeIsDarkMode(){return!0===this.theme.darkMode}themeIsLightMode(){return!1===this.theme.darkMode}_RenderToolsets(){return this.dev.debug&&console.log("all the tools in renderTools",this.tools),z`
    ...
    `}_renderCardAttributes(){let t;const e=[];this._attributes="";for(let s=0;s<this.entities.length;s++)t=this.attributesStr[s]?this.attributesStr[s]:this.secondaryInfoStr[s]?this.secondaryInfoStr[s]:this.entitiesStr[s],e.push(t);return this._attributes=e,e}_renderSvg(){const t=this.config.card_filter?this.config.card_filter:"card--filter-none",e=[];this._renderCardAttributes();const s=this._RenderToolsets();return e.push(z`
      <!-- SAK Card SVG Render -->
      ...
      </svg>`),z`${e}`}_buildUom(t,e,s){return t?.unit||s?.unit||e?.attributes.unit_of_measurement||""}toLocale(t,e="unknown"){const s=this._hass.selectedLanguage||this._hass.language,i=this._hass.resources[s];return i&&i[t]?i[t]:e}_buildStateString(t,e){if(void 0===t)return t;if(null===t)return t;if(e.convert){let s,i,a=e.convert.match(/(^\w+)\((\d+)\)/);switch(null===a?s=e.convert:3===a.length&&(s=a[1],i=Number(a[2])),s){case"brightness_pct":t="undefined"===t?"undefined":`${Math.round(t/255*100)}`;break;case"multiply":t=`${Math.round(t*i)}`;break;case"divide":t=`${Math.round(t/i)}`;break;case"rgb_csv":case"rgb_hex":if(e.attribute){let i=this._hass.states[e.entity];switch(i.attributes.color_mode){case"unknown":case"onoff":case"brightness":case"white":break;case"color_temp":if(i.attributes.color_temp_kelvin){let e=Yi(i.attributes.color_temp_kelvin);const a=zi(e);a[1]<.4&&(a[1]<.1?a[2]=225:a[1]=.4),e=Fi(a),e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:Ui(e)}else t="rgb_csv"===s?"255,255,255":"#ffffff00";break;case"hs":{let e=Gi([i.attributes.hs_color[0],i.attributes.hs_color[1]/100]);e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:Ui(e)}break;case"rgb":{const e=zi(i.attributes.rgb_color);e[1]<.4&&(e[1]<.1?e[2]=225:e[1]=.4);const a=Fi(e);t="rgb_csv"===s?a.toString():Ui(a)}break;case"rgbw":{let e=(t=>{const[e,s,i,a]=t;return Xi([e,s,i,a],[e+a,s+a,i+a])})(i.attributes.rgbw_color);e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:Ui(e)}break;case"rgbww":{let e=Zi(i.attributes.rgbww_color,i.attributes?.min_color_temp_kelvin,i.attributes?.max_color_temp_kelvin);e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:Ui(e)}break;case"xy":if(i.attributes.hs_color){let e=Gi([i.attributes.hs_color[0],i.attributes.hs_color[1]/100]);const a=zi(e);a[1]<.4&&(a[1]<.1?a[2]=225:a[1]=.4),e=Fi(a),e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:Ui(e)}else if(i.attributes.color){let e={};e.l=i.attributes.brightness,e.h=i.attributes.color.h||i.attributes.color.hue,e.s=i.attributes.color.s||i.attributes.color.saturation;let{r:a,g:r,b:o}=At.hslToRgb(e);if("rgb_csv"===s)t=`${a},${r},${o}`;else{t=`#${At.padZero(a.toString(16))}${At.padZero(r.toString(16))}${At.padZero(o.toString(16))}`}}else i.attributes.xy_color}}break;default:console.error(`Unknown converter [${s}] specified for entity [${e.entity}]!`)}}return void 0!==t?Number.isNaN(t)?t:t.toString():void 0}_computeEntity(t){return t.substring(t.indexOf(".")+1)}updateOnInterval(){this._hass?(this.updateData(),this.entityHistory.needed?(window.clearInterval(this.interval),this.interval=setInterval((()=>this.updateOnInterval()),1e3*this.entityHistory.update_interval)):this.interval&&(window.clearInterval(this.interval),this.interval=0)):this.dev.debug&&console.log("UpdateOnInterval - NO hass, returning")}async fetchRecent(t,e,s,i){let a="history/period";e&&(a+=`/${e.toISOString()}`),a+=`?filter_entity_id=${t}`,s&&(a+=`&end_time=${s.toISOString()}`),i&&(a+="&skip_initial_state"),a+="&minimal_response";try{return await this._hass.callApi("GET",a)}catch(r){return this.dev.debug&&console.warn("[SAK] fetchRecent failed for",t,r),[]}}async updateData(){this.entityHistory.updating=!0,this.dev.debug&&console.log("card::updateData - ENTRY",this.cardId);const t=[];let e=0;this.toolsets.map(((s,i)=>(s.tools.map(((s,a)=>{if("bar"===s.type||"sparkline"===s.type){if("real_time"===s.tool?.config?.period?.type)return!0;const r=new Date,o=new Date;if("day"===s.tool?.config?.period?.calendar?.period)o.setHours(0,0,0,0),o.setHours(o.getHours()+24*(s.tool.config.period.calendar.offset||0)),0!==(s.tool.config.period.calendar.offset||0)&&r.setHours(0,0,0,0);else{const t=s.tool?.config?.period?.rolling_window?.duration?.hour||s.tool?.config?.hours||0;o.setHours(r.getHours()-t)}const n=s.tool?.config?.entity_index;if(!this.entities||null==n||!this.entities[n])return console.error("SAK ERROR: invalid entity_index",n,"cardId=",this.cardId,"title=",this.config?.title,"toolset=",i,"toolIndex=",a,"toolType=",s.type,"entities_length=",this.entities?this.entities.length:"none","toolConfig=",s.tool?.config),!0;const h=this.config.entities[n]?.attribute?this.config.entities[n].attribute:null;t[e]={tsidx:i,entityIndex:n,entityId:this.entities[n].entity_id,attrId:h,start:o,end:r,type:s.type,idx:a},e+=1}return!0})),!0))),this.dev.debug&&(console.log("card::updateData - LENGTH",this.cardId,t.length,t),console.log("card::updateData, entityList from tools",t)),this.stateChanged=!1;try{const e=t.map(((t,e)=>this.updateEntity(t,e,t.start,t.end)));await Promise.all(e)}finally{this.entityHistory.updating=!1}this.entityHistory.updating=!1}async updateEntity(t,e,s,i){let a=[];const r=s;let o,n=await this.fetchRecent(t.entityId,r,i,!1);"sparkline"===t.type&&this.toolsets[t.tsidx].tools[t.idx].tool.processStateMap(n),n[0]&&n[0].length>0&&(t.attrId&&(o=this.entities[t.entityIndex].attributes[this.config.entities[t.entityIndex].attribute],t.state=o),n=n[0].filter((e=>t.attrId?!isNaN(parseFloat(e.attributes[t.attrId])):!isNaN(parseFloat(e.state)))),n=n.map((e=>({last_changed:e.last_changed,state:t.attrId?Number(e.attributes[t.attrId]):Number(e.state)})))),a=[...a,...n],"sparkline"===t.type?(this.toolsets[t.tsidx].tools[t.idx].tool.data=t.entityIndex,this.toolsets[t.tsidx].tools[t.idx].tool.series=[...a],this.requestUpdate()):this.updateBarData(t,a)}updateBarData(t,e){if(!e)return;const s=(new Date).getTime();let i=24,a=2;"bar"!==t.type&&"sparkline"!==t.type||(this.dev.debug&&console.log("entity.type == bar",t),i=this.toolsets[t.tsidx].tools[t.idx].tool.config.hours,a=this.toolsets[t.tsidx].tools[t.idx].tool.config.barhours);const r=e.reduce(((t,e)=>((t,e)=>{const r=(s-new Date(e.last_changed).getTime())/36e5/a-i/a,o=Math.floor(Math.abs(r));return t[o]||(t[o]=[]),t[o].push(e),t})(t,e)),[]);if(r.length=Math.ceil(i/a),0===Object.keys(r).length)return;const o=Object.keys(r)[0];"0"!==o&&(r[0]=[],r[0].push(r[o][0]));for(let h=0;h<i/a;h++)r[h]||(r[h]=[],r[h].push(r[h-1][r[h-1].length-1]));this.coords=r;let n=[];n=[],n=r.map((t=>{return s="state",(e=t).reduce(((t,e)=>t+Number(e[s])),0)/e.length;var e,s})),["bar"].includes(t.type)&&(this.toolsets[t.tsidx].tools[t.idx].tool.series=[...n]),this.requestUpdate()}getCardSize(){return 4}}customElements.define("swiss-army-knife-card",Ki);
