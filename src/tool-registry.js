...
export default class ToolRegistry {
   ...
   */
  static registerTool(toolType, toolClass, metadata = {}) {
  ...
  static isToolRegistered(toolType) {
    return this.registeredTools.has(toolType) || LazyToolLoader.isToolAvailable(toolType);
  }
